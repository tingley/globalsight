...
public class JobEditors {
	...
	public static final String Progress_LINK="link=Progress";
	public static final String ShowComments_LINK="link=Show Comments";
	public static final String SupportFiles_LINK="link=Support Files";
	public static final String Termbases_LINK="link=Termbases";
	public static final String PageInfo_LINK="link=Page Info";
	public static final String Options_LINK="link=Options";
	public static final String Close_LINK="link=Close";
    ...
    public static final String Comments_TABLE="//tbody[@id='idComments']";
	
	public static final String Layout1_IMG="//div[@id='main']/table/tbody/tr/td[1]/table/tbody/tr/td[2]/a[1]/img";
	public static final String Layout2_IMG="//div[@id='main']/table/tbody/tr/td[1]/table/tbody/tr/td[2]/a[2]/img";
	...
	//CommentEditor
	public static final String CommentEditor_TAG="CommentEditor";
	public static final String CommentEditor_WINDOW="name=CommentEditor";
	public static final String Status_SELECTION="idStatus";
	public static final String Priority_SELECTION="idPriority";
	public static final String Category_SELECTION="idCategory";
	public static final String Title_TEXT_FIELD="idTitle";
	public static final String Comment_TEXT_FIELD="idComment";
	
	public static final String OK_BUTTON="idOk";
	public static final String Cancel_BUTTON="idCancel";
