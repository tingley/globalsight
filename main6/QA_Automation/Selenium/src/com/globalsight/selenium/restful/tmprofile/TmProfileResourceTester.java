...
package com.globalsight.selenium.restful.tmprofile;
...
public class TmProfileResourceTester extends RestfulApiTestHelper
{
    ...
    {
        String url = "http://10.10.213.20:8080/globalsight/restfulServices/companies/85/tmprofiles/1";
    ...
    {
        String url = "http://10.10.213.20:8080/globalsight/restfulServices/companies/85/tmprofiles";
    ...
    {
        TmProfileResourceTester tester = new TmProfileResourceTester("85all", "password");
