...
/**
 * Automation test case for GBS-2263
 * MS Office 2010 PPTX Filter does not extract all translatable text from the Master Slide
 * 
 ...
 * @since   8.2.2
 */
public class GBS2263Test extends BaseTestCase
{
    @Test
