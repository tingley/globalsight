...
/**
 * Note - The file is a little big, but it's necessary to include all pages.
 * 
 * Reporter         
 * Assignee         
 * Affects version  
 ...
 * @date 2012/02/07
 */
public class NoSpecIDTest extends BaseTestCase {
	private boolean usingExist = false;
	private FileProfileFuncs fpFuncs = new FileProfileFuncs();

	@Test
	public void testNoSpecID() throws Exception {
