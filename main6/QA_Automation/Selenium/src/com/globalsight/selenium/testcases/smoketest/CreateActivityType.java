...
public class CreateActivityType extends BaseTestCase
{
    ...
    private ActivityTypeFuncs iActivityTypeFuncs = new ActivityTypeFuncs();
    String activityname = ConfigUtil.getDataInCase(getClass().getName(), "ACTIVITYNAME");
    /*
    ...
    public void createActivityType() throws Exception
    {
        ...
        iActivityTypeFuncs.newActivityType(selenium, activityname);  
