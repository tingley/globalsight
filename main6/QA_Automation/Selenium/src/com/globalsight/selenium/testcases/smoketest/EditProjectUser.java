...
public class EditProjectUser extends BaseTestCase {
	...
	public void editUserProject() throws Exception {
		...
		String iProjectName = ConfigUtil.getDataInCase(getClassName(),
				"PROJECTNAME");
		String addUser = ConfigUtil.getDataInCase(getClassName(),
				"Add_User_Name");
		uProjectFuncs.editProjectUser(selenium, iProjectName, addUser);
	}
