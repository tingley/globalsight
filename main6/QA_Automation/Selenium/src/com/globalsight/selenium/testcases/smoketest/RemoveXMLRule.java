...
public class RemoveXMLRule extends BaseTestCase{
	...
	private XMLRulesFuncs remove = new XMLRulesFuncs();
	private EditXMLRule ed = new EditXMLRule();
	@Test
	public void remove() throws Exception{
		selenium.click(MainFrame.Setup_MENU);
		selenium.click(MainFrame.XMLRules_SUBMENU);
		selenium.waitForPageToLoad(CommonFuncs.SHORT_WAIT);
		String rulename = ConfigUtil.getDataInCase(ed.getClass().getName(), "NAME");
		remove.removeRule(selenium, rulename);
	}
	@BeforeMethod
