...
namespace GlobalSight.WordConverter
{
	public class Service1 : System.ServiceProcess.ServiceBase
	{
		...
		private void InitializeComponent()
		{
			...
			// Service1
			// 
			this.ServiceName = "GlobalSight Converter - Word";
		...
		protected override void OnStart(string[] args)
		{
			...
			try 
			{
				m_watchDirName = RegistryUtil.GetGlobalSightRegistryValue("MsOfficeConvDir") + @"\word";
				DirectoryInfo watchDir = new DirectoryInfo(m_watchDirName);
				watchDir.Create();
				Logger.Initialize(m_watchDirName + @"\wordConverter.log");
				m_log = Logger.GetLogger();
				m_log.Log("GlobalSight Word Converter starting up.");
			...
			{
				string msg = "WordConverter failed to initialize because of: " + e.Message + "\r\n" + e.StackTrace;
		...
		protected override void OnStop()
		{
			...
			m_log.Log("WordConverter shutting down.");
