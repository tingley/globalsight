...
namespace Excel2003Converter
{
	public class Service1 : System.ServiceProcess.ServiceBase
	{
		...
		private Excel2003ConverterImpl m_importConverter = null;
		private Excel2003ConverterImpl m_exportConverter = null;
		...
		private void InitializeComponent()
		{
			...
			// Service1
			// 
			this.ServiceName = "GlobalSight Converter - Excel 2003";
		...
		protected override void OnStart(string[] args)
		{
			...
			try 
			{
				...
				watchDir.Create();
				Logger.Initialize(m_watchDirName + @"\excel2003Converter.log");
				m_log = Logger.GetLogger();
				m_log.Log("GlobalSight Excel 2003 Converter starting up.");
				m_log.Log("Creating and starting threads to watch directory " + 
					m_watchDirName);
				
				m_importConverter = new Excel2003ConverterImpl(
					Excel2003ConverterImpl.ConversionType.IMPORT);
				m_importConverterRunner = new ConverterRunner(
					m_importConverter, m_watchDirName);
				m_exportConverter = new Excel2003ConverterImpl(
					Excel2003ConverterImpl.ConversionType.EXPORT);
		...
		protected override void OnStop()
		{
			...
			m_log.Log("Excel 2003 Converter shutting down.");
