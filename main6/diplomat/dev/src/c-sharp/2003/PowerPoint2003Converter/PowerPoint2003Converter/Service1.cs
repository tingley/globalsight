...
namespace PowerPoint2003Converter
{
	public class Service1 : System.ServiceProcess.ServiceBase
	{
		...
		private PowerPoint2003ConverterImpl m_importConverter = null;
		private PowerPoint2003ConverterImpl m_exportConverter = null;
		...
		private void InitializeComponent()
		{
			...
			// Service1
			//
			this.ServiceName = "GlobalSight Converter - PowerPoint 2003";
		...
		protected override void OnStart(string[] args)
		{
			...
			try
			{
				...
				watchDir.Create();
				Logger.Initialize(m_watchDirName + @"\powerpoint2003Converter.log");
				m_log = Logger.GetLogger();
				m_log.Log("GlobalSight PowerPoint 2003 Converter starting up.");
				m_log.Log("Creating and starting threads to watch directory " +
					m_watchDirName);

				m_importConverter = new PowerPoint2003ConverterImpl(
					PowerPoint2003ConverterImpl.ConversionType.IMPORT);
				m_exportConverter = new PowerPoint2003ConverterImpl(
					PowerPoint2003ConverterImpl.ConversionType.EXPORT);
		...
		protected override void OnStop()
		{
			...
			m_log.Log("PowerPoint 2003 Converter shutting down.");
