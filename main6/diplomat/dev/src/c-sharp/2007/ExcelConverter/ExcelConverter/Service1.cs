...
namespace GlobalSight.ExcelConverter
{
    public class Service1 : System.ServiceProcess.ServiceBase
    {
        ...
        {
            // For test easier
            ExcelConverterTester tester = new ExcelConverterTester();
            tester.start();
            // end For test
        }
        ...
        private void InitializeComponent()
        {
            ...
            // Service1
            // 
            this.ServiceName = "GlobalSight Converter - Excel 2007";
        ...
        protected override void OnStart(string[] args)
        {
            ...
            try
            {
                ...
                m_importConverter = new ExcelConverterImpl(
                    ExcelConverterImpl.ConversionType.IMPORT);
                m_importConverterRunner = new ConverterRunner(
                    m_importConverter, m_watchDirName);
                m_exportConverter = new ExcelConverterImpl(
                    ExcelConverterImpl.ConversionType.EXPORT);
        ...
        protected override void OnStop()
        {
            ...
            m_log.Log("Excel 2007 Converter shutting down.");
