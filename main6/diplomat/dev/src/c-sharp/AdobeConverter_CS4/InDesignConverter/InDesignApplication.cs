...
namespace GlobalSight.InDesignConverter
{
    public class InDesignApplication
    {
        ...
        private const string INDD_COM_STRING = "InDesign.Application.CS4";
        ...
        private const string INDD_APP_WINDOW_TITLE = "Adobe InDesign CS4";
        ...
        private void OpenInDesignDoc(object fileNameAsObj)
        {
            ...
            t.Start();
            m_inDesignDoc = (InDesign.Document)m_inDesignApp.Open(fileNameAsObj, m_showingWindow);
            Thread.Sleep(3000);
