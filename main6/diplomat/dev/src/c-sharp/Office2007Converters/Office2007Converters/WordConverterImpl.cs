...
// Primary Interop Assemblies for Office 2007 must be installed
// from the Office 2007 installation CD through the setup program.
// 
...
namespace GlobalSight.Office2007Converters
{
	...
	public class WordConverterImpl : GlobalSight.Common.Converter
	{
		...
		/// <summary>
		/// Creates a Word 2007 ConverterImpl to be used for import or export.
		/// </summary>
