    ...
    class ExcelConverterUtil
    {
        ...
        public void start(String dir)
        {
            try
            {
                ...
                if (m_log == null)
                {
                    m_log = Logger.Initialize(excelDir + @"\excel2010Converter.log");
                }

                m_log.Log("Excel 2010 Converter starting up.");
            ...
            {
                string msg = "Excel 2010 Converter failed to initialize because of: " +
                    e.Message + "\r\n" + e.StackTrace;
