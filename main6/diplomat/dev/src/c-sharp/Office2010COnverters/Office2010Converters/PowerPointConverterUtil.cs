    ...
    class PowerPointConverterUtil
    {
        ...
        public void start(String dir)
        {
            try
            {
                ...
                if (m_log == null)
                {
                    m_log = Logger.Initialize(pptDir + @"\powerpoint2010Converter.log");
                }

                m_log.Log("PowerPoint 2010 Converter starting up.");
            ...
            {
                string msg = "PowerPoint 2010 Converter failed to initialize because of: " +
                    e.Message + "\r\n" + e.StackTrace;
