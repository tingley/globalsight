...
{
    public class XmlUtil3RD
    {
        public static string OutputTranslateUnits(List<TranslateUnit3RD> units)
        {
            ...
            {
                foreach (TranslateUnit3RD unit in units)
                {
        ...
        public static bool TryWriteTus(List<TranslateUnit3RD> _tus)
        {
