...
{
	/// <summary>
	/// ExcelXPConverterImpl is responsible for converting a MS Excel file to HTML and
	/// vice versa.
	/// </summary>
	public class ExcelXPConverterImpl : GlobalSight.Common.Converter
	{
		...
		/// <summary>
		/// Creates an ExcelXPConverterImpl to be used for import or export.
		/// </summary>
		/// <param name="p_conversionType"> the type of conversion (import or export)</param>
		public ExcelXPConverterImpl(ConversionType p_conversionType)
		{
		...
		public void Convert(string p_fileName, string p_language)
		{
			...
			{
				Logger.LogError("Excel XP Conversion Failed", e);
