...
{
	/// <summary>
	/// PowerPointXPConverterImpl is responsible for converting PowerPoint
	/// documents to and from HTML.
	/// </summary>
	public class PowerPointXPConverterImpl : GlobalSight.Common.Converter
	{
		...
		/// <summary>
		/// Creates a PowerPointXPConverterImpl to be used for import or export.
		/// </summary>
		/// <param name="p_conversionType"> the type of conversion (import or export)</param>
		public PowerPointXPConverterImpl(ConversionType p_conversionType)
		{
