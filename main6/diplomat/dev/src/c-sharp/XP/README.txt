...
All converters are built in Visual Studio 2003. The main solution is
OfficeConverters.sln, which includes all other projects.
...
Then run the Ambassador build with the appropriate target name. 
For example: ant ExcelXPConverter
