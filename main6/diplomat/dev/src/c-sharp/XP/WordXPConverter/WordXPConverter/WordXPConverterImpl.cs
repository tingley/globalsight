...
// Primary Interop Assemblies for Office XP are available here:
// http://download.microsoft.com/download/c/4/8/c4813cc0-a4d4-4bb4-b486-9cbd56f38235/oxppia.exe

namespace GlobalSight.WordXPConverter
{
	/// <summary>
	...
	/// HTML->RTF
	/// </summary>
	public class WordXPConverterImpl : GlobalSight.Common.Converter
	{
		...
		/// <summary>
		/// Creates a WordXPConverterImpl to be used for import or export.
		/// </summary>
		/// <param name="p_conversionType"> the type of conversion 
		/// (import or export)</param>
		public WordXPConverterImpl(ConversionType p_conversionType)
		{
		...
		public void Convert(string p_fileName, string p_language)
		{
			...
			{
				Logger.LogError("Word XP Conversion Failed", e);
		...
		private void CreateWordAppClass()
		{
			...
			m_wordApp.DefaultWebOptions().Encoding = 
				Office.MsoEncoding.msoEncodingUTF8;
		...
		private void OpenWordDoc()
		{
			...
			m_wordDoc = m_wordApp.Documents.Open(
				...
				ref missing, ref missing, ref noEncodingDialog);
