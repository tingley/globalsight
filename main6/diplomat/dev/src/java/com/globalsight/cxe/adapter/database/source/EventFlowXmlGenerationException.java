 ...
 */
public class EventFlowXmlGenerationException
    extends WrappedException
{
    ...
    private static final String DEFAULT_MSG =
        "EventFlowXml Generation Exception";
     ...
     */
    public EventFlowXmlGenerationException()
    {
        this(null, null);
    }
     ...
     */
    public EventFlowXmlGenerationException(String p_message)
    {
        this(p_message, null);
    }
     ...
     */
    public EventFlowXmlGenerationException(Exception p_exception)
    {
     ...
     * @param p_exception the exception to be wrapped.
     */
    public EventFlowXmlGenerationException(String p_message, Exception p_exception)
    {
