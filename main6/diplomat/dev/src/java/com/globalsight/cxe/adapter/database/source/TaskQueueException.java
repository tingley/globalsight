...
/**
 * Represents a generic exception that might occur when any task queue-related
    ...
    extends WrappedException
{
    ...
    // PRIVATE CONSTANTS
    //
    private static final String DEFAULT_MSG = "Task Queue Exception";
     ...
     */
    public TaskQueueException(String p_message)
    {
        this(p_message, null);
    }
     ...
     */
    public TaskQueueException(Exception p_exception)
    {
     ...
     * @param p_exception the exception to be wrapped.
     */
    public TaskQueueException(String p_message, Exception p_exception)
    {
