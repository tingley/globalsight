...
public class IdmlTagHelper
{
    ...
    public String mergeTags(String content)
    {
        ...
        for (Integer i : indexs)
        {
            ...
            if (temp1.indexOf("AppliedFont") > 0 && temp2.indexOf("AppliedFont") < 0)
            {
    ...
    private List<Integer> getStartIndexs(String content)
    {
        ...
        Collections.sort(sIndexs, new java.util.Comparator<Integer>()
        {
            @Override
    ...
    private List<Integer> removeAloneIndexs(List<Integer> starts, List<Integer> ends)
    {
        List<Integer> indexs = new ArrayList<Integer>();
