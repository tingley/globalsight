...
public class PassoloConfiguration
{
    static private final Logger CATEGORY =
        Logger.getLogger(PassoloConfiguration.class);
    ...
    static private final String PROPERTY_FILE =
        "/properties/PassoloAdapter.properties";

    static private PassoloConfiguration m_instance =
        new PassoloConfiguration();

    /**
     * Private Constructor.
     */
    private PassoloConfiguration()
    {
    }
     ...
     */
    static public PassoloConfiguration getInstance()
    {
        return m_instance;
    }
