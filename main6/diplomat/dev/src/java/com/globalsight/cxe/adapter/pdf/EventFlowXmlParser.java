...
public class EventFlowXmlParser
{
    ...
    */
    public static String setSingleElementValue(Element p_rootElement, String p_elementName, String p_value)
    {
    ...
    */
    ...
    /**
     * Returns the actual data attribute of the given category
     * <br>
     * @param p_categoryElement  The category element
     * @param p_daName  The value of the name attribute for the desired da element.
     * @return The actual data attribute element.
     */
    public Element getCategoryDa(Element p_categoryElement,
                                 String p_daName)
    {
        NodeList nl = p_categoryElement.getElementsByTagName("da");
        Element da = null;
    ...
    /**
    * Utility function to create an EventFlowXml da element containing the given values.
    * <br>
    ...
    */
    ...
    throws IOException
    {
        ...
        int bufferSize = m_eventFlowXml.length() * 2; //just double the buffer size to be safe
        StringWriter stringWriter = new StringWriter(bufferSize);
        stringWriter.write(XmlUtil.formattedEventFlowXmlDtd()); //restore the DTD
    ...
    */
    ...
    {
        return setSingleElementValue(getSingleElement("source"),"charset",p_encoding);
    }
    ...
    */
     ...
     *
     * @param p_filename The file name to give the target file upon export.
     */
    public void setTargetFileName(String p_filename)
    {
        ...
        Element newFileElement = 
            makeEventFlowXmlDaElement("Filename", filename);
