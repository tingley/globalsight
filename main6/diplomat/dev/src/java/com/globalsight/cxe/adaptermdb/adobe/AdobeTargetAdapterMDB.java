...
package com.globalsight.cxe.adaptermdb.adobe;
...
import com.globalsight.cxe.adapter.adobe.AdobeAdapter;
...
@MessageDriven(messageListenerInterface = MessageListener.class, activationConfig =
{
        @ActivationConfigProperty(propertyName = "destination", propertyValue = EventTopicMap.QUEUE_PREFIX_JBOSS
                ...
                + EventTopicMap.FOR_ADOBE_TARGET_ADAPTER),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = JmsHelper.JMS_TYPE_QUEUE) })
@TransactionManagement(value = TransactionManagementType.BEAN)
public class AdobeTargetAdapterMDB extends BaseAdapterMDB
{
    private static String ADAPTER_NAME = AdobeTargetAdapterMDB.class.getName();
