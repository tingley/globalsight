 ...
 *  
 */
package com.globalsight.cxe.adaptermdb.idml;
...
public class IdmlSourceAdapterMDB extends BaseAdapterMDB
{
    ...
    {
        return new IdmlAdapter(ADAPTER_NAME);
    }
}
