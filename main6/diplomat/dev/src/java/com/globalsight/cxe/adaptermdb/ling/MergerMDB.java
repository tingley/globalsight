 ...
 *  
 */
package com.globalsight.cxe.adaptermdb.ling;
...
public class MergerMDB extends BaseAdapterMDB
{
    ...
    {
        return new LingAdapter(ADAPTER_NAME);
    }
}
