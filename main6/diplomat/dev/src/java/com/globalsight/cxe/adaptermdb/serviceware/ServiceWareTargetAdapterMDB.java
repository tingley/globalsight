 ...
 *  
 */
package com.globalsight.cxe.adaptermdb.serviceware;
...
/**
 * ServiceWareTargetAdapterMDB uses the ServiceWareAdapter
 */
@MessageDriven(messageListenerInterface = MessageListener.class, activationConfig =
{
        @ActivationConfigProperty(propertyName = "destination", propertyValue = EventTopicMap.QUEUE_PREFIX_JBOSS
                ...
                + EventTopicMap.FOR_SERVICEWARE_TARGET_ADAPTER),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = JmsHelper.JMS_TYPE_QUEUE) })
@TransactionManagement(value = TransactionManagementType.BEAN)
public class ServiceWareTargetAdapterMDB extends BaseAdapterMDB
{
    private static String ADAPTER_NAME = ServiceWareTargetAdapterMDB.class
            .getName();
    ...
    {
        return new ServiceWareAdapter(ADAPTER_NAME);
    }
}
