...
{
    private static final long serialVersionUID = 5090128086023056603L;
    ...
    protected Source(Element p_elem)
    {
        ...
        m_pageIsCxePreviewable = Boolean.valueOf(
                XmlUtils.getAttributeValue(p_elem, PAGE_IS_CXE_PREVIEWABLE)).booleanValue();
        m_importRequestType = ImportRequestType.getImportRequestType(XmlUtils.getAttributeValue(
                p_elem, IMPORT_REQUEST_TYPE));
        m_importInitiatorId = XmlUtils.getAttributeValue(p_elem, IMPORT_INITIATOR_ID);
    }

    public boolean isValid()
    {
        return (m_locale != null) && (m_charset != null) && (m_name != null)
                && (m_dataSourceType != null) && (m_dataSourceId != null) && (m_formatType != null)
