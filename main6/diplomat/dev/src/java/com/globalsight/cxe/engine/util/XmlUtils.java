...
public class XmlUtils {
    /**
     * if the elementName is an attr of rootElement,return the attr value
     * else if elementName is a direct childElement of rootElement, return childElement value
     * 
    ...
    public static String getChildElementValue(Element p_rootElement, String p_elementName) {
    ...
    //ignore case    
    public static List getDirectChildElements(Element p_rootElement, String p_elementName) {
    	List result = new ArrayList();
    	for (Node node = p_rootElement.getFirstChild(); node != null; node = node.getNextSibling()) {
    		if (node.getNodeName().equalsIgnoreCase(p_elementName))
    ...
    public static String getElementValue(Element p_element) {
    	return p_element.getFirstChild().getNodeValue();
    }
	...
	public static StringBuffer appendElementStart(StringBuffer p_buffer, String p_name) {
		appendElementStart(p_buffer, p_name, null);
		//appendLine(p_buffer);
		return p_buffer;
	}
	
	public static StringBuffer appendElementStart(StringBuffer p_buffer, String p_name, String[][] attributes) {
	...
	public static StringBuffer appendEmptyElement(StringBuffer p_buffer, String p_name, String[][] attributes) {
		appendElementStartHead(p_buffer, p_name, attributes);
		p_buffer.append("/>");
		return p_buffer;
	}
	
	private static StringBuffer appendElementStartHead(StringBuffer p_buffer, String p_name, String[][] attributes) {
		p_buffer.append("<");
	...
	public static StringBuffer appendElementEnd(StringBuffer p_buffer, String p_name) {
		p_buffer.append("</");
		p_buffer.append(p_name);
		p_buffer.append(">");
		//appendLine(p_buffer);
	...
	public static StringBuffer appendElement(StringBuffer p_buffer, String p_name, String[][] attributes, String text) {
		if (text != null) {
	...
	public static StringBuffer appendElement(StringBuffer p_buffer, String p_name, String p_text) {
	...
	public static StringBuffer appendAttribute(StringBuffer p_buffer, String p_name, String p_value) {
		if (p_value != null) {
			p_buffer.append(" ");
			p_buffer.append(p_name);
			p_buffer.append("=\"");
