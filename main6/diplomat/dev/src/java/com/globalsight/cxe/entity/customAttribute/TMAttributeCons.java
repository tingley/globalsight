...
public class TMAttributeCons 
{
    ...
    public static final String SET_NOT = "SET_NOT";
    public static final String SET_FROM_JOBATT = "SET_FROM_JOBATT";
    public static final String SET_FROM_WFATT = "SET_FROM_WFATT";
}
