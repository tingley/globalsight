...
/**
 * The FileMessageData class represents a MessageData
 * object that is tied to particular file on the file
 * system. The data for the message is stored in that file.
 */
public class FileMessageData implements MessageData
{
    ...
    /**
     * Gets a new inputstream associated with this MessageData object
    ...
    public void operatingSystemSafeCopyTo(File p_file)
        throws IOException
    {
        if (isWindows())
        {
    ...
    public void operatingSystemSafeCopyFrom(File p_file)
        throws IOException
    {
        if (isWindows())
        {
     ...
     * @exception IOException
     */
    public void copyTo(File p_file)
        throws IOException
    {
     ...
     * @exception IOException
     */
    public void copyFrom(File p_file)
        throws IOException
    {
     ...
     * @exception IOException
     */
    public void copyFrom(MessageData p_other)
        throws IOException
    {
     ...
     *
     * @param p_from source InputStream
     * @param p_to   target OutputStream
     * @exception IOException
     */
    ...
    */
    ...
    private void doCopyNotClose(InputStream p_from, OutputStream p_to) throws IOException {
    	BufferedInputStream bis = new BufferedInputStream(p_from);
        BufferedOutputStream bos = new BufferedOutputStream(p_to);
        byte[] buf = new byte[10240];
        int count = 0;
