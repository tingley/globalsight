...
/**
 * Exception class for Database column entity.
 *
 */
public class DatabaseColumnEntityException extends GeneralException
{
    /**
     ...
     */
    public DatabaseColumnEntityException(String p_msg)
    {
        super(COMP_PERSISTENCE, EX_SQL, p_msg);
    }

    /**
     * Constructor that wraps an existing exception with DatabaseColumnEntityException.
     *
     * @param p_exception Original exception object.
     */
    public DatabaseColumnEntityException(Exception p_exception)
    {
