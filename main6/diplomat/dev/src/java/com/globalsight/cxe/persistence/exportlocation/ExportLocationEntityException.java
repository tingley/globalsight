...
public class ExportLocationEntityException extends GeneralException
{
    public ExportLocationEntityException(String p_msg)
    {
	super(COMP_PERSISTENCE, EX_SQL, p_msg);
    }

    public ExportLocationEntityException(Exception p_ex)
    {
