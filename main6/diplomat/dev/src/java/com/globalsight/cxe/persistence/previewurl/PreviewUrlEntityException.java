...
/**
 * Exception class for Preview Url entity.
 *
 */
public class PreviewUrlEntityException extends GeneralException
{
    /**
     ...
     */    
    public PreviewUrlEntityException(String p_msg)
    {
    	super(COMP_PERSISTENCE, EX_SQL, p_msg);
    }

    /**
     * Constructor that wraps an existing exception with PreviewUrlEntityException.
     *
     * @param p_exception Original exception object.
     */    
    public PreviewUrlEntityException(Exception p_exception)
    {
