...
public class XmlRuleFileEntityException extends GeneralException
{
    public XmlRuleFileEntityException(String p_msg)
    {
	super(COMP_PERSISTENCE, EX_SQL, p_msg);
    }

    public XmlRuleFileEntityException(Exception p_ex)
    {
