...
public class DJ_Extension extends WrapExtensionTable
{
    ...
    static private final String ORDER_BY_ID = "SELECT EXTENSION_ID, EXTENSION_NAME FROM " + EXTENSION + " ORDER BY " + EXTENSION_ID;
    static private final String ORDER_BY_EXTENSION = "SELECT EXTENSION_ID, EXTENSION_NAME FROM " + EXTENSION + " ORDER BY " + EXTENSION_NAME;
    ...
    public DJ_Extension (long p_id)
    {
        ...
        try 
        {
            ...
            String sql = "SELECT " + EXTENSION_NAME + " FROM " + EXTENSION + " WHERE " + 
                EXTENSION_ID + " = " + p_id;
	...
	public void deleteEntry()
	{
		...
		{
		    connection = ConnectionPool.getConnection();
		    String sql = "DELETE FROM " + EXTENSION + " WHERE " + EXTENSION_ID + " = " + m_id;	
	...
	try {
	    connection = ConnectionPool.getConnection();
	    String sql = "INSERT INTO " + EXTENSION + " VALUES(" + INCREMENT_EXTENSION_ID + ".NEXTVAL," +
