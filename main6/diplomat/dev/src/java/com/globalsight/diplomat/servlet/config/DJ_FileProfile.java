...
public class DJ_FileProfile
{
    ...
    public DJ_FileProfile(long p_id)
    {
        ...
        try
        {
            ...
            String sql = "SELECT NAME, KNOWN_FORMAT_TYPE_ID, RULE_ID FROM " + FILE_PROFILE + " WHERE " + FILE_PROFILE_ID + " = " + m_id;
	...
	public void deleteEntry()
	{
		...
		if (m_id > 0)
		{
		    String sql = "DELETE FROM " + FILE_PROFILE + " WHERE " + FILE_PROFILE_ID + " = " + m_id;	
	...
	public void update()
	{
		...
		if (m_rule > 0)
		    {
			sql = "UPDATE " + FILE_PROFILE + " SET " + NAME + "=" + Utility.quote(m_name) + ", " +
			    DATA_TYPE + "=" + m_type + ", " + RULE_ID + "=" + m_rule +
			    " WHERE " + FILE_PROFILE_ID + "=" + m_id;
		    }
		else
		    {
			sql = "UPDATE " + FILE_PROFILE + " SET " + NAME + "=" + Utility.quote(m_name) + ", " +
			    DATA_TYPE + "=" + m_type + " WHERE " + FILE_PROFILE_ID + "=" + m_id;        
		    }
	        connection.createStatement().executeUpdate(sql);
	    }
	    catch (ConnectionPoolException cpe) {
	...
	try {
		...
		{   
		    sql = "INSERT INTO " + FILE_PROFILE + "( " + FILE_PROFILE_ID + "," + NAME + 
			"," + DATA_TYPE + ") VALUES(" + m_id + ", " +
