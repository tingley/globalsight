...
/**
 * WrappedException represents an abstract exception that wraps other
    ...
    extends Exception
{
     ...
     */
    public WrappedException(String p_message, Exception p_exceptionToWrap)
    {
        super(p_message);
