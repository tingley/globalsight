...
public class UserCalendarWorkingDayTest extends TestCase
{
	private int day = 8;
	...
	public void testSave() throws Exception
	{
		...
		UserFluxCalendar fluxCalendar = (UserFluxCalendar) HibernateUtil.get(
				UserFluxCalendar.class, 1);

		UserCalendarWorkingDay workingDay = new UserCalendarWorkingDay(day);
    ...
    {
        String hql = "from UserCalendarWorkingDay d where d.day = '" + day + "'";
