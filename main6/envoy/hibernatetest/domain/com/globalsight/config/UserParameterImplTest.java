...
public class UserParameterImplTest extends TestCase
{
    ...
    {
        UserParameterImpl impl = new UserParameterImpl();
        impl.setUserId("222");
        impl.setName("s");
    ...
    public void testGet() throws Exception
    {
        ...
        for (int i = 0; i < ids.size(); i++)
        {
            ...
            UserParameterImpl impl = (UserParameterImpl) HibernateUtil.get(
                    UserParameterImpl.class, id);
