...
public class DBConnectionImplTest extends TestCase
{
    ...
    public void testGet() throws Exception
    {
        ...
        for (int i = 0; i < ids.size(); i++)
        {
            ...
            DBConnectionImpl impl = (DBConnectionImpl) HibernateUtil.get(
                    DBConnectionImpl.class, id);
