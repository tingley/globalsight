...
public class FileExtensionImplTest extends TestCase
{
    ...
    {
        FileExtensionImpl impl = new FileExtensionImpl();
        impl.setName("s");
        impl.setCompanyId("1");
    ...
    public void testGet() throws Exception
    {
        ...
        for (int i = 0; i < ids.size(); i++)
        {
            ...
            FileExtensionImpl impl = (FileExtensionImpl) HibernateUtil.get(
                    FileExtensionImpl.class, id.longValue());
