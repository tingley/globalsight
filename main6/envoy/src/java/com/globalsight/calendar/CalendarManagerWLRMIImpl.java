...
/**
 * This class represents the remote implementation of a Calendar Manager.
 * Note that all of the methods of this class throw the following exceptions:
 * 1. CalendarManagerWLRMIImpl - For component related errors.
 * 2. RemoteException - For network related exception.
 */

public class CalendarManagerWLRMIImpl
    extends RemoteServer
    implements CalendarManagerWLRemote
{
     ...
     */
    public CalendarManagerWLRMIImpl()
    ...
    /**
     * @see CalendarManager.computeCalendarIntervals(
     *      UserFluxCalendar, Timestamp)
     */
    public FluxCalendar computeCalendarIntervals(
        FluxCalendar p_calendar,
        Timestamp p_startDate)
        throws RemoteException, CalendarManagerException
    {
        return m_localInstance.computeCalendarIntervals(
            p_calendar, p_startDate);
    }

    /**
     * @see CalendarManager.computeUserCalendarIntervals(
     *      UserFluxCalendar, Timestamp)
     */
    public UserFluxCalendar computeUserCalendarIntervals(
        ...
        throws RemoteException, CalendarManagerException
    {
        return m_localInstance.computeUserCalendarIntervals(
            p_userCalendar, p_startDate);
    }
    ...
    public FluxCalendar createCalendar(FluxCalendar p_calendar,
        ...
        throws RemoteException, CalendarManagerException
    {
        return m_localInstance.createCalendar(p_calendar,
                                              p_creatorUserId);
    }
     ...
     */
    public Holiday createHoliday(Holiday p_holiday)
        throws RemoteException, CalendarManagerException
    {
    ...
    public UserFluxCalendar createUserCalendar(UserFluxCalendar p_calendar,
        ...
        throws RemoteException, CalendarManagerException
    {
        return m_localInstance.createUserCalendar(p_calendar, 
                                                  p_creatorUserId);
    }
     ...
     */
    public Holiday findHolidayById(long p_holidayId)
        throws RemoteException, CalendarManagerException
    {
    ...
    public Collection findReservedTimesByOwnerAndTaskId(String p_userId,
        ...
        throws RemoteException, CalendarManagerException
    {
        return m_localInstance.findReservedTimesByOwnerAndTaskId(
            p_userId, p_taskId);
    }
    ...
    public List findReservedTimesForGivenDate(long p_userCalendarId,
        ...
        throws RemoteException, CalendarManagerException
    {
        return m_localInstance.findReservedTimesForGivenDate(
            p_userCalendarId, p_date);
    }
     ...
     */
    public TimeZone findUserTimeZone(String p_userId)
        throws RemoteException, CalendarManagerException
    {
     ...
     */
    public List getAllUserCalendars()
        throws RemoteException, CalendarManagerException
    {
     ...
     */
    public void importEntries(List p_entries)
        throws RemoteException, CalendarManagerException
    {
     ...
     */
    public void makeDefaultCalendar(long p_calendarId,
                                    String p_modifierUserId)
        throws RemoteException, CalendarManagerException
    {
        m_localInstance.makeDefaultCalendar(p_calendarId,
                                            p_modifierUserId);
    }
    ...
    public FluxCalendar modifyCalendar(FluxCalendar p_calendar,
        ...
        throws RemoteException, CalendarManagerException
    {
        return m_localInstance.modifyCalendar(p_calendar, 
                                              p_modifierUserId);
    }
     ...
     */
    public Holiday modifyHoliday(Holiday p_holiday)
        throws RemoteException, CalendarManagerException
    {
    ...
    public UserFluxCalendar modifyUserCalendar(UserFluxCalendar p_userCalendar,
        ...
        throws RemoteException, CalendarManagerException
    {
        return m_localInstance.modifyUserCalendar(
            p_userCalendar, p_modifierUserId);
    }
     ...
     */
    public void removeCalendar(long p_calendarId)
        throws RemoteException, CalendarManagerException
    {
     ...
     */
    public void removeHoliday(long p_holidayId)
        throws RemoteException, CalendarManagerException
    {
     ...
     */
    public HashMap userUnavailabilityReport(
        List p_userInfos, int p_month, int p_year)
        throws RemoteException, CalendarManagerException
    {
        return m_localInstance.userUnavailabilityReport(
            p_userInfos, p_month, p_year);
    }
