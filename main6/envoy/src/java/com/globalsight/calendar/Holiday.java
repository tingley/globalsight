 ...
 * only used by schedule engine (Quartz) and is defined when a holiday object is created.
 * Time expression is a description of a rule that is used to compute a
