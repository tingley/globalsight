...
/**
 * <p>This interface defines the names of user-definable parameters
 * that users can set using small option dialogs and that are stored
 * in the USER_PARAMETER table.</p>
 *
 * <p>Options that affect the same component should be arranged in
 * groups having the same prefix. This will make it easier to design
 * option dialogs.</p>
 */
public interface UserParamNames
{
    ...
    public static final String PAGENAME_DISPLAY_DEFAULT =
        PAGENAME_DISPLAY_FULL;
    ...
    //////////////////////////////////////////////////////////////////////
    // ADMIN
    public static final String NOTIFY_INITIAL_IMPORT_FAILURE =
        "notifyInitilaImportFailure";
    // PM/WFM
    public static final String NOTIFY_JOB_DISCARD_FAILURE =
        "notifyJobDiscardFailure";
    public static final String NOTIFY_READY_TO_DISPATCH =
        "notifyReadyToBeDispatched";
    public static final String NOTIFY_DISPATCH_FAILURE =
        "notifyDispatchFailure";
    public static final String NOTIFY_IMPORT_FAILURE =
        "notifyImportFailure";
    public static final String NOTIFY_IMPORT_CORRECTION =
        "notifyImportCorrection";
    public static final String NOTIFY_DELAYED_REIMPORT_FAILURE =
        "notifyDelayedReimportFailure";
    public static final String NOTIFY_TASK_ACCEPTANCE =
        "notifyTaskAcceptance";
    public static final String NOTIFY_TASK_COMPLETION =
        "notifyTaskCompletion";
    public static final String NOTIFY_TASK_REJECTION =
        "notifyTaskRejection";
    public static final String NOTIFY_PM_CHANGE_IN_PROJECT =
        "notifyPmChangeInProject";
    public static final String NOTIFY_NO_AVAILABLE_RESOURCE =
        "notifyNoAvailableResource";
    public static final String NOTIFY_EXPORT_SOURCE_FAILURE =
        "notifyExportSourceFailure";
    public static final String NOTIFY_ESTIMATED_EXCEEDS_PLANNED_DATE =
        "notifyEstimatedExceedsPlannedDate";
    public static final String NOTIFY_ADD_WORKFLOW_TO_JOB_FAILURE =
        "notifyAddWfToJobFailure";
    public static final String NOTIFY_STF_CREATION_FAILURE =
        "notifyStfCreationFailure";
    public static final String NOTIFY_SCHEDULING_FAILURE =
        "notifyDeadlineScheduleFailure";
    public static final String NOTIFY_ACTIVITY_DEADLINE =
    ...
    public static final String NOTIFY_OVERDUE_USER_DEFAULT = "0";
     ...
     // LP, LM,..
    public static final String NOTIFY_DELAYED_REIMPORT =
        "notifyDelayedReimport";
    public static final String NOTIFY_NEWLY_ASSIGNED_TASK =
        "notifyNewlyAssignedTask";
    public static final String NOTIFY_WORKFLOW_DISCARD =
        "notifyWorkflowDiscard";
    public static final String NOTIFY_EXPORT_FOR_UPDATE =
        "notifyExportForUpdate";
    public static final String NOTIFY_EXPORT_COMPLETION =
        "notifyExportCompletion";
    public static final String NOTIFY_SUCCESSFUL_UPLOAD =
        "notifySuccessfulUpload";
    public static final String NOTIFY_SAVING_SEGMENTS_FAILURE =
        "notifySavingSegmentsFailure";
    public static final String NOTIFY_BATCH_ALIGNMENT_SUCCESS =
        "notifyBatchAlignmentSuccess";
    public static final String NOTIFY_BATCH_ALIGNMENT_FAILURE =
        "notifyBatchAlignmentFailure";
    public static final String NOTIFY_ALIGNMENT_UPLOAD_SUCCESS =
        "notifyAlignmentUploadSuccess";
    public static final String NOTIFY_ALIGNMENT_UPLOAD_FAILURE =
        "notifyAlignmentUploadFailure";
    ...
    public static final String EDITOR_AUTO_ADJUST_WHITESPACE =
        "editor_autowhite";
    ...
    public static final String DOWNLOAD_OPTION_FORMAT_DEFAULT = "rtfTrados";
    ...
    public static final String DOWNLOAD_OPTION_RESINSSELECT_DEFAULT = "resInsAtns";
    ...
    public static final String DOWNLOAD_OPTION_CONSOLIDATE_TMX_DEFAULT = "no";
    ...
    public static final String DOWNLOAD_OPTION_TERMINOLOGY_DEFAULT = "termNone";
    
    public static final String DOWNLOAD_OPTION_CONSOLIDATE_TERM = "consolidateTerm";
    public static final String DOWNLOAD_OPTION_CONSOLIDATE_TERM_DEFAULT = "no";
