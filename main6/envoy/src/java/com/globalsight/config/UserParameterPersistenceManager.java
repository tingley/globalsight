...
public interface UserParameterPersistenceManager
{
    ...
    public static final String SERVICE_NAME =
        "UserParameterPersistenceManager";

    /**
     * Update specified user parameter in data store.
     *
     * @param p_userParam User Parameter object to modify
     * @throws RemoteException Application Server Error
     * @throws UserParameterEntityException Error updating user
     ...
     *
     * @param p_id Id of user parameter to retreive
     * @throws RemoteException Application Server Error
     * @throws UserParameterEntityException Error retrieving a
     * specific user parameter.
     * @return  User parameter object with matching id
     */
    public UserParameter getUserParameter(long p_id)
        throws RemoteException, UserParameterEntityException;

    /**
     * Retrieve a specific user parameter object with passed parameter
     * name.
     *
     * @param p_name user parameter to retreive
     * @throws RemoteException Application Server Error
     * @throws UserParameterEntityException Error retrieving a
     * specific user parameter.
    ...
    /**
     * Return all user parameter objects from data store for a
     * specific user.
     *
     * @throws RemoteException Application Server Error
     * @throws UserParameterEntityException Error getting collection
     * of user parameters from data store.
    ...
    /**
     * Return all user parameter objects from data store for a
     * specific user in a HashMap.
     *
     * @throws RemoteException Application Server Error
     * @throws UserParameterEntityException Error getting map of user
     * parameters from data store.
     * @return HashMap of all user parameters, indexed by parameter name
     */
    public HashMap getUserParameterMap(String p_userId)
        throws RemoteException, UserParameterEntityException;
}
