...
public class BlaiseConnectorFilter
{
    ...
    public List<BlaiseConnector> filter(List<BlaiseConnector> conns)
    {
        List<BlaiseConnector> result = new ArrayList<BlaiseConnector>();
        
        for (BlaiseConnector conn : conns)
        {
