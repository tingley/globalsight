...
/**
 * An exception thrown during the process of using the AlignerManager api.
 */
public class AlignerManagerException
    extends GeneralException
{
    /**
     * Create a AlignerManagerException with the specified message.
     *
     ...
     */
    public AlignerManagerException(String p_messageKey,
    ...
    public AlignerManagerException(Exception p_exception)
    {
        super(p_exception);
    }
