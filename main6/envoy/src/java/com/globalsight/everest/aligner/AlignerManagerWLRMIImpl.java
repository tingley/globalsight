...
/**
 * This class represents the remote implementation of AlignerManager
 */
public class AlignerManagerWLRMIImpl
    extends RemoteServer
    implements AlignerManagerWLRemote
{
    private AlignerManager m_localInstance = null;

    public AlignerManagerWLRMIImpl()
        throws RemoteException, AlignerManagerException
    {
        super(SERVICE_NAME);
        m_localInstance = new AlignerManagerLocal();
    }
    ...
    public void batchAlign(
        ...
        throws RemoteException, AlignerManagerException
    {
        m_localInstance.batchAlign(p_alignerPackageOptions, p_user);
    }
    ...
    public List getAllPackages()
        throws RemoteException, AlignerManagerException
    {
        return m_localInstance.getAllPackages();
    }
    ...
    public List getErrorMessages(String p_packageName)
        throws RemoteException, AlignerManagerException
    {
        return m_localInstance.getErrorMessages(p_packageName);
    }
    ...
    public void deletePackage(String p_packageName)
        throws RemoteException, AlignerManagerException
    {
        m_localInstance.deletePackage(p_packageName);
    }
