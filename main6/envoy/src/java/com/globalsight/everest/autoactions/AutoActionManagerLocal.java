...
public class AutoActionManagerLocal
{
    ...
    public AutoAction getAutoActionByName(String p_name)
    {
        ...
        {
            c_logger.error(
                    "Persistence Exception when retrieving auto activities "
                            + p_name, pe);
        }
    ...
    public void createAction(AutoAction p_action) throws RemoteException,
            AutoActionException
    {
    ...
    public void updateAction(AutoAction p_action) throws RemoteException,
            AutoActionException
    {
        Session session = null;
        Transaction transaction = null;
