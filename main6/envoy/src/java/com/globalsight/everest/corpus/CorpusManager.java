...
/**
 * This is the interface of the CorpusManager. It provides methods for accessing the corpus TM.
 */
public interface CorpusManager
{
    public static final String SERVICE_NAME = "CorpusManager";
     ...
     * @return CorpusDoc
     */
    CorpusDoc getCorpusDoc(Long p_id) throws RemoteException, CorpusException;
     ...
     * 
     * @param p_locale source locale
     * @param p_name   name of the document
     * @param p_gxmlContent
     *                 string of GXML content
     * @param p_binaryContent
     *                 File of the binary data
     * @param p_deleteBinary -- true if the binary file should be deleted
     ...
     * @param p_canStoreNativeFormatDosc
     ...
     * @exception CorpusException
     */
    void mapSegmentsToCorpusDoc(List<TuvMapping> p_segments, CorpusDoc p_doc) throws RemoteException, CorpusException;
     ...
     * @exception CorpusException
     */
    ArrayList getCorpusContextsForSegment(long p_projectTuvId, long p_sourceLocaleId)
    throws RemoteException, CorpusException;
