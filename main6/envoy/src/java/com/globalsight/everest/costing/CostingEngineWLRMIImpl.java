 ...
 *  manages the objects needed for costing and calculates the cost of
 * various objects in the system (i.e. Job, Workflow).
 * Note that all of the methods of this class throw the following exceptions:
 * 1. CostingException - For costing related errors.
 * 2. RemoteException - For network related exception.
 */
public class CostingEngineWLRMIImpl 
    extends RemoteServer implements CostingEngineWLRemote
{
        ...
        throws SystemStartupException
    {
        ...
        try
        {
            ...
            boolean costingEnabled = sc.getBooleanParameter(
            ...
            if (costingEnabled)
            {
                ...
                {
                    String errorMessage = 
                        new String("The pivot currency failed to be set, the costing engine failed to start.");
                    c_logger.error(errorMessage);
                    throw new SystemStartupException(SystemStartupException.COMP_COSTING, 
                                                     errorMessage);
                }   
            }
            ...
            ServerProxy.getSystemParameterPersistenceManager().
                registerListener(this, SystemConfigParamNames.PIVOT_CURRENCY);
       }
       catch (CostingException ce)
       {
           c_logger.error("CostingException when loading currencies.", ce);
           throw new SystemStartupException(SystemStartupException.COMP_COSTING, ce);
       } 
       catch (Exception e)
       {
           ...
           throw new SystemStartupException(SystemStartupException.COMP_COSTING, e);
       }
    }           
     ...
     */
    public Vector getIsoCurrencies()
     ...
     */
    public Vector getIsoCurrenciesWithoutConversion()
        throws RemoteException, CostingException
    {
     ...
     */
    public IsoCurrency getIsoCurrency(String p_isoCode)
        throws RemoteException, CostingException
    {
     ...
     * @see CostingEngine.getCurrency(String)
     */
    public Currency getCurrency(String p_isoCodes)
        throws RemoteException, CostingException
    {
    ...
    /** 
     * Implementation of the SystemParameterChangeListener.listen(String, String)
     * method.  Passes on to the local instance to handle any processing
    ...
    {
        m_localInstance.listen(p_systemParameterName,
                               p_newSystemParameterValue);
    }
                                                 
    /**
     * @see CostingEngine.addRate(Rate)
     */
    public Rate addRate(Rate p_rate)
        throws RemoteException, CostingException
    {
     ...
     */
    public void modifyRate(Rate p_rate)
        throws RemoteException, CostingException
    {
     ...
     */
    public void deleteRatesOnRole(Role p_role)
        throws CostingException, RemoteException
    {
    ...
    /**
     * @see CostingEngine.getRates(Activity, GlobalSightLocale, GlobalSightLocale)
     */
    public Collection getRates(Activity p_activity, GlobalSightLocale p_sourceLocale,
                               GlobalSightLocale p_targetLocale)
        throws RemoteException, CostingException
    {
        return m_localInstance.getRates(p_activity, p_sourceLocale, p_targetLocale);
    }
     ...
     */
      ...
      */
     public Cost overrideCost(WorkObject p_obj, float p_overrideCost, int p_costType)
        throws RemoteException, CostingException
     {
      ...
      */
      public Cost addSurcharge(long p_costId, Surcharge p_newSurcharge, int p_costType)
            throws RemoteException, CostingException
      {
          return m_localInstance.addSurcharge(p_costId, p_newSurcharge, p_costType);
      }
    ...
    /**
      ...
      */
    public Cost removeSurcharge(long p_costId, String p_surchargeName, int p_costType)
        throws RemoteException, CostingException
    {
        return m_localInstance.removeSurcharge(p_costId, p_surchargeName, p_costType);
    }
    ...
    public void setEstimatedAmountOfWorkInJob(long p_jobId, int p_unitOfWork,
        ...
        throws RemoteException, CostingException
    {
        m_localInstance.setEstimatedAmountOfWorkInJob(p_jobId, p_unitOfWork, p_amount);
    }

    /**
     * @see CostingEngine.getEstimatedAmountOfWorkInJob(long, int, int)
     */
    public float getEstimatedAmountOfWorkInJob(long p_jobId, int p_unitOfWork, int p_costType)
        throws RemoteException, CostingException
    {
        return m_localInstance.getEstimatedAmountOfWorkInJob(p_jobId, p_unitOfWork, p_costType);
    }
    ...
    public void setEstimatedAmountOfWork(long p_taskId, int p_unitOfWork,
        ...
        throws RemoteException, CostingException
    {
        m_localInstance.setEstimatedAmountOfWork(p_taskId, p_unitOfWork, p_amount);
    }
     ...
     */
    public void calculateCost(long p_jobId, Currency p_currency, boolean p_recalculate, int p_costType)
        throws RemoteException, CostingException
    {
        m_localInstance.calculateCost(p_jobId, p_currency, p_recalculate, p_costType);
    }

     /**
      * @see CostingEngine.calculateCost(Job, Currency, boolean, int)
      */
     public Cost calculateCost(Job p_job, Currency p_currency, boolean p_recalculate, int p_costType)
         throws RemoteException, CostingException
     {
         return m_localInstance.calculateCost(p_job, p_currency, p_recalculate, p_costType);
     }
     /**
    ...
    public Cost calculateCost(Workflow p_workflow, Currency p_currency,
        ...
        throws RemoteException, CostingException
    {
        return m_localInstance.calculateCost(p_workflow, p_currency, p_recalculate, p_costType);
    }
    
    /**
     * @see CostingEngine.calculateCost(Workflow, boolean, int)
     */
    public Cost calculateCost(Workflow p_workflow, boolean p_recalculate, int p_costType)
        throws RemoteException, CostingException
    {
        return m_localInstance.calculateCost(p_workflow, p_recalculate, p_costType);
    }

    /**
     * @see CostingEngine.calculateCost(Task, Currency, boolean, int)
     */
    public Cost calculateCost(Task p_task, Currency p_currency, boolean p_recalculate, int p_costType)
        throws RemoteException, CostingException
    {
        return m_localInstance.calculateCost(p_task, p_currency, p_recalculate, p_costType);
    }
    ...
    /**
     * @see CostingEngine.calculateCost(Workflow, Currency, boolean, int, boolean)
     */
    public Cost calculateCost(Workflow p_workflow, Currency p_currency,
            boolean p_recalculate, int p_costType, boolean p_recalcFinishedWorkflow)
    throws RemoteException, CostingException 
    {
        return m_localInstance.calculateCost(p_workflow, p_currency, p_recalculate, 
                p_costType, p_recalcFinishedWorkflow);
    }
	...
	public float getFactor(Currency currency, String targetName, String companyId) throws RemoteException, CostingException, GeneralException
	{		
		return m_localInstance.getFactor(currency, targetName, companyId);
	}
	
	public Currency getCurrencyByName(String targetName, String companyId) throws RemoteException, CostingException, GeneralException
	{		
