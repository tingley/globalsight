 ...
 * 
 */
public class COTIXmlSchemaST4 extends COTIXmlBase
{
    public COTIXmlSchemaST4(Element root)
    {
        this.root = root;
    }
    ...
    public List<COTIDocument> createDocuments()
    {
        ...
        Element files = getFirstElement(projectE, "translation");
        ...
        if (nodelist != null && nodelist.getLength() > 0)
        {
            for (int i = 0; i < nodelist.getLength(); i++)
            {
                ...
                if (n.getNodeType() == Node.ELEMENT_NODE)
                {
                    ...
                    String fileType = file.getAttribute("type");
