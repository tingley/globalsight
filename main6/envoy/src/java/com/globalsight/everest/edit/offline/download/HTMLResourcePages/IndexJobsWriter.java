...
public class IndexJobsWriter
    extends DownloadWriter
    implements DownloadWriterInterface
{
    static private final String INDEX_PAGE = "IndexPage";
    static private final int PARAM_COUNT = 5;
    static private final String RESOURCE_FILE = "IndexJobsWriter";
    ...
    private String[] makeParamList()
    {
        ...
        params[1] = JOB_LIST_FILE;
        params[2] = JOBS_DIR + "/" + m_jobId + ".html";
        params[3] = RESOURCE_DIR + "/" + m_pageId + "/" + SEG_ID_LIST_FILE;
        params[4] = RESOURCE_DIR + "/" + m_pageId + "/" + m_pageId + ".html";
        return params;
    }
