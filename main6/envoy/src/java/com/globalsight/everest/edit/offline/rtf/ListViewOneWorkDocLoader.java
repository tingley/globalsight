        ...
        AmbassadorDwUpConstants, PseudoConstants
{
    ...
    /** The GlobalSight segment ID of the current segment being read (123_45). */
    ...
    private StringBuffer m_segmentRun = new StringBuffer();
    ...
    /** Creates a new instance of ListViewOneWorkDocLoader. */
    public ListViewOneWorkDocLoader(RtfDocument p_rtfDoc, OfflinePageData p_opd)
    {
        m_rtfDoc = p_rtfDoc;
        m_opd = p_opd;
    ...
    private void load(RtfText p_object) throws Exception
    {
        ...
        if (matcher.match(p_object.getData()))
        {
            String tuId = matcher.getParen(2);
            ...
            if (subId != null)
            {
                m_curSegId = tuId + BOOKMARK_SEG_ID_DELIM + subId;
            }
        }
