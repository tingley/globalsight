...
@XmlType(name = "", propOrder = { "skeleton", "any", "notes", "unitOrGroup" })
...
public class File
{
    ...
    @XmlElements({ @XmlElement(name = "unit", type = Unit.class),
     ...
     * 
     * @return possible object is {@link Skeleton }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link Skeleton }
     * 
     */
