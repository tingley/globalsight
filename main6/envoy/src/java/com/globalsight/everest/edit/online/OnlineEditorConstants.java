...
public class OnlineEditorConstants
{
    ...
    public static List<String> SEGMENT_FILTERS_ALL;
    static
    {
        SEGMENT_FILTERS_ALL = new ArrayList<String>();
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_ALL);
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_ALL_EXCEPT_ICE);
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_ALL_EXCEPT_ICE_AND_100);
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_ICE);
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_100);
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_MACHINETRANSLATION);
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_REPEATED);
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_REPETITIONS);
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_MODIFIED);
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_NO_TRANSLATED);
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_APPROVED);
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_COMMENTED);
        SEGMENT_FILTERS_ALL.add(SEGMENT_FILTER_PERPLEXITY);
    }
}
