    ...
    implements Role
{
    ...
    public String toString()
    {
        return "Role m_name=" + (getName()!=null?getName():"null")
                + " m_activity=" + (m_activity!=null?m_activity.getName():"null")
                + " m_sourceLocale=" + (m_sourceLocale!=null?m_sourceLocale:"null")
                + " m_targetLocale=" + (m_targetLocale!=null?m_targetLocale:"null")
                + " m_rates= " + (m_rates!=null?m_rates.toString():"null")
                ;
    }


    public boolean isRoleValid() {
        if (m_activity != null && m_sourceLocale != null && m_targetLocale != null) {
            return true;
        }
    ...
    public boolean equals(Object o)
    {
        ...
        if (getSourceLocale().toString().equals(role.getSourceLocale().toString()) &&
            getTargetLocale().toString().equals(role.getTargetLocale().toString()) &&
