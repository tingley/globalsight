...
public class GSEditionActivityManagerLocal
{
    ...
    public GSEditionActivity getGSEditionActionByName(String p_name,
            GSEdition gsEdition)
    {
    ...
    public void updateGSEditionActivity(GSEditionActivity p_action)
            throws RemoteException, GSEditionException
    {
        Session session = null;
        Transaction transaction = null;
        try
        {
            session = HibernateUtil.getSession();
            transaction = session.beginTransaction();
            GSEditionActivity oldAction = getGSEditionActivityByID(p_action
                    .getId());
    ...
    public Collection getAllActions()
    {
        ...
        {
            c_logger.error(
                    "PersistenceException while retrieving all GS Edition Actons.",
                    pe);
        }
