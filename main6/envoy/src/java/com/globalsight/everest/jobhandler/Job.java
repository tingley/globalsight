    ...
    extends WorkObject
{
    ...
    /*
     * Returns the due date of the job - ie. the latest due date of
     *    its workflows.
     *
     * @return Date The due date of the job or NULL if the date
     *              can't be calculated yet (the job must be dispatched).
     */
    ...
    /** 
     * Remove the overriden word count.  The word count will
     * be calculated again from all the source page word counts.
     */
    public void clearOverridenWordCount();

    /**
     * Returns 'true' if the word count has been overriden
     *         'false' if it hasn't and is still being calculated
     */ 
    ...
    /**
     * Return all the source pages in the job that contain
     * the specified primary file type.
     ...
     * This defaults to the number of requests but can be changed by the user.
     */
    ...
    */
    ...
    /** 
     * Sets the number of pages in a job.
     * This defaults to the number of requests, but can be overriden.
     */
    public void setPageCount(int p_numOfPages);

    /**
     * Get the leverage match threshold for this job. The value
     * is the original TM Profile's leverage match threshold
     * from when this job was created.
     *
     * @return The leverage match threshold that was originally
     * set during import.
     */
     ...
     *
     * @param p_leverageMatchThreshold The value set from the
     * TM Profile's during the import process.
     */
     ...
     * <p>
     * @param p_quoteDate The quotation email date of this job.
     */
      ...
      * @param p_quoteApprovedDate  Approved Quote Date.
      */     
      ...
      * @param p_quotePoNumber The quote PO number by user set.
      */     
