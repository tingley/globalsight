...
/**
 * JobHandler is an interface used for handling and delegating job related processes.
 */
public interface JobHandler
{
    ...
    /**
     * Cancel the entire job and all its workflow.
     * This is used by the server and not the GUI so
     * no user id or session id is passed in.
     *
     ...
     *
     * @param p_job - The job to cancel
     * @param p_boolean - from reimport?
     */
    public void cancelJob(Job p_job, boolean p_reimport)
        throws RemoteException, JobException;

    /**
     * Cancel the entire job and all its workflows.
     * This is used by the server/API and not the GUI
     * so no session id is passed in.
     *
     * @param p_jobId - The id of the job to cancel.
     */
    public void cancelJob(long p_jobId)
        throws RemoteException, JobException;
     ...
     * <p>
     * @param p_activity - The activity to be created.
     *
     ...
     */
    public Activity createActivity(Activity p_activity)
        throws RemoteException, JobException;

    /**
     * Get the activity with the specified name.
     * <p>
     * @param p_activityName - The name of the activity to find.
     */
    public Activity getActivity(String p_activityName)
        throws RemoteException, JobException;
     ...
     * <p>
     * @param p_activityName - The name of the activity to find.
     * @param p_companyId - The id of the company this activity belongs to.
     */
     ...
     * <p>
     * @param p_company - The company to be created.
     *
     ...
     * <p>
     * @param p_companyName - The name of the company to find.
     */
    public Company getCompany(String p_companyName)
        throws RemoteException, JobException;
    
    /**
     * Get the company with the specified id.
     * <p>
     * @param p_companyName - The id of the company to find.
     */
    public Company getCompanyById(long p_companyId)
        throws RemoteException, JobException;
    
    public Collection getAllDtpActivities() 
		throws RemoteException, JobException;

    public Collection getAllTransActivities() 
		throws RemoteException, JobException;
     ...
     * Remove an company.
     * <p>
     * @param p_company - The company to be removed.
     * @exception java.rmi.RemoteException Network related exception.
     * @exception JobException Component related exception.
     */
    public void removeCompany(Company p_company)
        throws RemoteException, JobException;

    /**
     * Modify an company's description.
     * <p>
     * @param p_company - The company to be updated.
     * @exception java.rmi.RemoteException Network related exception.
     * @exception JobException Component related exception.
     */
    public void modifyCompany(Company p_company)
        throws RemoteException, JobException;
     ...
     */
    public Job getJobById(long p_jobId)
        throws RemoteException, JobException;
     ...
     * <p>
     * @param p_state The state interested in.
    ...
    /**
     * Get a list of jobs based on the given list of states.  The
     * query could optionally be limited in terms of job creation date
     * (i.e. from the past 30 days or any value specified in envoy.properties).
     * 
     * @param p_listOfStates - A list of valid job states.
     * @param p_queryLimitByDate - True if the query should be limited.
     *
    ...
    public Collection getSourcePageByJobId(long p_jobId)
        throws RemoteException, JobException;
    /**
     * Returns all the source pages associated with the specified job id
     * and contain a primary file of the specified type.
     ...
     *
     * @param p_sourcePageId - the unique identifier of the source page.
     * 
     * @return Either the job that contains that source page or NULL
     *         if a job doesn't contain that page.
     */
    public Job findJobOfPage(long p_sourcePageId)
        throws RemoteException, JobException;
    
    /**
     * Cancel all the error pages in an IMPORT_FAIL job,
     * so releases the job to be dispatched or accept
     * more requests.
     * <p>
     * @param p_idOfUserRequestingCancel
     ...
     */
      ...
      *
      * @param p_job The job to update the page count of.
      * @param p_pageCount  The new number of pages.
      ...
      *
      * @param p_job The job to update the quotation email date of.
      * @param p_quoteDate  The new date of quotation email.
      */
      ...
      * 
      * @param p_job The job to update the Approved Quotedate of.
      * @param p_quoteApprovedDate  The new date of Approved Quote.
      */
      ...
      *
      * @param p_job The job to update the PO Number of Quote.
      * @param p_quotePoNumber  The PO Number of Quote.
      */
     ...
     /**
      * Overrides the total word count (source page word count) for
      * the job.  This is an overriden word count and is not
      * necessarily the total of all the source page word counts.
      * 
      * @param p_job The job to override/ update the word count of.
      * @param p_wordCount The word count amount that overrides the
     ...
     /**
      * Removes the overriden word count on a job.
      * Not the total word count will be calculated from all the source pages
      * in the job.
      * 
      * @param p_job The job to remove the overriden word count from.
      */
     public Job clearOverridenWordCount(Job p_job)
        throws RemoteException, JobException;

    /**
     * Modify an activity's description.
     * <p>
     * @param p_activity - The activity to be updated.
     * @exception java.rmi.RemoteException Network related exception.
     * @exception JobException Component related exception.
     */
    public void modifyActivity(Activity p_activity)
        throws RemoteException, JobException;

    /**
     * Remove an existing activity.
     * <p>
     * @param p_activity - The activity to be removed.
     * @exception java.rmi.RemoteException Network related exception.
     * @exception JobException Component related exception.
     */
     ...
     * 
     * @param p_jobName : The specified job name.
     * @return The job object
     * @throws RemoteException
     * @throws JobException
     */
    public Job getJobByJobName(String p_jobName)
        throws RemoteException, JobException;

    /**
     * Get job IDs with special range of fetching records
     * @param p_companyId Company ID
     * @param p_offset Begin index of records
     * @param p_count Count number of fetching records
     * @return
     * @throws RemoteException
     * @throws JobException
