...
public class JobHandlerWLRMIImpl 
    extends RemoteServer
    implements JobHandlerWLRemote
{
    ...
    public Activity getActivityByDisplayName(String p_activityName) throws RemoteException, JobException
    {
    ...
    public Collection getJobsByStateList(Vector p_listOfStates,
        ...
        throws RemoteException, JobException
    {
        return m_localReference.getJobsByStateList(
            p_listOfStates, p_queryLimitByDate);
    }
     ...
     * 
     * @param p_job The job to update.
     * @param p_quoteApprovedDate The new date of Approve Quote. 
     */
     ...
     * 
     * @param p_job The job to update.
     * @param p_quotePoNumber The new PO number.
	 */
