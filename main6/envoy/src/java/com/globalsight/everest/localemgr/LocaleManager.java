...
/**
 * Handles locale information for the application.
 * Locale Pairs, GlobalSightLocale, Locales for UI
 */
public interface LocaleManager
{
    ...
    /**
     * Add a source/target locales pair.  After this, the source/target
     * locale pair becomes valid for a localization profile.
     *
    ...
    /**
     * Get all the locales which are the source locale in all the
     * source/target locale pairs with specified company id<p>
     * @return A vector all the GlobalSightLocales that are specified
     * as sources in LocalePairs.
     * @exception LocaleManagerException Specifies the error, probably
     ...
     * @exception RemoteException System or network related exception
     */
    Vector getAllSourceLocales()
        throws LocaleManagerException, RemoteException;


    /**
     * Get all the distinct locales which are the targets locale in all the source/target
     * locale pairs
     *
     ...
     * <p>
     * @return Vector A vector of all the locales (GlobalSightLocales) that is supported
     *                by the UI.
     * @exception LocaleManagerException Specifies the error, probably persistence exception
     * @exception RemoteException System or network related exception
     */
    Vector getSupportedLocalesForUi()
        throws LocaleManagerException, RemoteException;
     ...
     * @exception RemoteException System or network related exception
     */
    GlobalSightLocale getLocaleById(long p_id)
        throws LocaleManagerException, RemoteException;

    /**
     * Get a particular locale based on the string "language code"_"country code"
     * <p>
     ...
     * @exception RemoteException System or network related exception
     */
    Vector getSourceTargetLocalePairs()
        throws LocaleManagerException, RemoteException;
    ...
    /**
     * For a given source locale, get the list of target locales that
     * it is paired with and specified company id.  <p>
     * @param GlobalSightLocale The source locale
     * @return A list of GlobalSightLocale's (the target locales)
     * @exception LocaleManagerException Specifies the error, probably
     * persistence exception
     * @exception RemoteException System or network related exception
    ...
    /**
     * For a given source locale, get the list of target locales that it
     * is paired with.
     *
    ...
    /**
     * For a given source locale and project, get the list of target locales that it
     * is paired with.
     *
     * @param Locale The source locale
     ...
     * @exception RemoteException System or network related exception
     */
    Vector getTargetLocalesByProject(GlobalSightLocale p_sourceLocale, String p_project)
        throws LocaleManagerException, RemoteException; 
     ...
     *
     * @param LocalePair The locales Pair
     * @exception LocaleManagerException Specifies the error, probably persistence exception
     * @exception RemoteException System or network related exception
     */
