...
abstract public class ExtractedFile implements PrimaryFile
{
	...
	protected Map m_templateMap = new HashMap();

	// holding the leverage group(s) of the file
	protected List m_leverageGroupList = new ArrayList();

	protected List m_leverageGroupIds = new ArrayList();
     ...
     */
	public List getLeverageGroups()
	{
		return m_leverageGroupList;
	}

	public List getLeverageGroupSet()
	{
		return m_leverageGroupList;
	}

	public void setLeverageGroupSet(List groups)
	{
	...
	private void updateLeverageGroupIds(List p_leverageGroupIds)
	{
