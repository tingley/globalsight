...
/**
 * This class represents the remote implementation of a page manager
 * that manages a Page(s).
 *
 * Note that all of the methods of this class throw the following
 * exceptions:
 * 1. PageException - For page related errors.
 * 2. RemoteException - For network related exception.
 */
public class PageManagerWLRMIImpl
    extends RemoteServer
    implements PageManagerWLRemote
{
     ...
     */
    public SourcePage getSourcePage(long p_sourcePageId)
     ...
     * @exception RemoteException Network related exception.
     */
    public TargetPage getTargetPage(long p_targetPageId)
        throws PageException, RemoteException
    {
     ...
     * @param p_sourcePageId - The id of the original source page
     *                        that the target page was derived from.
    ...
    /**
     * @see PageManager#getPageWithExtractedFileForImport(Request, GlobalSightLocale,
     *                                                    String, int,
     *                                                    boolean)
     */
    public SourcePage getPageWithExtractedFileForImport(Request p_request,
        ...
        throws PageException
    {
        return m_localInstance.getPageWithExtractedFileForImport(
            p_request, p_sourceLocale, p_dataType, p_wordCount,
     ...
     * @exception RemoteException Network related exception.
     */
    public LeverageGroup createLeverageGroup()
        throws PageException, RemoteException
    {
    ...
    /**
     * Creates a copy of the source page for each target locale.
     * The copy includes all the Tuvs,
     * LeverageGroups, etc.  The sequence numbers for all should be
     * set to -1, and the locale replaced by the one passed in.
     * The states can all remain the same.
     * The target locale rows need new database sequence numbers
     * assigned.  Target pages are associated with the same
     ...
     * @param p_targetLocales collection of target locales.
     * @param p_useLeveragedSegments Determines whether leveraged segments
     *        should be used.
     * @exception PageException when a page related error occurs.
     * @exception RemoteException Network related exception.
     */
        ...
        throws PageException
    {
        return m_localInstance.createTargetPagesWithExtractedFile(p_sourcePage,
            p_targetLocales, p_termMatches,
            p_useLeveragedSegments,
            p_useLeveragedTerms,
    ...
    public Collection createTargetPagesWithUnextractedFile(SourcePage p_sourcePage,
        ...
        throws PageException
    {
        return m_localInstance.createTargetPagesWithUnextractedFile(p_sourcePage,
            p_targetLocales);
    }
    ...
    public Collection createFailedTargetPagesWithExtractedFile(SourcePage p_sourcePage,
        Hashtable p_targetLocales)
        throws PageException
    {
        return m_localInstance.createFailedTargetPagesWithExtractedFile(p_sourcePage,
            p_targetLocales);
    }
     ...
     * @param p_pageTemplateType - The string representation of the page
     * template type.
     *
     * @return A collection of template parts based on the given source
     * page id.
     * @exception PageException when a page related error occurs.
     * @exception RemoteException Network related exception.
     */
     ...
     * reimport.
     * @param p_sourcePage - The source page used for getting it's previous
     * leverage group ids.
     ...
     * @exception RemoteException Network related exception.
     */
    public boolean isExported(Collection p_pageIds)
        throws PageException, RemoteException
    {
     ...
     * belongs to.
     * @return A hash map containing all the pages (Source and Target)
     * that were created as part of import.  The key is the locale of
     * the page.
     *
     * @exception PageException when a page related error occurs.
     * @exception RemoteException Network related exception.
     */
    public HashMap importPage(Request p_request)
        throws PageException, RemoteException
    {
     ...
     * required for export.
     * @param p_pageIds - A collection of pages to be exported (from a
     * workflow).
     * @param p_isTargetPage -- whether the ids refer to target or source pages
     * @param p_exportBatchId - the export ID returned from ExportEventObserver.notifyBeginExport()
     * @exception PageException when a page related error occurs.
     * @exception RemoteException Network related exception.
     */
    ...
    public void exportSecondaryTargetFiles(ExportParameters p_exportParameters,
        ...
        throws PageException, RemoteException
    {
        m_localInstance.exportSecondaryTargetFiles(
            p_exportParameters, p_stfIds, p_exportBatchId);
    }

    /**
     * Perform the export for preview based on the specified list of
     * tuvs.
     *
     * @return The string representation of request information for a
     * preview.
     *
     ...
     */
    public void updateWordCount(HashMap p_pageWordCounts)
        throws PageException, RemoteException
    {
     ...
     */
    public void updateUnextractedFileInfo(Page p_page)
        throws PageException, RemoteException
    {
    ...
    public TargetLocaleLgIdsMapper getLocaleLgIdMapForReimportPage(
        ...
        throws PageException, RemoteException
    {
        return m_localInstance.getLocaleLgIdMapForReimportPage(p_sourcePage, p_targetLocales);
    }

    /**
     * @see PageManager.cleanupUpdatingPages
     */
    public void cleanupUpdatingPages()
