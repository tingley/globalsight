...
//	}
	...
	public void handleStyleNode(Node bNode)
    {
        ...
        //SmartArt
        else if (wrNode.getNodeName().equals("a:r"))
        {
            Node cNode = wtNode.getFirstChild();
            ...
            while (cNode != null)
            {
                ...
                updateStyle2(cNode, cloneNode, wtNode, wrNode, root);
	...
	protected void updateStyle2(Node cNode, Node cloneNode, Node wtNode,
			...
			Node wrNode, Node root)
    {
    	if (cNode.getNodeName().equals(getNodeName()))
        {
    		Element n = (Element) getChild(cloneNode, "rPr");

            if (n == null)
            {
                n = cloneNode.getOwnerDocument().createElement("rPr");
                Node t = getChild(cloneNode, "t");
                cloneNode.insertBefore(n, t);
            }
