...
public class BoldTag extends SpecialTag 
{

	@Override
	boolean check(String prefixTag, String removedPrefixTag) 
	{
		prefixTag = prefixTag.replace("&lt;w:b/&gt;", "");
	...
	String modifyTag(String bptTag, String all) 
	{
		 ...
		 newTag = newTag.replaceAll(" type=\"[^\"]*\"", " type=\"office-bold\" erasable=\"yes\"");
