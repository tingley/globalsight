...
public class ColorTag extends SpecialTag 
{

	@Override
	boolean check(String prefixTag, String removedPrefixTag) 
	{
		prefixTag = prefixTag.replaceAll("&lt;w:color w:val=&quot;[^&]*&quot;/&gt;", "");
	...
	String modifyTag(String bptTag, String all) 
	{
		 ...
		 newTag = newTag.replaceAll(" type=\"[^\"]*\"", " type=\"color\" erasable=\"yes\"");
	...
	{
		return gxml.contains("&lt;w:color w:val=&quot;");
	}
