...
public class SuperScriptTag extends SpecialTag 
{

	@Override
	boolean check(String prefixTag, String removedPrefixTag) 
	{
		prefixTag = prefixTag.replace("&lt;w:vertAlign w:val=&quot;superscript&quot;/&gt;", "");
	...
	String modifyTag(String bptTag, String all) 
	{
		 ...
		 newTag = newTag.replaceAll(" type=\"[^\"]*\"", " type=\"superscript\" erasable=\"yes\"");
	...
	{
		return gxml.contains("&lt;w:vertAlign w:val=&quot;superscript&quot;/&gt;");
	}
}
