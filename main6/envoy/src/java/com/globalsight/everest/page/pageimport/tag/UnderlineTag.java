...
public class UnderlineTag extends SpecialTag 
{

	@Override
	boolean check(String prefixTag, String removedPrefixTag) 
	{
		prefixTag = prefixTag.replace("&lt;w:u w:val=&quot;single&quot;/&gt;", "");
	...
	String modifyTag(String bptTag, String all) 
	{
		 ...
		 newTag = newTag.replaceAll(" type=\"[^\"]*\"", " type=\"office-underline\" erasable=\"yes\"");
	...
	{
		return gxml.contains("&lt;w:u w:val=&quot;single&quot;/&gt;");
	}
}
