...
public class Permission
{
    ...
    static public final String RESTART_SYSTEM = "restart.system";
    ...
    { ACTIVITIES_VIEW, ACTIVITIES_ACCEPT, ACTIVITIES_REJECT_BEFORE_ACCEPTING,
            ...
            ACTIVITIES_COMMENTS_EDIT, ACCOUNT_NOTIFICATION_GENERAL, ACTIVITIES_EXPORT,
            ACTIVITIES_EXPORT_INPROGRESS, ACTIVITIES_DOWNLOAD, ACTIVITIES_ACCEPT_ALL,
            ACTIVITIES_DOWNLOAD_ALL, ACTIVITIES_UPLOAD_SUPPORT_FILES, ACTIVITIES_DETAIL_STATISTICS,
            ACTIVITIES_SUMMARY_STATISTICS, SOURCE_PAGE_EDIT, COMMENT_ACCESS_RESTRICTED,
            ACTIVITIES_COMMENTS_NEW, ACTIVITIES_COMMENTS_JOB, ACTIVITIES_COMMENTS_DOWNLOAD,
            ACTIVITIES_SECONDARYTARGETFILE, USERS_VIEW, CHANGE_OWN_EMAIL,
            ACTIVITIES_JOB_COMMENTS_VIEW, ACTIVITIES_JOB_COMMENTS_EDIT, ACTIVITIES_JOB_COMMENTS_NEW,
            ACTIVITIES_JOB_COMMENTS_DOWNLOAD, REPORTS_TRANSLATIONS_EDIT, REPORTS_MAIN,
            REPORTS_LANGUAGE_SIGN_OFF, REPORTS_LANGUAGE_SIGN_OFF_SIMPLE, REPORTS_CHARACTER_COUNT,
            REPORTS_SCORECARD, REPORTS_DELL_FILE_LIST, ACTIVITY_DASHBOARD_VIEW,
            ACTIVITIES_BATCH_COMPLETE_ACTIVITY, ACTIVITIES_BATCH_COMPLETE_WORKFLOW,
            ACTIVITIES_UPDATE_LEVERAGE, ACTIVITIES_OFFLINEUPLOAD_FROMANYACTIVITY, TM_VIEW,
            TM_SEARCH, ACTIVITIES_TM_SEARCH, ACTIVITIES_TB_SEARCH, TERMINOLOGY_VIEW,
            TERMINOLOGY_SEARCH, ACTIVITIES_DOWNLOAD_COMBINED, ACTIVITIES_EXPORT_DOWNLOAD,
            REPORTS_POST_REVIEW_QA, REPORTS_TRANSLATIONS_VERIFICATION };
