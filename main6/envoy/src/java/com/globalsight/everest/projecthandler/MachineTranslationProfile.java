...
public class MachineTranslationProfile implements java.io.Serializable
{
    ...
    private String msTransVersion = null; //2 or 3
    ...
    public MachineTranslationProfile()
    {
        ...
        this.msTransVersion = "3";
        this.msTokenUrl = MTProfileConstants.MT_MS_GET_ACCESS_TOKEN_URL;
    }
    ...
    public String getMsTransVersion()
    {
        return msTransVersion;
    }

    public void setMsTransVersion(String msTransVersion)
    {
        this.msTransVersion = msTransVersion;
    }
	
	public boolean isV3()
	{
	    if (msTransVersion != null) {
	        return "3".equals(msTransVersion);
	    }
	    
	    return !url.toLowerCase().contains("soap.svc");
	}
