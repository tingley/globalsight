...
public interface ProjectHandler
{
	 ...
	 *                the exception code.
	 */
	void modifyL10nProfile(L10nProfile p_l10nProfile, Vector<WorkflowInfos> workflowInfos) throws RemoteException,
			ProjectHandlerException;
	 ...
	 *                persistence component.
	 */
	List getAllProjectInfosForGUI() throws RemoteException,
			ProjectHandlerException;
	 ...
	 * GlobalSight module or admin or vendor management for the Vendor Management
	 * module.
	 * 
	 * @param p_user
	...
	void duplicateWorkflowTemplates(long p_origWFTempInfoId, String p_newName,
			WorkflowTemplate p_origIflowTemplate, Collection p_localePairs,
			String p_displayRoleName) throws RemoteException,
			ProjectHandlerException;
	...
	// ////////////////////////////////////////////////////////////////////
	public L10nProfileWFTemplateInfo getL10nProfileWfTemplateInfo(long l10nProfileId, long workflowId);
/*	
	public void saveL10nProfileWfTemplateInfo(L10nProfileWFTemplateInfo l10nProfileWFTemplateInfo);

	void updateL10nProfileWfTemplateInfo(
