...
/**
 * Writes entries to a CSV file as directed by the conversion settings
    ...
    implements IWriter
{
        ...
        throws IOException
    {
        ...
        if (!CompanyWrapper.SUPER_COMPANY_ID.equals(companyId)) {
        	directory = directory + CompanyWrapper.getCompanyNameById(companyId);
        ...
        if (m_options.getHeader().equalsIgnoreCase("true"))
        {
            ...
            m_output.println("Username" + separator +
                "Subject" + separator + "Type" + separator +
                "Starts at" + separator + "Ends at");
        }
        ...
        throws IOException
    {
        ...
        try
        {
            ...
            sb.append(o.getUserFluxCalendar().getOwnerUserId());
            sb.append(separator);
    ...
    /*
     * Since PrintWriter.println() method does not throw any exception
     * we'll check for IO errors.
     */
    ...
    /*
     * Create a Timestamp object by parsing the given date and the format pattern.
     *
    ...
    private String formatDate(Date p_date,
                              String p_dateFormatPattern,
                              TimeZone p_timeZone)
    {
        try
        {
            SimpleDateFormat sdf =
                new SimpleDateFormat(p_dateFormatPattern);
