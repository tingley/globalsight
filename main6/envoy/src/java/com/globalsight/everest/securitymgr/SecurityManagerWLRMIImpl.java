...
/**
 * SecurityManagerWLRMIImpl is the remote implementation of SecurityManagerLocal.
 */
public class SecurityManagerWLRMIImpl extends RemoteServer implements SecurityManagerWLRemote
{
    ...
    *
    * @param p_localInstance The local instance of the UserManager.
    * @exception java.rmi.RemoteException Network related exception.
    */
    public SecurityManagerWLRMIImpl() 
    ...
    //////////////////////////////////////////////////////////////////////////////
    /**
    * Authenticate the user by the provided credentials and return
    ...
    */
    public User authenticateUser(String p_userName, String p_password)
        throws RemoteException,SecurityManagerException
    {
	return m_localInstance.authenticateUser(p_userName, p_password);
    }
     ...
     *
     */
    public void logUserOut(String p_userName)
        throws RemoteException, SecurityManagerException
    {
    ...
    public void setFieldSecurity(User p_requestingUser,
        ...
        throws RemoteException, SecurityManagerException
    {
        m_localInstance.setFieldSecurity(p_requestingUser,
                                         p_objectWithFields,
                                         p_fs);
    }
