...
/**
 * Rule class represents rule element in 
...
public class Rule {
	...
	/**
	 * The text of a rule element's before
	 * child element.
	 */
	private String m_beforebreak;
	/**
	 * The text of a rule element's after
	 * child element.
	 */
	...
	/**
	 * Get the text of afterbreak element.
	 * The text should be regular expression.
	 * @return
	 */
	...
	/**
	 * Set the text of afterbreak element.
	 * The text should be regular expression.
	 * @param p_afterbreak
	 */
	...
	/**
	 * Get the text of beforebreak element.
	 * The text should be regular expression.
	 * @return
	 */
	...
	/**
	 * Set the text of beforebreak element.
	 * The text should be regular expression.
	 * @param p_beforebreak
	 */
	...
	/**
	 * Get break attribute of rule element,
	 * if "yes", return false, otherwise return
	 * true.
	 * @return
