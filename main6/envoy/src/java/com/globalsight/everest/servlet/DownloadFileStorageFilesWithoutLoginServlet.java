...
public class DownloadFileStorageFilesWithoutLoginServlet extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        //URL: http://10.10.211.117:80/globalsight/GlobalSight/CommentReference2/1010/General/1001.txt?companyName=york
        //Actual: C:\Welocalize\FileStorage\york\GlobalSight\CommentReference\1010\General\1001.txt
        ...
        filePath.append(File.separator).append("GlobalSight").append(File.separator).append("CommentReference");
        ...
        if (index >= 0)
        {
            fileName = decodedUrl.substring(index + WebAppConstants.COMMENT_REFERENCE2.length() + 1);
        ...
        else
        {
            ...
            CATEGORY.warn("Invalid request for " + fileName +
                ", not under /" + WebAppConstants.COMMENT_REFERENCE);
