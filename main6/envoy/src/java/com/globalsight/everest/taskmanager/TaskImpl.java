...
public class TaskImpl extends PersistentObject implements Task, WorkObject
{
	...
	private Set m_workSet = new HashSet(); // For Hibernate
	...
	public String getAllAssigneesAsString()
	{
		...
		return m_wfTaskInstance.getAllAssigneesAsString();
	}
	...
	public AmountOfWork getAmountOfWork(Integer p_unitOfWork)
	{
		...
		if (m_work != null)
		{
			work = (AmountOfWork) m_work.get(p_unitOfWork);
		}
		return work;
	}
	...
	public Set getWorkSet()
	{

		return m_workSet;
	}

	public void setWorkSet(Set p_workSet)
	{
		this.m_workSet = p_workSet;
		if (p_workSet != null)
		{
			Iterator iterator = p_workSet.iterator();
			while (iterator.hasNext())
			{
				AmountOfWork work = (AmountOfWork) iterator.next();
				if (work != null)
				{
					work.setTask(this);
