...
/**
 *  TaskManager is an interface that defines serves to handlle and delegate
...
public interface TaskManager
{
    ...
    /**
     * Get a list of current tasks of the workflow (that are in ACTIVE,
     * or ACCEPTED state) for the given workflow id.
     * 
     * @param p_workflowId - The id of the workflow where its current tasks
     * are being queried.
     *
     ...
     * @throws RemoteException, TaskException
     */
    Collection getCurrentTasks(long p_workflowId)
       throws RemoteException, TaskException;
     ...
     * of activities are displayed based on their state, it's important to pass
     * the state in order to get the appropriate details info.
     *
    ...
    /**
     * To retrieve a Task purely by task Id.
     * This task is read-only (not editable).
     *
     * @param p_taskId The id of the target task.
     *
     * @return a Task object
     * @throws RemoteException, TaskException
     */
     public Task getTask(long p_taskId)
            throws RemoteException, TaskException;

    /**
     * To retrieve a Task purely by task Id.
     * and specify if it is editable (cloned) or not.
     *
     * @param p_taskId The id of the target task.
     * @param p_isEditable Whether it should cloned so it can be
     *                     edited or not.
     *
     * @return a Task object
     * @throws RemoteException, TaskException
     ...
     */
     ...
     /**
      * Retrieves all the tasks in a job that are associated with
      * a particular rate type (like HOURLY, PAGE_COUNT, etc..)
      */
     public Collection getTasks(long p_jobId, Integer p_rateType, Integer p_costType)
        throws RemoteException, TaskException;

     /**
      * Get a collection of tasks based on the given task name and 
      * job id.  Note that a workflow could have multiple tasks with
      * the same name (besides the possiblity of having a task with
      * same name in multiple workflows of a job).  
      *
      * @param p_taskName - The name of the tasks to be retrieved.
      * @param p_jobId - The id of the job which the tasks belong to.
     ...
     * @return 
     */
    Collection getTasks(TaskSearchParameters  p_params)
    throws RemoteException, TaskException;
      ...
      *         that is a vendor.
      *         The list is returned with the tasks in order of completion.
      */
     public List getTasksForRating(long p_workflowId)
        throws RemoteException, TaskException;


     /**
      * Return information about all the accepted tasks within the
      * specified workflow.
      *
      * @param p_workflowId  The id of the workflow the tasks are part of.
      *
      * @return A collection of TaskInfo objects that contain information about
      *         all the accepted tasks.  This collection could be empty if
      *         no tasks have been accepted yet. TaskInfo is strictly an entitiy object that
      *         is serializable and can be used by clients.
      */
      ...
      *
      * @param p_userId - The user id of the removed user.
      *
      * @throws RemoteException, TaskException
      */
     void removeUserAsTaskAcceptor(String p_userId)
        throws RemoteException, TaskException;

     /**
      * Update the secondary target file creation state for this task.
      * The valid states are 'IN_PROGRESS', 'COMPLETED', and 'FAILED'.
      *
      * @param p_taskId - The id of the task to be updated.
      * @param p_stfCreationState - The state to be set.
      *
      * @exception RemoteException Network related exception.
      * @exception TaskException Component related exception.
      */
     void updateStfCreationState(long p_taskId, 
                                 String p_stfCreationState)
        throws RemoteException, TaskException;
}