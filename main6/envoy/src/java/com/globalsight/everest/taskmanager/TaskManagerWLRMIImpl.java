 ...
 *  manages tasks.
 */
public class TaskManagerWLRMIImpl extends RemoteServer
        implements TaskManagerWLRemote
{
    ...
    */
     ...
     * @return 
     */
    public Collection getTasks(TaskSearchParameters  a)
    throws RemoteException, TaskException
    {
     ...
     */
     public void updateStfCreationState(long p_taskId, 
                                        String p_stfCreationState)
        throws RemoteException, TaskException
     {
         m_localInstance.updateStfCreationState(p_taskId, 
                                                p_stfCreationState);
     }
}