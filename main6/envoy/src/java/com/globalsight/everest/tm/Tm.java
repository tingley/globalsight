...
/**
 * Translation Memory (TM) is a collection of translation units (TU).
 * Tm holds translations of text segments for re-use in new translations.
 */
public interface Tm
{
    /**
     ...
     * @param p_name the name of the Tm.
     */
     ...
     * @param p_domain the domain attribute of the Tm.
     */
     ...
     * @param p_organization the organization attribute of the Tm.
     */
     ...
     * @param p_description the description of the Tm.
     */
     ...
     */
     ...
     /**
      * Get the ID of the tm3 TM backing this logical TM.
      * If this is a legacy (tm2) TM, this value will be null.
      */
