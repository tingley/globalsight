        ...
        TmManagerExceptionMessages
{
     ...
     */
    public Collection getAllTms() throws RemoteException, GeneralException
    {
     ...
     *             when a communication-related error occurs.
     */
    public ArrayList getNames(Locale p_uiLocale) throws RemoteException
    {
     ...
     */
    public String getTmName(long p_id) throws RemoteException
    {
     ...
     */
    public long getTmId(String p_name) throws RemoteException
    {
    ...
    /**
     * Returns a list of TM names and descriptions known to the server sorted in
     * the given locale.
     * 
     * @param p_uiLocale
     ...
     *             when a communication-related error occurs.
     */
    public String getDescriptions(Locale p_uiLocale) throws RemoteException
    {
     ...
     * 
     * @return an XML string: <tms> <tm id="1000"> <name>NAME</name>
     *         <domain>DESC</domain> <organization>DESC</organization>
     *         <description>DESC</description> ... </tm> </tms>
     * 
     * @throws TmManagerException
     *             when an error occurs.
     * @throws RemoteException
    ...
    /**
     * Returns a default TM definition that can be modified according to taste
     * (currently the empty definition <tm></tm>).
     */
     ...
     */
    public Tm getTm(String p_name) throws TmManagerException, RemoteException
    {
        if (p_name == null || p_name.length() == 0)
        {
            throw new TmManagerException(MSG_INVALID_NAME, null, null);
     ...
     *             when a communication-related error occurs.
     */
    public Tm getTmById(long p_id) throws RemoteException, GeneralException
    {
     ...
     */
    public Tm createTm(String p_name, String p_domain, String p_organization,
            String p_description) throws TmManagerException, RemoteException
    {
        if (p_name == null || p_name.length() == 0)
        {
            throw new TmManagerException(MSG_INVALID_NAME, null, null);
        ...
        if (p_domain == null || p_organization == null || p_description == null)
        {
            String[] args =
            { "a required attribute is null" };
     ...
     */
    public void deleteTm(String p_name) throws GeneralException,
            RemoteException
    {
     ...
     * 
     * @return an XML string with languages sorted by p_uiLocale (if null,
     *         Locale.US is used).
     * 
            ...
            throws TmManagerException
    {
        ...
        try
        {
            ...
            TuReader reader = new TuReader(conn);
    ...
    /** Returns an import manager to import TMX files into a TM. */
    public IImportManager getImporter(String p_name) throws ImporterException,
            TmManagerException, RemoteException
    {
        if (p_name == null || p_name.length() == 0)
        {
            String[] args =
    ...
    public IExportManager getExporter(String p_name) throws ExporterException,
            TmManagerException, RemoteException
    {
        if (p_name == null || p_name.length() == 0)
        {
    ...
    /**
     * <p>
     * Releases all TMs during system shutdown.
     * </p>
     */
    ...
    /**
     * <p>
     * Stops the in-memory TM object by setting it's status to DELETED and
     * removing it from the TmList. The object may still be referenced by many
     * clients, but all their calls to the object will fail. Once the last
     * client has released his reference to the TM object, it will be
     * garbage-collected.
     * </p>
     */
    static protected void doDeleteTm(String p_name) throws TmManagerException
    {
        String[] args =
        { p_name };
