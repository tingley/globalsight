...
/**
 * <p>Trados-TMX Converter for HTML.</p>
 *
 * <p>This tool reads a Trados TMX file with content from Trados' HTML
 * filter and writes it out as GXML.</p>
 */
public class TradosHtmlTmxToGxml
{
    ...
    public TradosHtmlTmxToGxml (GlobalSightCategory p_logger)
    {
        m_logger = p_logger;
    }
    ...
    public String handleTuv(String p_segment)
        throws Throwable
    {
        try
        {
