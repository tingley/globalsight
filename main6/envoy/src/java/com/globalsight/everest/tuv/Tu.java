...
/**
 * The Tu interface represents a translation unit.
 * A translation unit encapsulates all the translation
 * unit variants for a given segment of text.
 */
public interface Tu
    extends TuLing
{
    ...
    /**
     * Add a Tuv to a Tu.
     * @param p_tuv the Tuv to add.
     */
    public void addTuv(Tuv p_tuv);

    /**
     * Get a tuv based on the specified locale id.
     * @param p_localeId - The locale id used for getting a tuv.
     ...
     * @param p_leverageGroup - The leverage group to be set.
     */
    ...
    /**
     * Get the LeverageGroup associted with this Tu.
     * @returns the LeverageGroup associted with this Tu.
     */
