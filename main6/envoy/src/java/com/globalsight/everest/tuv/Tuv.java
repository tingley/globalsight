...
/**
 * The Tuv interface represents a translation unit variant.
 * A translation unit variant specifies text in a given Locale.
 * The text is commonly referred to as a segment.
 * Tuv also contains meta-data about the text.
 */
public interface Tuv
{
    ...
    /**
     * <p>Return the persistent object's id as a Long object.<p>
     *
     * <p>This is a convenience method that simply wraps the id as an
    ...
    /**
     * Get Tuv content in Gxml format.  The string will be a segment
     * or localizable element including it's tags.
    ...
    /**
     * Indicate that the Tuv has been indexed.  After executing this method,
     * a call to isIndexed() will always return true for this Tuv.
     */
    public void makeIndexed();

    /**
     * Get Tuv content in Gxml format.  The string will be a segment
     * or localizable element excluding the top level tags.
     * @return Tuv content in Gxml format excluding the top level tags.
     */
    public String getGxmlExcludeTopTags();

    /**
     * Get Tuv content in format of a GxmlElement.  The element will
     * be a segment or localizable element.
     * @return Tuv content in format of a GxmlElement.
     */
    public GxmlElement getGxmlElement();

    /**
     * Set Tuv content in format of a GxmlElement.  It should be a
     * segment or localizable element.
     * @param Tuv content in format of a GxmlElement.
     */
    ...
    /**
     * <p>Set subflow elements as a Map of subflow content not
     * including the sub tags, keyed by the sub id attribute.</p>
     *
     * <p>Whatever subflows are in the Map will overwrite the current
     * ones, based on the id attribute.  Current ones that are not in
     * the Map remain the same.</p>
     *
     * @param p_map Map of subflow content not including the sub tags,
     * keyed by the sub id attribute.  Cannot be empty or null.
     */
     ...
     * <p>
     * @param p_subflowId the subflow id attribute.
     * @param p_subflowContent the subflow content Gxml String not
     * including the sub tags.
     */
     ...
     * localizable element including it's tags, but ignore any
     * subflows in the string.  Any subflows in the string must have
     * id attributes set.
     * @param p_gxml Gxml String.
     */
    ...
    /**
     * Set the text of the segment with a Gxml string of a segment or
     * localizable element excluding it's top level tags, but ignore
     * any subflows in the string.  Any subflows in the string must
     * have id attributes set.
     * @param p_gxml Gxml String.
     */
    ...
    /**
     * Set the text of the segment with a Gxml string.  The string
     * must be a segment or localizable element including it's tags.
     * All the sub elements must not have the id attribute set.  This
     * method will set them.
     * @param p_gxml Gxml String.
     */
    ...
    /**
     * Set the text of the segment with a Gxml string.  The string
     * must be a segment or localizable element excluding it's top
     * level tags.
     * @param p_gxml Gxml String.
     */
    ...
    /**
     * Set the text of the segment with a Gxml string.  The string
     * must be a segment or localizable element including its tags.
     * All the sub elements must have the id attribute set.  This
     * method will set them.
     * @param p_gxml Gxml String.
     */
    ...
    /**
     * Returns true if it is in state
     * LEVERAGE_GROUP_EXACT_MATCH_LOCALIZED.  This means that the Tuv
     * was localized from the leveraging process by the fact that
     * there was an exact match in a previous version of the leverage
     * group.
    ...
    /**
     * @return true if state is LEVERAGE_GROUP_EXACT_MATCH_LOCALIZED
     * or EXACT_MATCH_LOCALIZED
     */
    public boolean isExactMatchLocalized();

    /**
     * @return true if state the segment, including it's subflows, has
     * not been localized.
     */
    public boolean isNotLocalized();

    /**
     * @return true if the state of the segment (including it's
     * subflows?) has been localized.
     */
    public boolean isLocalized();

    /**
     * Set the LeverageMatchType.  When content is copied into Tuv
     * from a leverage matching Tuv, the LeverageMatchType is set.
     * @see com.globalsight.ling.tm.LeverageMatchType
     * @see com.globalsight.everest.page.PagePersistenceAccessor
     * @param p_matchType the LeverageMatchType when content comes
     * from a leverage matching Tuv.
     */
    public void setMatchType(String p_matchType);

    /**
     * Get the LeverageMatchType.  When content is copied into Tuv
     * from a leverage matching Tuv, the LeverageMatchType is set.
     * @see com.globalsight.ling.tm.LeverageMatchType
     * @see com.globalsight.everest.page.PagePersistenceAccessor
     * @return the LeverageMatchType when content comes from a
     * leverage matching Tuv.
     */
