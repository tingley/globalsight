 ...
 */
public class AttributeCloneComparator extends StringComparator
{
...
//    public static final int FILE_NUMBER = 1;
     ...
     * displayName
     */
    public AttributeCloneComparator(int p_type, Locale p_locale)
    {
        super(p_type, p_locale);
    }

    public AttributeCloneComparator(Locale p_locale)
    {
        super(p_locale);
    }
    ...
    {
        AttributeClone a = (AttributeClone) p_A;
        AttributeClone b = (AttributeClone) p_B;
