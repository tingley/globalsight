 ...
 */
public class AttributeSetComparator extends StringComparator
{
...
//    public static final int FILE_NUMBER = 1;
     ...
     * displayName
     */
    public AttributeSetComparator(int p_type, Locale p_locale)
    {
        super(p_type, p_locale);
    }

    public AttributeSetComparator(Locale p_locale)
    {
        super(p_locale);
    }
    ...
    {
        AttributeSet a = (AttributeSet) p_A;
        AttributeSet b = (AttributeSet) p_B;
