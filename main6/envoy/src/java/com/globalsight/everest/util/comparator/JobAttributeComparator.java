 ...
 */
public class JobAttributeComparator extends StringComparator
{
...
//    public static final int FILE_NUMBER = 1;
     ...
     * displayName
     */
    public JobAttributeComparator(int p_type, Locale p_locale)
    {
        super(p_type, p_locale);
    }

    public JobAttributeComparator(Locale p_locale)
    {
        super(p_locale);
    }
    ...
    {
        JobAttribute a = (JobAttribute) p_A;
        JobAttribute b = (JobAttribute) p_B;
