 ...
 */
public class RequestFileComparator extends StringComparator
{
     ...
     * displayName
     */
    public RequestFileComparator(int p_type, Locale p_locale)
    {
        super(p_type, p_locale);
    }

    public RequestFileComparator(Locale p_locale)
    {
        super(p_locale);
    }
    ...
    public int compare(java.lang.Object p_A, java.lang.Object p_B)
    {
        ...
        case PROJECT:
            ...
            break;
        case PRIORITY:
            aValue = a.getPriority();
            bValue = b.getPriority();
            
            rv = Integer.parseInt(aValue) - Integer.parseInt(bValue);
            break;
        case REQUEST_TIME:
