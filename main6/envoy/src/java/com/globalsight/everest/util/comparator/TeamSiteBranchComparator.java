	...
	public int compare(java.lang.Object p_A, java.lang.Object p_B) {
        ...
        try
        {
            ...
            case BRANCH:
                ...
                break;
            case TARG_LOCALE:
                GlobalSightLocale targ_locale_a =
                    ServerProxy.getLocaleManager().getLocaleById(a.getBranchLanguage());
                GlobalSightLocale targ_locale_b =
                    ServerProxy.getLocaleManager().getLocaleById(b.getBranchLanguage());
            ...
            case TARG_BRANCH:
                ...
                break;
            case SERVER:
                TeamSiteServer ts_a = ServerProxy.getTeamSiteServerPersistenceManager()
                                        .readTeamSiteServer(a.getTeamSiteServerId());
                TeamSiteServer ts_b = ServerProxy.getTeamSiteServerPersistenceManager()
                ...
                break;
            case STORE:
                BackingStore store_a = ServerProxy.getTeamSiteServerPersistenceManager()
                                        .readBackingStore(a.getTeamSiteStoreId());
                BackingStore store_b = ServerProxy.getTeamSiteServerPersistenceManager()
            ...
            case COMPANY:
                ...
                ts_b = ServerProxy.getTeamSiteServerPersistenceManager()
                                  .readTeamSiteServer(b.getTeamSiteServerId());
                aValue = ts_a.getCompanyId();
                bValue = ts_b.getCompanyId();
                rv = this.compareStrings(aValue,bValue);
                break;
            }
        } catch (Exception e) {
