...
*/
public class XmlRuleFileComparator extends StringComparator
{
	//types of comparison
	...
	/**
	* Creates a XmlRuleFileComparator with the given type and locale.
	* If the type is not a valid type, then the default comparison
	* is done by displayName
	*/
	public XmlRuleFileComparator(int p_type,Locale p_locale)
	{
	    super(p_type, p_locale);
	}

	public XmlRuleFileComparator(Locale p_locale)
	{
	    super(p_locale);
	}
	...
	*/
	public int compare(java.lang.Object p_A, java.lang.Object p_B) {
		XmlRuleFileImpl a = (XmlRuleFileImpl) p_A;
		XmlRuleFileImpl b = (XmlRuleFileImpl) p_B;
