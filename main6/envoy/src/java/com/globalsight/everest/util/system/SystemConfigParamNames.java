 ...
 * parameters.  The symbols defined here are used with the
 * SystemConfiguration methods to read the system configuration
...
public interface SystemConfigParamNames
{
    ...
    public static final String LEVERAGE_EXCLUDE_TU_TYPES =
        "leverager.excludeTuTypes";

    // System-wide parameters for term auto replacement
    public static final String AUTO_REPLACE_TERMS =
        "leverager.autoReplaceTerms";

    //
    // NamedQueries derived class names
    //

    public static final String NAMED_QUERIES_CLASS_NAMES =
        "named.queries.class.names";

    // log4j Priority to assign to all existing GlobalSightCatagories
    // One of FATAL, ERROR, WARN, INFO, or DEBUG.
    public static final String SYSTEM_LOGGING_PRIORITY =
        "system.logging.priority";
    public static final String SYSTEM_LOGGING_DIRECTORY =
        "system.logging.directory";
    public static final String CXE_LOGGING_DIRECTORY =
        "cxe.logging.directory";
    ...
    // Specifies if concurrent duplicate logins are allowed (duplicate = same login name)
    ...
    public static final String OVERRIDE_FONT_FACE_ON_EXPORT =
        "export.overrideCjkFontFace";
    ...
    /**
     * The file storage root used for saving GlobalSight related files.
     * This is the root for files such as the secondary target files and is
     * used as a common root for storing all other GS files.
     */
    ...
    /**
     * The parameter used for getting the email address of a default contact for a customer.
     */
    ...
    public static final String HYPERLINK_COLOR_OVERRIDE =
        "hyperlinkColorOverride";
    ...
    public static final String VISITED_HYPERLINK_COLOR =
        "visitedHyperlinkColor";
    ...
    public static final String REIMPORT_DELAY_MILLISECONDS =
        "reimport.delay.milliseconds";
     ...
     */
    public static final String SYSTEM_NOTIFICATION_ENABLED =
        "systemNotification.enabled";
    /**
     * Parameter used for enabling/disabling the warning/deadline notification.
     */
    public static final String USE_WARNING_THRESHOLDS =
        "warningThresholds.enabled";
     ...
     * be handled differently upon an import failure (when extracted).
     */
    public static final String HANDLE_IMPORT_FAILURE =
        "formatType.handleImportFailure";
     ...
     */
    public static final String CALENDERING_DISPLAY_PER_PAGE =
        "calendaringDisplayPerPage";
     ...
     */
    public static final String EMAIL_AUTHENTICATION_ENABLED =
    ...
    /**
     * Parameter used to determine whether the AND/OR nodes should be
     * visible (in envoy.properties)
     */
    ...
    /**
     * Parameter to determine if the PM email notification check-box in
     * Workflow Template screen should be selected by default (during
     * workflow template creation only).
     */
    public static final String PM_EMAIL_NOTIFICATION = "pm.email.notification";

    /**
     * Parameters for specifying how many records to display per page
     * on the My Jobs and My Activities pages.
     */
    ...
    */
    ...
    /**
     * For old "Dell_Review" activity, change to support Multi-Company, Some this
     * Activity can be configurable for every new Company.
     * The report will only display activity has this name
     */
     ...
     */
    public static final String EXPORT_REMOVE_INFO_ENABLED =
        "export.remove_info.enabled";
     ...
     */
    public static final String CALENDAR_INSTALL_KEY =
        "calendar.installKey";
    /**
     * Parameter used to determine the start time of the event responsible
     * for calendar related cleanup (i.e. removal of reserved times)
     */
    public static final String CALENDAR_CLEANUP_START_TIME =
        "calendar.cleanupStartTime";

    /**
     * Determines the calendar cleanup recurrance (i.e. daily/weekly/monthly)
     */
    public static final String CALENDAR_CLEANUP_RECURRANCE =
        "calendar.cleanupRecurrance";

    /**
     * The cleanup period is used to cleanup calendar related objects
     * that are older than the given period in envoy.properties (based
     * on the fired event's date)
     */
    public static final String CALENDAR_CLEANUP_PERIOD =
        "calendar.cleanupPeriod";
