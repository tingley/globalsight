...
/**
 * Workflow List Applet is a subclass of EnvoyApplet and is strictly used for going from one applet
 * to WorkflowListApplet.  In our case we only have one applet which is responsible
...
public class WorkflowListApplet extends EnvoyApplet {
