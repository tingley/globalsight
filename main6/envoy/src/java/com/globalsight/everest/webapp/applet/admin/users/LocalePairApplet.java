...
/**
 * LocalePairApplet is a subclass of EnvoyApplet and is strictly used for going from one applet
 * to LocalePairApplet.  In our case we only have one applet which is responsible
...
public class LocalePairApplet extends EnvoyApplet {
