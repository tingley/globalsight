...
/**
 * The default resource bundle that should be used based on the default locale.
 * In our case, we'll copy/past the contents from the en_US file.
 */
public class AppletResourceBundle extends ListResourceBundle implements Serializable
{
