...
public class DBConnectionBasicHandler extends PageHandler
{
    /**
        ...
        throws ServletException, IOException, EnvoyServletException
    {
        ...
        {
            setNames(p_request);
            if (DBConnectionConstants.EDIT.equals(action))
            {
                // Fetch the DBConnection to edit and store in session
                ...
                DBConnection db = ServerProxy.getDBConnectionPersistenceManager().
                    readDBConnection(Long.parseLong(id));
                sessionMgr.setAttribute(DBConnectionConstants.DB_KEY, db);
    ...
    /**
     * Get list of all dbconnection names.  Needed in jsp to determine duplicate names.
     */
        ...
        throws RemoteException, NamingException, GeneralException
    {
        ...
        if (list != null)
        {
            ...
            {
                DBConnectionImpl db = (DBConnectionImpl)list.get(i);
                names.add(db.getName());
            }
        }
        p_request.setAttribute(DBConnectionConstants.NAMES, names);
    }
}
