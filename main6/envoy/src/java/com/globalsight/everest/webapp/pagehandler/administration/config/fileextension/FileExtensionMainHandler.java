...
/**
 * FileExtensionPageHandler, A page handler to produce the entry page(index.jsp) for FileExtension management.
 * <p>
...
public class FileExtensionMainHandler extends PageHandler
{
        ...
        throws ServletException, IOException, EnvoyServletException
    {
        ...
        try
        {
            ...
            {
                if (FormUtil.isNotDuplicateSubmisson(p_request, FormUtil.Forms.NEW_FILE_EXTENSION)) {
        ...
        throws RemoteException, NamingException, GeneralException
    {
        ...
        setTableNavigation(p_request, p_session, (ArrayList)fileextensions,
                       new FileExtensionComparator(uiLocale),
                       10,
                       EXTENSION_LIST,
                       EXTENSION_KEY);
    }
    ...
    private void checkExtention() {
        String[] extensions = { "htm", "html", "shtml", "jhtml", "txt", "css",
                "js", "properties", "cfm", "cfml", "asp", "jsp", "xml", "doc",
                "xls", "ppt", "fm", "qxd", "cpp", "java", "pdf", "indd", "ai",
                "docx", "xlsx", "pptx", "rtf", "inx", "xlf", "xliff", "rc" };
        String currentId = CompanyThreadLocal.getInstance().getValue();
        String sql = 
            "from FileExtensionImpl f where f.companyId=:companyId"; 
        Map map = new HashMap();
