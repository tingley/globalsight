...
public class UILocaleConstant
{
    ...
    public static final String[] PROPERTIES_FILE_NAMES_EARLIB = {
            "AdobeApplicationAdapterMsg", "AmbassadorDwUpException",
            "CalendarManagerException", "CapAdapterMsg", "CatalystAdapterMsg",
            "CmsUserManagerException", "CommentException",
            "CopyFlowAdapterMsg", "CostingException", "DatabaseAdapterMsg",
            "DBConnectionPersistenceManager", "DependencyCheckException",
            "DesktopApplicationAdapterMsg", "DiplomatMergerException",
            "DocumentumPersistenceManagerException", "EditorMatchTypeLabels",
            "EnvoyServletException", "EventSchedulerException",
            "ExceptionResource", "ExportEventObserverException",
            "FileExtensionEntityException", "FileImportException",
            "FileProfileEntityException", "FileProfilePersistenceManager",
            "FileSystemAdapterMsg", "GlossaryException", "GxmlException",
            "ImporterException", "InddAdapterMsg", "JobCreationException",
            "JobException", "LingAdapterMsg", "LingManagerException",
            "LocaleManagerException", "LocaleResource", "MailerException",
            "MediasurfaceAdapterMsg", "MicrosoftApplicationAdapterMsg",
            ...
            "PdfAdapterMsg", "PersistenceException", "ProjectHandlerException",
            "ReimporterException", "RequestHandlerException",
            "SecondaryTargetFileException", "SecurityManagerException",
            "SnippetException", "StandardExtractorAgent",
            "StandardMergerAgent", "StatisticsException",
            "SystemParameterEntityException", "SystemStartupException",
            "TaskException", "TeamSiteAdapterMsg",
            "TeamsiteServerEntityException", "TemplateException",
            "TermbaseException", "TmManagerException",
            "UploadPageSaverException", "UserManagerException",
            "VendorException", "VignetteAdapterMsg", "WorkflowException",
            "WorkflowManagerException","EmailMessageResource" };
