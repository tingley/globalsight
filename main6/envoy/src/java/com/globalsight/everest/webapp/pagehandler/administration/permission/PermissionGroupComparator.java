...
/**
* This class can be used to compare PermissionGroup objects
*/
public class PermissionGroupComparator extends StringComparator
{
	//types of comparison
	...
	/**
	* Creates a PermissionGroupComparator with the given type and locale.
	* If the type is not a valid type, then the default comparison
	* is done by displayName
	*/
	public PermissionGroupComparator(int p_type,Locale p_locale)
	{
	    super(p_type, p_locale);
	}

	public PermissionGroupComparator(Locale p_locale)
	{
	    super(p_locale);
	}

	/**
	* Performs a comparison of two Permission Group objects.
	*/
	public int compare(java.lang.Object p_A, java.lang.Object p_B) {
		PermissionGroup a = (PermissionGroup) p_A;
		PermissionGroup b = (PermissionGroup) p_B;
