...
public interface ReportConstants
{
    ...
    public static final String LOCALIZED = "Exact Match";
    public static final String NOT_LOCALIZED = "Untranslated";
    public static final String APPROVED = "Translated/Approved";
