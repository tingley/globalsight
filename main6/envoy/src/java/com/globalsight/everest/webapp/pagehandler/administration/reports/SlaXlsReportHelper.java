...
{    
    ...
    throws Exception
    {
        ...
        SlaReportDataAssembler reportDataAssembler = 
            new SlaReportDataAssembler(p_request);
    ...
    public void generateReport() throws Exception
    {
        ...
        data.generalSheet = m_workbook.createSheet(bundle.getString("lb_sheet") + "1", 0);
    ...
    private void addHeader() throws Exception
    {
        ...
        WritableFont titleFont = new WritableFont(WritableFont.ARIAL, 
                                                  14,
                                                  WritableFont.BOLD, 
                                                  false, 
        ...
        theSheet.addCell(new Label(0, 0, bundle.getString("translation_sla_performance"), titleFormat));
        ...
        int c = 0;
        theSheet.addCell(new Label(c, 2, bundle.getString("lb_job_id"), headerFormat));
        theSheet.mergeCells(c, 2, c, 3);
        theSheet.setColumnView(c, 7);
        c++;
        theSheet.addCell(new Label(c, 2, bundle.getString("lb_job_name"), headerFormat));
        theSheet.mergeCells(c, 2, c, 3);
        theSheet.setColumnView(c, 40);
        c++;
        theSheet.addCell(new Label(c, 2, bundle.getString("lb_workflow"), headerFormat));
        theSheet.mergeCells(c, 2, c, 3);
        theSheet.setColumnView(c, 25);
        c++;
        theSheet.addCell(new Label(c, 2, bundle.getString("lb_language"), headerFormat));
        theSheet.mergeCells(c, 2, c, 3);
        theSheet.setColumnView(c, 12);
        c++;
        theSheet.addCell(new Label(c, 2, bundle.getString("lb_word_count"), headerFormat));
        theSheet.mergeCells(c, 2, c, 3);
        theSheet.setColumnView(c, 7);
        c++; 
        theSheet.addCell(new Label(c, 2, bundle.getString("lb_current_activity"), headerFormat));
        theSheet.mergeCells(c, 2, c, 3);
        theSheet.setColumnView(c, 14);
        c++; 
        theSheet.addCell(new Label(c, 2, bundle.getString("lb_translation_start_date"), headerFormat));
        theSheet.mergeCells(c, 2, c, 3);
        theSheet.setColumnView(c, 28);
        c++;
        theSheet.addCell(new Label(c, 2, bundle.getString("lb_translation_due_date"), headerFormat));
        theSheet.mergeCells(c, 2, c, 3);
        theSheet.setColumnView(c, 28);
        c++;
        theSheet.addCell(new Label(c, 2, bundle.getString("lb_translation_finish_date"), headerFormat));
        theSheet.mergeCells(c, 2, c, 3);
        theSheet.setColumnView(c, 28);
        c++;
        theSheet.addCell(new Label(c, 2, bundle.getString("lb_on_time"), headerFormat));
        theSheet.mergeCells(c, 2, c, 3);
        theSheet.setColumnView(c, 28);
        c++;
        theSheet.addCell(new Label(c, 2, bundle.getString("lb_leadtime"), headerFormat));
        theSheet.mergeCells(c, 2, c, 3);
        theSheet.setColumnView(c, 12);
        c++;
        theSheet.addCell(new Label(c, 2, bundle.getString("lb_actual_performance"), headerFormat));
        theSheet.mergeCells(c, 2, c, 3);
        theSheet.setColumnView(c, 14);
    }
    ...
    throws Exception
    {
        ...
        WritableCellFormat moneyFormat = new WritableCellFormat(euroNumberFormat);
        ...
        while (projectIter.hasNext())
        {
            ...
            while (localeIter.hasNext())
            {
                ...
                ProjectWorkflowData data = 
                    (ProjectWorkflowData) localeMap.get(localeName);
                ...
                theSheet.addCell(new Label(col++, row, dateFormat.format(data.creationDate)));
                
                // Translation Due Date
                if (data.estimatedTranslateCompletionDate == null)
                {
                    theSheet.addCell(new Label(col++, row, bundle.getString("lb_no_translation")));
                }
                else
                {
                    theSheet.addCell(new Label(col++, row, dateFormat.format(data.estimatedTranslateCompletionDate)));
                }
                ...
                {
                	theSheet.addCell(new Label(col++, row, dateFormat.format(data.actualTranslateCompletionDate)));
                }
                ...
                {
                	theSheet.addCell(new Label(col++, row, bundle.getString("lb_yes")));
                }
                else
                {
                	theSheet.addCell(new Label(col++, row, bundle.getString("lb_no")));
                }
                ...
                {
                    theSheet.addCell(new Label(col++, row, bundle.getString("lb_not_completed")));
                }
                else
                {
                    theSheet.addCell(new Label(col++, row, data.actualPerformance));
                }
