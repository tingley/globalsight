...
public class TranslationProgressReportHelper
{
            ...
            throws Exception
    {
        ...
        percent = NumberFormat
                .getPercentInstance((Locale) session.getAttribute(WebAppConstants.UILOCALE));
            ...
            String[] paramSourceLocales, String[] paramTargetLocales) throws Exception
    {
        ...
        if (selectedWF != null)
        {
            Collection<TargetPage> targetPages = selectedWF.getTargetPages();
            ...
            throws LocaleManagerException, RemoteException, GeneralException
    {
        ...
        {
            m_sourceLocale = ServerProxy.getLocaleManager()
                    .getLocaleById(Long.valueOf(paramSourceLocales[0]));
        }

        if (paramTargetLocales != null && !"*".equals(paramTargetLocales[0]))
        {
            m_targetLocale = ServerProxy.getLocaleManager()
                    .getLocaleById(Long.valueOf(paramTargetLocales[0]));
        }
    }
