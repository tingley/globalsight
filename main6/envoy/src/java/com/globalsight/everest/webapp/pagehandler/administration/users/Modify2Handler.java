...
public class Modify2Handler extends PageHandler {
    ...
    public void invokePageHandler(WebPageDescriptor p_thePageDescriptor,
        ...
        if (action != null && action.intern() == USER_ACTION_MODIFY_LOCALES) {
            ...
            {
            	wrapper.addUserRoles(sourceLocale,targetLocale[i],activityCostMap,
            			(String)p_theRequest.getParameter(COMPANY_ID));
            }
    ...
    /**
     * set roles data for the page
     * each role pair has a company id
     */
    private void setRolesData(HttpSession session, HttpServletRequest request,
        ...
        if(roles != null) {
	        ...
	        while (it.hasNext()) {
	            ...
	            String companyId = role.getActivity().getCompanyId();
        ...
        setTableNavigation(request, session, data, new UserRoleComparator(
                uiLocale), 10, // change this to be configurable!
    ...
    private ArrayList populateData(Hashtable p_map, Locale p_uiLocale)
        ...
        while (eKeys.hasMoreElements()) {
            ...
            while (eTargets.hasMoreElements()) {
                ...
                String[] pair = { sourceLocale, targetLocale };
        ...
        for (int i = 0; i < vLines.size(); i++) {
            ...
            userRole
                    .setSourceDisplayName(((GlobalSightLocale) UserHandlerHelper
                            .getLocaleByString(curLine[0]))
                            .getDisplayName(p_uiLocale));
            userRole
                    .setTargetDisplayName(((GlobalSightLocale) UserHandlerHelper
                            .getLocaleByString(curLine[1]))
                            .getDisplayName(p_uiLocale));
