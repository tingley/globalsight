...
/**
 * The page handler displaying new rate page for a task.
 */

public class TaskRateHandler extends PageHandler
{
        ...
        EnvoyServletException
    {
        ...
        Task task = WorkflowTemplateHandlerHelper.getTaskById(Long.parseLong(taskId));
        sessionMgr.setAttribute("task", task);
        List ratings = task.getRatings();
        if (ratings != null && ratings.size() > 0)
        {
            sessionMgr.setAttribute("rating", ratings.get(0));
