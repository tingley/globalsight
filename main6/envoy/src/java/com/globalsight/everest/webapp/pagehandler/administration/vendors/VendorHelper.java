...
public class VendorHelper
{
    ...
    public static List searchVendors(User user, SessionManager sessionMgr)
        throws  EnvoyServletException
    {
        VendorSearchParameters sp = (VendorSearchParameters) sessionMgr.getAttribute(
                                    "vendorSearch");
        try
        {
            // Do search
        ...
        throws  EnvoyServletException
    {
        try
        {
            ...
            {
                setAtLeastOneCriteria = true;
                sp.setSourceLocale(ServerProxy.getLocaleManager().getLocaleById(
                                    Long.parseLong(buf)));
            }
            ...
            {
                setAtLeastOneCriteria = true;
                sp.setTargetLocale(ServerProxy.getLocaleManager().getLocaleById(
                                    Long.parseLong(buf)));
            }
     ...
     * @exception EnvoyServletException
     */
    public static Vendor getVendorByCustomId(User p_userQuerying, 
                                             String id)
        throws  EnvoyServletException
    {
        try
        {
            return ServerProxy.getVendorManagement().
                getVendorByCustomId(p_userQuerying, id);
        }
        catch (Exception e)
        {
            throw new EnvoyServletException(e);
    ...
    public static List getSecurities(
        List p_vendorInfos, User p_user)
        throws  EnvoyServletException
    {
        try
        {
        ...
        throws  EnvoyServletException
    {
        ...
        {
            return 
              ServerProxy.getSecurityManager().getFieldSecurity(user, 
                                                                vendor,
                                                                checkProject);
        }
        catch (Exception e)
     ...
     * @exception EnvoyServletException
     */
    public static void removeVendor(User user, long id)
        ...
        throws EnvoyServletException
    {
        ...
        {
            Collection cns = 
                ServerProxy.getVendorManagement().getCompanyNames();
        ...
        throws  EnvoyServletException
    {
        try
        {
            Vector usernames = ServerProxy.getUserManager().getVendorlessUsers();
            Collections.sort(usernames,
                 new UserComparator(UserComparator.DISPLAYNAME, uiLocale));
            return usernames;
        }
        catch (Exception e)
        {
     ...
     * @exception EnvoyServletException
     */
    public static ArrayList getAllAliases()
        throws  EnvoyServletException
    {
        try
        {
     ...
     * @exception EnvoyServletException
     */
    public static Collection getCostingRates()
        throws  EnvoyServletException
    {
        try
        {
    ...
    /**
     * Given a list of locale pairs, remove them from the list
     * of all locale pairs.  Then create a hashtable where the key
     * is the source locale, and the value is all possible target locales.
     *
     */
        ...
        throws  EnvoyServletException
    {
        ...
        for (int i = 0; i < sourceLocales.size(); i++)
        {
            GlobalSightLocale curLocale =
                (GlobalSightLocale) sourceLocales.elementAt(i);
            Vector validTargets =
                 UserHandlerHelper.getTargetLocales(curLocale);
    ...
    /**
     * Return a hashtable where the key is an activity and the value is
     * a list of the activity rates
     */
    ...
    /**
     * Given a vendor, src local, & targ locale,
     * return a hashtable of it's activities
     * where the key is an activity and the value is
     * it's rate.
     */
        ...
        else
        {
            ...
            if (task != null)
            {
                try
                {
                    ...
                    task = ServerProxy.getTaskManager().
                                    getTask(task.getId(), true);
        ...
        throws  EnvoyServletException
    {
        ...
        if (buf != null) vendor.setStatus(buf);
        buf = (String) request.getParameter("firstName");
        if (buf != null) vendor.setFirstName(buf);
        buf = (String) request.getParameter("lastName");
        if (buf != null) vendor.setLastName(buf);
        buf = (String) request.getParameter("userTitle");
        if (buf != null) vendor.setTitle(buf);
        ...
        if (buf != null) vendor.setNotes(buf);
        buf = (String) request.getParameter("countries");
        if (buf != null) vendor.setNationalities(buf);
        buf = (String) request.getParameter("dateOfBirth");
        if (buf != null) vendor.setDateOfBirth(buf);
        buf = (String) request.getParameter("alias");
        if (buf != null) vendor.setPseudonym(buf);
    ...
    public static void saveContactInfo(Vendor vendor, HttpServletRequest request)
    {
        ...
        if (buf != null) vendor.setAddress(buf);
        buf = (String)request.getParameter("country");
        if (buf != null) vendor.setCountry(buf);
        buf = (String)request.getParameter("homePhone");
        if (buf != null) vendor.setPhoneNumber(User.PhoneType.HOME, buf);
        buf = (String)request.getParameter("workPhone");
        if (buf != null) vendor.setPhoneNumber(User.PhoneType.OFFICE, buf);
        buf = (String)request.getParameter("cellPhone");
        if (buf != null) vendor.setPhoneNumber(User.PhoneType.CELL, buf);
        buf = (String)request.getParameter("fax");
        if (buf != null) vendor.setPhoneNumber(User.PhoneType.FAX, buf);
        buf = (String)request.getParameter("email");
        if (buf != null) vendor.setEmail(buf);
        buf = (String)request.getParameter("uiLocale");
        if (buf != null) vendor.setDefaultUILocale(buf);
    }
        ...
        throws  EnvoyServletException
    {
        try
        {
            ...
            fs.put(VendorSecureFields.DOB,
                   request.getParameter("dateOfBirth"));
            fs.put(VendorSecureFields.ROLES,
                   request.getParameter("roles"));
            fs.put(VendorSecureFields.ADDRESS,
                   request.getParameter("address"));
            fs.put(VendorSecureFields.COUNTRY,
     ...
     */
    public static void savePermissions(Vendor vendor, HttpServletRequest request,
                                  SessionManager sessionMgr)
        throws  EnvoyServletException
    {
        ...
        try {
            if (toField != null && !toField.equals(""))
            {
                ...
                {
                    userPerms.add(Permission.getPermissionManager().readPermissionGroup(
                                                            Long.parseLong(perm[i])));
                }
            }
        }
        catch(Exception e)
        ...
        throws  EnvoyServletException
    {
        try
        {
            ServerProxy.getVendorManagement().updateRating(user, vendor, rating);
        }
        catch (Exception e)
        {
            throw new EnvoyServletException(e);
     ...
     */
    public static void newRole(Vendor vendor,
        ...
        throws  EnvoyServletException
    {
        ...
        try {
            ...
            lp =
                ServerProxy.getLocaleManager().getLocalePairBySourceTargetIds(
        ...
        for (int i = 0; i < activities.size(); i++)
        {
            ...
            String activityName = (String)
                request.getParameter(activity.getActivityName());
            Rate rate = null;
     ...
     */
    public static void modifyRole(Vendor vendor,
                                  HttpServletRequest request,
                                  SessionManager sessionMgr,
                                  Locale uiLocale)
        throws  EnvoyServletException
    {
        ...
        GlobalSightLocale srcLocale = (GlobalSightLocale)
                sessionMgr.getAttribute("sourceLocale");
        GlobalSightLocale targLocale = (GlobalSightLocale)
        ...
        throws  EnvoyServletException
    {
        ...
        if (toField != null)
        {
            ...
            else
            {
                try {
                    ...
                    {
                        Project proj =
                           ServerProxy.getProjectHandler().getProjectById(
                            Long.parseLong(projIds[i]));
                        projects.add(proj);
                    }
        ...
        PermissionSet permSet = (PermissionSet) request.getSession(false).getAttribute(
        ...
        throws EnvoyServletException
    {
        try
        {
            return ServerProxy.getProjectHandler().
                getProjectsManagedByUser(user, Permission.GROUP_MODULE_VENDOR_MANAGER);
        }
        catch (Exception ge)
        {
            throw new EnvoyServletException(ge);
                                             ...
                                             Vendor vendor)
    {
        ...
        for (Iterator r = roles.iterator() ; r.hasNext() ; )
        {
            ...
            if (existingLP.getId() == lp.getId() &&
                activityName.equals(role.getActivity().getActivityName()))
            {
                return role;
            }
        }
        ...
        throws  EnvoyServletException
    {
        ...
        {
            // Get the rate
            String rateId = (String) request.getParameter(
                    activity.getActivityName()+"_expense");
            if (!rateId.equals("-1"))
            {
                try {
                    rate = (Rate) ServerProxy.getCostingEngine().getRate(Long.parseLong(rateId));
                }
                catch (Exception e )
                {
                    throw new EnvoyServletException(e);
