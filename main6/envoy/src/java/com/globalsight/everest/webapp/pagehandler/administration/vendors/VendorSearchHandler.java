...
public class VendorSearchHandler extends PageHandler
            implements VendorConstants
{
    ...
    throws ServletException, IOException, EnvoyServletException
    {
        ...
        request.setAttribute("srcLocales", 
            WorkflowTemplateHandlerHelper.getAllSourceLocales(uiLocale));
        request.setAttribute("targLocales", 
            WorkflowTemplateHandlerHelper.getAllTargetLocales(uiLocale));
        request.setAttribute("costingRates", Rate.getRateTypes());
        request.setAttribute("activities", VendorHelper.getAllActivities());
        request.setAttribute("customPage", CustomPageHelper.getPageTitle());
