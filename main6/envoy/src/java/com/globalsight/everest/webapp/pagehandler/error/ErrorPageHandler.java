...
public class ErrorPageHandler extends PageHandler
{
   ...
   */
                ...
                ServletContext p_context) throws ServletException, IOException
    {
        ...
        //AbstractXMLResourceWrapper xmlResources = ErrorXMLResources.getInstance();
        //p_theRequest.setAttribute("xmlResources", xmlResources);
