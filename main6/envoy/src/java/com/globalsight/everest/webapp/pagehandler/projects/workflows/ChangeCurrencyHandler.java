...
/**
 * This is an empty page handler just for the purposes 
 * of I18N of the strings in the changeCurrency.jsp 
 * page
 */
public class ChangeCurrencyHandler extends PageHandler
{
    public ChangeCurrencyHandler()
    {
    }
