...
implements ControlFlowHelper, WebAppConstants
{
    ...
    public EstimatedTranslateCompletionDateControlFlowHelper(HttpServletRequest p_request,
        ...
        throws EnvoyServletException
    {
        ...
        else if (action.equals(JobManagementHandler.ESTIMATED_TRANSLATE_COMP_DATE))
        {  
