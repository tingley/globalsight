 ...
 */
class EstimatedTranslateCompletionDateControlFlowHelper implements
        ControlFlowHelper, WebAppConstants
{
    ...
    public EstimatedTranslateCompletionDateControlFlowHelper(
    ...
    public String determineLinkToFollow() throws EnvoyServletException
    {
        ...
        if (action == null)
        {
            ...
            // again.
            destinationPage = JobManagementHandler.ESTIMATED_TRANSLATE_COMP_DATE_BEAN;
        }
        else if (action
                .equals(JobManagementHandler.ESTIMATED_TRANSLATE_COMP_DATE))
        {
            // Save the estimated translate completion date
            WorkflowHandlerHelper.updateEstimatedTranslateCompletionDates(
                    m_request, timezone);
