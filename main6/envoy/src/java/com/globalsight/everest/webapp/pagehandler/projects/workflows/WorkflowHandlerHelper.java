...
public class WorkflowHandlerHelper
{
    ...
    /**
     * Cancel all workflows of the given state; if all are cancelled,
     * cancel the job too.  If the state is NULL then it cancels all
     ...
     */
    static void exportPage(ExportParameters p_exportParameters,
        List p_pageIds, boolean p_isTargetPage, long p_exportBatchId)
        throws EnvoyServletException
    {
        try
        {
    ...
    /**
     * Get a list of currently active task(s) for the specified
    ...
    /**
     * Get a list of job objects based on a particular state (such as:
     * 'ready', 'in progresss' and 'completed').
     *
        ...
        throws EnvoyServletException
    {
        try
        {
            ...
            return ServerProxy.getJobHandler().getJobsByStateList(
                p_stateList, true);
        }
        catch (Exception e)
        {
     ...
     *
     * @param p_userId The user id of the project manager.
     * @param p_state The state of the job.
     * @exception EnvoyServletException Component related exception.
     */
     ...
     *
     * @param p_userId The user id of the project manager.
     * @param p_stateList The state list of multiple states.
     * @exception EnvoyServletException Component related exception.
     */
    static public Collection getJobsByManagerIdAndStateList(
        String p_userId, Vector p_stateList)
        throws EnvoyServletException
    {
        try
        {
    ...
    /**
     * Gets a list of job objects based on a id of a particular
     * workflow manager and particular state (such as: 'ready', 'in
     * progresss' and 'completed').
     * @param p_userId The user id of the workflow manager.
     * @param p_stateList The state list of multiple states.
     * @exception EnvoyServletException Component related exception.
     */
    static public Collection getJobsByWfManagerIdAndStateList(
        String p_userId, Vector p_stateList)
        throws EnvoyServletException
    {
        try
        {
            return ServerProxy.getJobHandler().getJobsByWfManagerIdAndStateList(
                p_userId, p_stateList);
        }
        catch (Exception e)
        {
    ...
    /**
     * Gets a list of job objects based on a rate and Job state is
     * either PENDING or DISPATCHED
     * @param p_rate The rate used by any of the tasks.
     * @exception EnvoyServletException Component related exception.
     */
     ...
     * @param p_job the job of the job that is having workflows added to
     */
     ...
     * Get a list of workflow objects based on a particular workflow id.
     *
     * @param p_workflowId - The id of the workflow.
     * @return A vector of only ONE workflow (always a vector is returned
     ...
     *
     * @param p_jobId - The id of the job (also is the foreign key in
     * the workflow).
     * @return A vector of only ONE workflow (always a vector is returned
     * since TOPLink is unaware of querying for one or more objects.)
     * @exception EnvoyServletException - Component related exception.
     ...
     */
    static List getTaskInfos(Workflow wf)
        throws EnvoyServletException
    {
        try
        {
    ...
    /**
     * This method reassigns a user to a different user during any
     * task of the workflow
     * @param String Session Id, WorkflowInstance iFlow instance
     * @throws EnvoyServletException
     */
    ...
    /**
     * Determine if the workflow can be modified.  This is used for
     * enabling a link or button in order to go to the modify workflow UI.
     */
     ...
     * 
     * @param p_wfInstanceTasks - the workflow instance tasks.
     * 
