...
/**
 * RSSPersistenceManagerLocal provides the main implementation 
 * of the RSSPersistenceManager interface.
 */
...
public class RSSPersistenceManagerLocal implements RSSPersistenceManager
{
	 ...
	 * @param p_str content of RSS_URL
	 * @return List : Feed
	 */
	...
	public Feed getFeed(long p_id) {
        ...
        {
            throw new GeneralException("Failed to get Feed with id is " + p_id, pe);
        }
        return feed;
	}
