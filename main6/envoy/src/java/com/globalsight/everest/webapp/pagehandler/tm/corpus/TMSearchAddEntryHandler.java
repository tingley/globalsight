...
public class TMSearchAddEntryHandler extends PageActionHandler
{
    @ActionHandler(action = TM_ACTION_ADD_ENTRY, formClass = "")
            ...
            HttpServletResponse response, Object form) throws Exception
    {
        ...
        TMSearchAddEntryHandlerHelper.setLable(request, bundle);
        // set entry info
        TMSearchAddEntryHandlerHelper.addEntries(request, userId);
    }
            ...
            HttpServletResponse response, Object form) throws Exception
    {
        HttpSession session = request.getSession(false);
        String userId = getUser(session).getUserId();
        String message = TMSearchAddEntryHandlerHelper.saveEntries(request,
                userId);
