...
/**
 * WorkflowException is a subclass of GeneralException.
 * All workflow related exceptions will throw this exception. 
*/
...
public class WorkflowException extends GeneralException
{
    ...
    // Args: 1 - role name (i.e. 1001 translate en_US fr_FR, 1001 translate en_US fr_FR userid)
    public final static String MSG_FAILED_TO_GET_ASSIGNEES_FOR_ROLE = 
        "failedToGetAssigneesForRole";

    // Args: 1 - sequence number of task
    //       2 - process instance id
    public final static String MSG_FAILED_TO_UPDATE_ASSIGNEES_FOR_TASK = 
        "failedToUpdateAssigneesForTask";
     ...
     * @param p_messageId The id for the explanation of the error.
     * @param p_originalException The original exception that this exception identifies.
     */
    public WorkflowException(int p_exceptionId, int p_messageId, Exception p_originalException)
    {
        super();
    }
    ...
    //////////////////////////////////////////////////////////////////////
    //  Begin: Constructors to be used (the ones outside this block should be removed.
    //////////////////////////////////////////////////////////////////////
    /**
    ...
    //////////////////////////////////////////////////////////////////////
    //  End: Constructors to be used (the ones outside this block should be removed.
    //////////////////////////////////////////////////////////////////////
}
