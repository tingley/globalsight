...
public class WorkflowJbpmPersistenceHandler
{
    ...
    public static void saveSkipVariable(TaskInstance taskInstance,
            long workflowId)
    {
        JbpmVariable taskVariable = new JbpmVariable();
        ...
        WorkflowConfiguration.getInstance().getCurrentContext().getSession()
                .save(taskVariable);
    }
    ...
    /**
     * Fix for GBS-1470 Judges whether the user is rejected for (This user
     * Rejected the task first, then reassign to this user)
     * 
     * @param ctx
     *            {@code JbpmContext}
     * @param userId
     ...
     */
    public static boolean isUserRejectedForReassign(JbpmContext ctx,
            String userId, TaskInstance taskInstance)
    {
    ...
    public static List<String> getSkippedTaskInstance(long workflowId,
            JbpmContext p_ctx)
    {
        Session session = p_ctx.getSession();
    ...
    static class SqlHolder
    {
        ...
        static
        {
            ...
            activeTaskSb.append("and vi.NAME = :").append(VARIABLE_NAME)
                    .append(" ");
            activeTaskSb.append("and (vi.VALUE != :").append(ACTOR_ID)
                    .append(" ");
            activeTaskSb.append("or vi.VALUE is null) ");
            activeTaskSb.append("and vi.CATEGORY = :").append(CATEGORY)
                    .append(" ");
            ...
            activeTaskPmSb.append("or ti.DESCRIPTION_ = :").append(PM)
                    .append(" ");
            ...
            rejectTaskSb.append("where vi.NAME = :").append(VARIABLE_NAME)
                    .append(" ");
            rejectTaskSb.append("and vi.VALUE = :").append(USER_ID).append(" ");
            rejectTaskSb.append("and vi.CATEGORY = :").append(CATEGORY)
                    .append(" ");
            rejectTaskSb.append("and ti.ID_ not in (");
            rejectTaskSb.append("select ti.ID_ ");
            rejectTaskSb
                    .append("from JBPM_TASKINSTANCE ti join JBPM_TASKACTORPOOL tap ");
            ...
            rejectTaskSb.append("on ti.ID_ = vi.TASKINSTANCE_ID ");
            rejectTaskSb.append("and vi.NAME = :").append(VARIABLE_NAME)
                    .append(" ");
            rejectTaskSb.append("and vi.VALUE = :").append(USER_ID).append(" ");
            rejectTaskSb.append("and vi.CATEGORY = :").append(CATEGORY)
                    .append(" ");
            rejectTaskSb.append("where pa.ACTORID_ = :").append(USER_ID)
                    .append(" ");
            rejectTaskSb.append(")");
            ...
            isUserRejectedSb.append("and vi.CATEGORY = :").append(CATEGORY)
                    .append(" ");
            isUserRejectedSb.append("and ti.id_ = :").append(TASK_ID)
                    .append(" ");

            isUserRejectedForReassignSb.append("select count(*) ");
            isUserRejectedForReassignSb
                    .append("from JBPM_TASKINSTANCE ti join JBPM_TASKACTORPOOL tap ");
            isUserRejectedForReassignSb
                    .append("on ti.ID_ = tap.TASKINSTANCE_ ");
            isUserRejectedForReassignSb
                    .append("inner join JBPM_POOLEDACTOR pa ");
            isUserRejectedForReassignSb.append("on tap.POOLEDACTOR_ = pa.ID_ ");
            isUserRejectedForReassignSb
                    .append("inner join JBPM_GS_VARIABLE vi ");
            isUserRejectedForReassignSb
                    .append("on ti.ID_ = vi.TASKINSTANCE_ID ");
            isUserRejectedForReassignSb.append("and vi.NAME = :")
                    .append(VARIABLE_NAME).append(" ");
            isUserRejectedForReassignSb.append("and vi.VALUE = :")
                    .append(ACTOR_ID).append(" ");
            isUserRejectedForReassignSb.append("and vi.CATEGORY = :")
                    .append(CATEGORY).append(" ");
            isUserRejectedForReassignSb.append("where pa.ACTORID_ = :")
                    .append(ACTOR_ID).append(" ");
            isUserRejectedForReassignSb.append("and ti.id_ = :")
                    .append(TASK_ID).append(" ");
            ...
            isAllUserRejectedSb.append("where vi.NAME = :")
                    .append(VARIABLE_NAME).append(" ");
            ...
            isAvailableExistPmSb.append("and vi.CATEGORY = :").append(CATEGORY)
                    .append(" ");
            isAvailableExistPmSb.append("where ( pa.ACTORID_ = :")
                    .append(ACTOR_ID).append(" ");
            ...
            isTaskRejectedSb.append("and vi.CATEGORY = :").append(CATEGORY)
                    .append(" ");
            isTaskRejectedSb.append("and pa.ACTORID_ != :").append(PM)
                    .append(" ");
            isTaskRejectedSb.append("and ti.id_ = :").append(TASK_ID)
                    .append(" ");
            ...
            skippedTaskInstance.append("where vi.value = :")
                    .append(WORKFLOW_ID).append(" ");
            skippedTaskInstance.append("and vi.CATEGORY = '")
                    .append(VARIABLE_CATEGORY_SKIP).append("' ");
        ...
        static String isUserRejectForReassign = isUserRejectedForReassignSb
                .toString();
