...
public interface WorkflowServer {
	 ...
	 * 
	 */
	public void acceptTask(Workflow wfClone, String p_assignee, long p_nodeInstanceId, TaskInfo p_taskInfo,
			TaskEmailInfo m_emailInfo, boolean isSkipped) throws RemoteException, WorkflowException;
	 ...
	 */
	WorkflowTemplate importWorkflowTemplate(WorkflowTemplate p_wfTemplate, Document doc) throws RemoteException,
			WorkflowException;
	 ...
	 *                - Wraps jbpm's exceptions.
	 */
	WorkflowTemplate createWorkflowTemplate(WorkflowTemplate p_wfTemplate, WorkflowOwners p_worklfowOwners)
			throws RemoteException, WorkflowException;
	 ...
	 *                - Wraps jbpm's exceptions.
	 */
	WorkflowInstance createWorkflowInstance(long p_wfTemplateId) throws RemoteException, WorkflowException;

	/**
	 * @see WorkflowServerLocal.filterTasksForPM(String, int).
	 */
	public Map filterTasksForPM(String p_userId, int p_taskState) throws RemoteException, WorkflowException;
	 ...
	 *                - Wraps jbpm's exceptions.
	 */
	long[] taskIdsInDefaultPath(long p_workflowInstanceId) throws WorkflowException, RemoteException;
	 ...
	 */
	public List timeDurationsInDefaultPath(long p_workflowInstanceId, long p_startNodeId, ArrorInfo p_destinationArrow,
	 ...
	 *                - Wraps jbpm's exceptions.
	 */
	public Map getTasksForUser(String p_userId, int p_taskState) throws RemoteException, WorkflowException;
	 ...
	 *                -
	 */
	public List<WorkflowTaskInstance> getUnVisitedTasksForWorkflow(long p_workflowInstanceId) throws RemoteException,
			WorkflowException;
	 ...
	 *                - Wraps jbpm's exceptions.
	 */
	WfTaskInfo getWorkflowTaskInfo(long p_workflowInstanceId, long p_taskId) throws RemoteException, WorkflowException;
	 ...
	 *                - Wraps jbpm's exceptions.
	 */
	public WorkflowTaskInstance getWorkflowTaskInstance(long p_workflowId, long p_taskId) throws RemoteException,
			WorkflowException;
	 ...
	 */
	WorkflowTemplate modifyWorkflowTemplate(WorkflowTemplate p_wfTemplate, WorkflowOwners p_worklfowOwners)
			throws RemoteException, WorkflowException;
	 ...
	 *                - Wraps jbpm's exceptions.
	 */
	Map modifyWorkflowInstance(String p_sessionId, WorkflowInstance p_wfInstance, DefaultPathTasks p_taskInfos,
	 ...
	 *                - Wraps jbpm's exceptions.
	 */
	void reassignUserActivitiesToPm(String p_userId) throws RemoteException, WorkflowException;
	 ...
	 *                - Wraps jbpm's exceptions.
	 */
	public void reassignWorkflowOwners(long p_workflowInstanceId, String p_projectManagerId, String[] p_workflowOwners)
			throws RemoteException, WorkflowException;
