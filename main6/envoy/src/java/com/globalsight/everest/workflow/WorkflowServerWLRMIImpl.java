		...
		WorkflowServerWLRemote
{
			...
			String skipping) throws RemoteException, WorkflowException
	{
		return m_localInstance.advanceTask(p_wfClone, p_assignee,
				p_nodeInstanceId, p_arrowLabel, p_taskInfos, p_emailInfo, skipping);
	}
	...
	/*
     * @see com.globalsight.everest.workflow.WorkflowServer#timeDurationsInDefaultPath(java.lang.String,
     *      long, long)
     */
     ...
     *      long, java.lang.String, com.fujitsu.iflow.model.workflow.Node[])
     */
    ...
    public List<WorkflowTaskInstance> getUnVisitedTasksForWorkflow(long p_workflowInstanceId)
            throws RemoteException, WorkflowException
    {
        return m_localInstance.getUnVisitedTasksForWorkflow(p_workflowInstanceId);
    }
     ...
     * 
     * @param p_sessionId -
     *            The client's http session id. This id is used for obtaining a
     *            Workflow Session object (i-Flow object).
     * @param p_wfInstance -
