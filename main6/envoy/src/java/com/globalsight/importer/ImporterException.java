...
/**
 * <p>The Importer Exception class.</p>
 */
public class ImporterException
    extends GeneralException
{
    /**
     * Importer related messages are stored in the following
     * property file.
     */
    private final static String PROPERTY_FILE_NAME = "ImporterException";
    ...
    public final static String MSG_IMPORT_FAILED = "importFailed";
    // Args: 1 - reason as string
     ...
     * be "LingMessage".
     */
    public ImporterException(String p_messageKey,
