...
public class SafabaTranslateUtil
{
            ...
            throws Exception
    {
        ...
        logger.info("Single translation source: " + text);
                ...
                new Callable<String>()
                {
                    public String call()
                    {
                        SafabaSecureClient client = new SafabaSecureClient(
                                hostName, port, companyName, password);
                        try
                        {
        ...
        try
        {
            ...
            logger.info("Single translation result from Safaba: " + result);
            return result;
        }
        catch (Exception e)
        {
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            if (back != null)
            {
                ...
                temp.append("Safaba batch translation ").append(back.size())
                        .append(" result: \n");
                for (int i = 0; i < back.size(); i++)
                {
                    temp.append(back.get(i)).append("\n");
                }
                logger.info(temp);
                back.toArray(result);
                return result;
