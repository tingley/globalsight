...
public class JobTableModel2 extends AbstractTableModel
{
    ...
    public static final String[] COLUMN_NAMES = { "ID", "PRIORITY", "PROJECT",
            "PM", "JOBNAME", "SRCLOCALE", "DATASRC", "WORDCNT", "CREATE_DATE",
            "COST", "ACTUALCOST", "TOTALCOST", "JOB_OBJECT", "JOBSTATUS",
            "CURRENCY", "LOCPROFILE",  "ACTUAL_REVENUE",
            "TOTAL_REVENUE" };
...
//                break;
    ...
    private Cost getJobCost(Job p_job, Currency p_currency, int p_costType)
    {
        ...
        if(p_costType == Cost.EXPENSE)
            cost = BasicReportHandler.calculateJobCost(p_job, p_currency, p_costType);
        else
            cost = BasicReportHandler.calculateJobCost(p_job, p_currency, p_costType);
        return cost;
    }
