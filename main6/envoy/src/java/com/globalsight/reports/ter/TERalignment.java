...
public class TERalignment
{
    ...
    public static void performShiftArray(HashMap hwords, int start, int end, int moveto,
            int capacity)
    {
        ...
        else
        {
            ...
            copyHashWords(hwords, nhwords, end + moveto - start + 1, capacity, end + moveto - start
                    + 1);
        }
        hwords.clear();
    ...
    private String prtShift(Comparable[] ref, TERshift[] allshifts)
    {
        ...
        if (allshifts != null)
        {
            for (int i = 0; i < allshifts.length; ++i)
            {
                ...
                to_return += getPraStr(ref, allshifts[i].aftershift, allshifts[i].alignment,
                        oneshift, true);
            }
            to_return += "\n";
        }
    ...
    private String getPraStr(Comparable[] ref, Comparable[] aftershift, char[] alignment,
    ...
    private static void copyHashWords(HashMap ohwords, HashMap nhwords, int start, int end,
            int nstart)
    {
        int ind_start = 0;
        int ind_end = 1;
