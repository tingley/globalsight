 ...
 * a Project Manager.  The eventFired method is invoked through Quartz when the time
 * for notification is reached.
 */
    ...
    
{
        ...
        throws EventHandlerException
    {
        ...
        {      
            int eventKey = 
                ((Integer)p_flowContext.get(SchedulerConstants.EVENT_KEY)).intValue();
	...
	private void notifyProjectManager(String p_subjectSuffix,
		...
		EventSchedulerHelper.notifyProjectManager(p_emailInfo, 
		                                          prefix+ p_subjectSuffix, prefix + p_messageSuffix);
	}    
