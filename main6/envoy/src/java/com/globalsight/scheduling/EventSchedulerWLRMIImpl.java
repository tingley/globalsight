...
/**
 * This class represents the remote implementation of an event scheduler. Note
 * that all of the methods of this class throw the following exceptions: 1.
 * EventSchedulerWLRMIImpl - For event scheduling related errors. 2.
 * RemoteException - For network related exception.
 */

public class EventSchedulerWLRMIImpl extends RemoteServer implements EventSchedulerWLRemote
{
     ...
     */
    public EventSchedulerWLRMIImpl() throws RemoteException, EventSchedulerException
    {
    ...
    {
        return m_esl.determineDateByDefaultCalendar(p_startDate, p_duration, p_companyId);
    }
     ...
     *      Timestamp, TimeZone)
     */
    public CalendarBusinessIntervals makeCalendarBusinessIntervals(List p_holidays,
            List p_reservedTimes, List p_personalEvents, List p_workingDays, Timestamp p_startDate,
            TimeZone p_timeZone) throws RemoteException, EventSchedulerException
    {
        return m_esl.makeCalendarBusinessIntervals(p_holidays, p_reservedTimes, p_personalEvents,
