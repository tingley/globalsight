 ...
 * Database Manager.  Responsible for creating, deleting, and
 * accessing terminology databases.</p>
 *
 * <p>This class is a singleton (a factory for ITermbase objects)
 * and manages the list of known termbases.</p>
 */
public class ITermbaseManagerImpl
               ...
               TermbaseExceptionMessages
{
     ...
     * @return an ArrayList
     */
    public ArrayList getTermbaseList(Locale p_uiLocale)
        throws RemoteException
    {
     ...
     */
    public String getTermbaseName(long p_id)
        throws RemoteException
    {
     ...
     */
    public long getTermbaseId(String p_name)
        throws RemoteException
    {
    ...
    public ITermbase create(String p_user, String p_password,
        String p_definition, String p_companyId)
        throws TermbaseException, RemoteException
    {
        if (p_user == null || p_user.length() == 0)
        {
     ...
     */
    public void rename(String p_name, String p_newName,
        ...
        throws TermbaseException, RemoteException
    {
        ...
        if (tb2 != null)
        {
            String[] args = { "duplicate new name" };
            throw new TermbaseException(MSG_INVALID_ARG, args, null);
        }
        ...
        TermAuditEvent auditEvent = new TermAuditEvent(
            ...
            p_name,
            "ALL",
            "delete", "renamed termbase to " + p_newName);
        TermAuditLog.log(auditEvent);
    }
        ...
        throws TermbaseException, RemoteException
    {
        ...
        {
            String[] args = { "definition is null" };
            throw new TermbaseException(MSG_INVALID_ARG, args, null);
        }
     ...
     * is returned (without Termbase name).
     */
     ...
     */
    public String getStatistics(String p_name)
        throws TermbaseException, RemoteException
    {
        if (p_name == null || p_name.length() == 0)
        {
