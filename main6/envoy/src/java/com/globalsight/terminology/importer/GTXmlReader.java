...
/**
 * Reads GTXML files and produces Entry objects.
 */
    ...
    implements IReader, TermbaseExceptionMessages
{
    ...
    private GTXmlReaderThread m_thread = null;
    ...
    public GTXmlReader (ImportOptions p_options, Termbase p_termbase)
    {
    ...
    private void startThread()
    {
        if (m_thread == null)
        {
            ...
            m_thread = new GTXmlReaderThread(m_results, m_options, m_termbase);
            m_thread.start();
        }
    }
