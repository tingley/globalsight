 ...
 */
public class TermXmlReaderThread
    extends Thread
{
    private static final Logger CATEGORY =
        Logger.getLogger(
            TermXmlReaderThread.class);
    ...
    // Constructor
    //
    public TermXmlReaderThread (ReaderResultQueue p_queue,
    ...
    public void run()
    {
        ...
        try
        {
            ...
            {
                CATEGORY.debug("TermXmlReaderThread: start reading TB " +
                    m_termbase.getName());
            }
            ...
            // Retrieve term level XML
            stmt = conn.createStatement();
            rset = stmt.executeQuery(
                "select CID, TID, XML from TB_TERM " +
        ...
        finally
        {
            ...
            if (CATEGORY.isDebugEnabled())
            {
                CATEGORY.debug("TermXmlReaderThread: done.");
            }
        }
    }
}
