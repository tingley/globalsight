...
/**
 * This class can be used to create HashtableValueOrderWalker
 * objects. This class is not JDK 1.1 safe, and uses Java2
 * collections.
 */
public class HashtableValueOrderWalkerFactory
{
    ...
    /**
     * Creates a HashtableValueOrderWalker that can be
     * used to walk through the keys in a Hashtable based
     * on the sorted order of the values
     * 
     * @param p_hashtable
     * @return 
     */
    public static HashtableValueOrderWalker createHashtableValueOrderWalker(Hashtable p_hashtable)
    {
	Hashtable copyWithValueKeyPairs = makeHashtableCopy(p_hashtable);
	ArrayList pairs = new ArrayList(copyWithValueKeyPairs.values());
	Collections.sort(pairs); //sort based on value order
	...
	return new HashtableValueOrderWalker(p_hashtable, sortedValues, sortedKeys);
    }
    ...
    /**
    * Private class to be used to hold a key,value combination.
    * The natural sorting order is based on the natural order of
    * the values.
    */
