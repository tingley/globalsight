...
// hacked code
public class DbConnectorDb2 extends DbConnectorAbstract
{
	static final String DEFAULT_DRIVER = "COM.ibm.db2.jdbc.app.DB2Driver";
/**
 ...
 */
public DbConnectorDb2(String p_url, String p_username, String p_password) throws FailedToLoadDriverException
{
 ...
 * @exception FailedToLoadDriverException Failed to load JDBC driver.
 */
public DbConnectorDb2(String p_driver, String p_url, String p_username, String p_password) throws FailedToLoadDriverException
{
	super(p_url, p_username, p_password);
