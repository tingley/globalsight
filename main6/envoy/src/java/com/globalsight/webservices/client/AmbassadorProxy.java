...
public class AmbassadorProxy implements com.globalsight.webservices.client.Ambassador {
  ...
  public AmbassadorProxy(String endpoint, String userName, String password) {
      _endpoint = endpoint;
      _initAmbassadorProxy( userName,  password);
  }
  ...
  private void _initAmbassadorProxy(String userName, String password)
  {
      try {
          ambassador = (new com.globalsight.webservices.client.AmbassadorServiceLocator()).getAmbassadorWebService(new java.net.URL(_endpoint), userName, password);
          if (ambassador != null) {
              if (_endpoint != null)
                  ((javax.xml.rpc.Stub)ambassador)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
              else
  ...
  public void uploadSourceFile(java.lang.String p_accessToken, java.lang.String p_path, byte[] bytes) throws java.rmi.RemoteException, com.globalsight.webservices.client.WebServiceException{
    if (ambassador == null)
      _initAmbassadorProxy();
    ambassador.uploadSourceFile(p_accessToken, p_path, bytes);
  }
