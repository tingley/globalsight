...
public class WebService2ClientHelper
{
    /**
     ...
     * @throws Exception
     */
    public static Ambassador2 getClientAmbassador2(String p_hostName,
            String port, String userName, String password, boolean enableHttps)
            throws Exception
    {
        ...
        if (enableHttps)
        {
            wsdlUrl = "https://" + p_hostName + ":" + port
                    + "/globalsight/services/AmbassadorWebService2?wsdl";
            setTrustStore();
            // acceptAllCerts();
        }
        else
        ...
        Ambassador2ServiceLocator loc = new Ambassador2ServiceLocator();
        URL url = new URL(wsdlUrl);
        return loc.getAmbassadorWebService2(url, userName, password);
    }
     ...
     * @throws Exception
     */
    public static Ambassador2 getClientAmbassador2(String p_endpoint,
