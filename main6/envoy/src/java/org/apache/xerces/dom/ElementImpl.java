...
public class ElementImpl extends ParentNode implements Element
{
     ...
     * be copied unless the "deep" flag is true, but Attributes are <i>always</i>
     * replicated.
     * 
     ...
     * attributes
     */
    public void setOwnerDocument(CoreDocumentImpl doc)
    {
     ...
     * is considered "markup" and will _not_ be merged either with normal Text
     * or with other CDATASections.
     */
        ...
        for (kid = firstChild; kid != null; kid = next)
        {
            ...
            if (kid.getNodeType() == Node.TEXT_NODE)
            {
                ...
                else
                {
                    ...
                    if (kid.getNodeValue().length() == 0) removeChild(kid);
                }
            }
    ...
    protected NamedNodeMapImpl getDefaultAttributes()
    {
        ...
        // Does not get the default attributes list from internal dtd
        // definition.
        // Though default attributes do exist in dtd definition, it will
        // return null, which is to fix the canonicalization of XML tags
        return null;

    } // getDefaultAttributes()

    public Object getUserData(String userData)
    {
        return null;
    }
    ...
    public void setIdAttributeNS(String namespaceURI, String qualifiedName,
            boolean isId)
    {
    }
