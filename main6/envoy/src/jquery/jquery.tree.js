...
(function($) {
    ...
    $.fn.treeview = function(settings) {
        var dfop =
            {
                ...
                data: null,  
                clicktoggle: true,  
                theme: "bbit-tree-arrows" //three theme：bbit-tree-lines ,bbit-tree-no-lines,bbit-tree-arrows
            };
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            // =========== end modify ========
            ht.push("<span class='standardText' id='percent"+nd.id+"'></span><span unselectable='on'>", nd.text, "</span>");
            ht.push("</a>");
            ht.push("</div>");
            //Child
            if (nd.hasChildren) {
