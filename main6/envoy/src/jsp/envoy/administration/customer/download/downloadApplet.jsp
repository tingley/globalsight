...
<TD WIDTH="100%" HEIGHT="400" ALIGN="LEFT">
            ...
            <APPLET type="application/x-java-applet;jpi-version=1.8.0_45"
              height=100% width=80% pluginspage="<%=httpProtocolToUse%>://www.java.com/en/download" code="com.globalsight.everest.webapp.applet.admin.customer.download.DownloadApplet.class">
            <%}%>
