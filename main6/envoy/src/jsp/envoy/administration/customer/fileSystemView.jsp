...
<TD WIDTH="100%" HEIGHT="470" ALIGN="LEFT">
            ...
            <APPLET type="application/x-java-applet;jpi-version=1.8.0_45"
              height=95% width=90% pluginspage="<%=httpProtocolToUse%>://www.java.com/en/download" code="com.globalsight.everest.webapp.applet.admin.customer.FileSystemApplet.class">
            <%}%>
