...
<head>
    ...
    <title><%=bundle.getString("lb_cvs_job") %></title>
	<style>
		body {font-size:12px}
...
CVSModule module = (CVSModule)sessionMgr.getAttribute("cvsmodule");
...
session.setAttribute("cvsModule", module);
%>
<script language="JavaScript">
...
<form name="form1" method="post" >
  ...
  <input type="hidden" name="baseInfo" value="">
	...
	<table width="80%" align="left" valign="center">
	  ...
	  <tr>
	  	<td align="left" class="standardText"><%=bundle.getString("lb_cvs_server") %>:</td>
	  	<td align="left" class="standardText"><%=server.getName() %></td>
	  </tr>
	  <tr>
	  	<td align="left" class="standardText"><%=bundle.getString("lb_cvs_repository") %>:</td>
	  	<td align="left" class="standardText"><%=server.getRepository() %></td>
	  </tr>
	  <tr>
	  	<td align="left" class="standardText"><%=bundle.getString("lb_cvs_module") %>:</td>
	  	<td align="left" class="standardText"><%=module.getName() %></td>
	  </tr>
		<tr>
			<td valign="top" colspan=2>
				<div align="left">
					...
					<script>
							...
							tree2.setXMLAutoLoading("/globalsight/envoy/administration/cvsjob/getFileList.jsp");	
							tree2.loadXML("/globalsight/envoy/administration/cvsjob/getFileList.jsp?id=");
					</script>
				</div>
			</td>
		</tr>
			...
			<td colspan="2">
			  <div align="center">
			    ...
			    <input type="button" name="previous" value="<%=bundle.getString("lb_previous") %>" onclick="submitForm('previous')">&nbsp;&nbsp;
   			    <input type="button" name="done" value="<%=bundle.getString("lb_next") %>" onclick="submitForm('done')">
			  </div>
			</td>
		</tr>
	</table>
