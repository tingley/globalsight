<%@ page contentType="text/html; charset=UTF-8"
		...
		import="java.util.*,com.globalsight.everest.webapp.javabean.NavigationBean,
		 ...
		 java.util.Locale,
		 java.util.ResourceBundle, java.util.Vector,
...
<%
   ...
   String chosenConn = (String)sessionMgr.getAttribute("acquisitionConn");
   String chosenAcqSQL = (String)sessionMgr.getAttribute("acquisitionSQL");
   ...
   String lbReadConnection = bundle.getString("lb_acquisition_db_connection");
   String lbReadSql = bundle.getString("lb_acquisition_sql");
...
<TR>
<TD WIDTH=500>
<%=bundle.getString("helper_text_db_read")%>
</TD>
</TR>
</TABLE>
<P>
...
<%=lbReadConnection%><SPAN CLASS="asterisk">*</SPAN>:
</SPAN>
<BR>
...
<P>
<SPAN CLASS="standardTextBold">
<%=lbReadSql%><SPAN CLASS="asterisk">*</SPAN>:
</SPAN>
<BR>
