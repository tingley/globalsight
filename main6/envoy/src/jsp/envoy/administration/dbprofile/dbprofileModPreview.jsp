...
<%
   ...
   int chosenURL = (int)ModDBProfile.getPreviewUrlId();
   int chosenConn = (int)ModDBProfile.getPreviewConnectionProfileId();
   String chosenInsertSQL = (String)ModDBProfile.getPreviewInsertSql();
   String chosenUpdateSQL = (String)ModDBProfile.getPreviewUpdateSql();
   ...
   String title = bundle.getString("lb_preview");
...
<TR>
<TD WIDTH=500>
<%=bundle.getString("helper_text_db_edit_preview")%>
</TD>
</TR>
</TABLE>
<P>
...
%>
				...
				<tr>
					<td valign="top"><SPAN CLASS="standardText"><%= bundle.getString("lb_preview_db_connections") + bundle.getString("lb_colon") %></SPAN></td>
