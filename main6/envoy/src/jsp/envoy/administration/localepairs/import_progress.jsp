...
$(document).ready(function(){
	...
	$("#backBtn").click(function(){
		document.location.href="/globalsight/ControlServlet?linkName=localePairsimport&pageName=LPR&action=import";
	});
...
function startUpload() {
	$.post("/globalsight/ControlServlet?pageName=LOCALEPAIRSIMPORT&linkName=startUpload&action=doImport");
}
...
function refreshBar() {
	...
	$.get("/globalsight/ControlServlet?pageName=LOCALEPAIRSIMPORT&linkName=startUpload&action=refreshProgress", 
		{"no":Math.random()},
		function(data){
			var tmp = data.split("&");
