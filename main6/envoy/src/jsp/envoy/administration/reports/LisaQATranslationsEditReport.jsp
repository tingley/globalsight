<%@ page contentType="application/vnd.ms-excel"
         ...
         session="true"
%><%
response.setHeader("Content-Disposition","attachment; filename=TranslationsEdit.xls" );
response.setHeader("Expires", "0");
response.setHeader("Cache-Control","must-revalidate, post-check=0,pre-check=0");
response.setHeader("Pragma","public");
ReviewerLisaQAXlsReportHelper reviewerLisaQAXlsReportHelper = 
		new ReviewerLisaQAXlsReportHelper(request, response, ReviewerLisaQAXlsReportHelper.TRANSLATIONS_EDIT_REPORT);
