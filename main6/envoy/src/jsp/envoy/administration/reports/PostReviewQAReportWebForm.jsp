...
function fnGetSelectedJobIds()
{
    ...
    {
		reportJobInfo = getAjaxReportJobInfo("${self.pageURL}&activityName=xlsReportPostReviewQA", "getReportJobInfo");
    }
...
function filterJob()
{
    ...
    if (reportJobInfo == null)
    {
        ...
        var url ="${self.pageURL}&activityName=xlsReportPostReviewQA&action=getReportJobInfo";
