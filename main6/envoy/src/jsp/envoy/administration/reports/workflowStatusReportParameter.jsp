...
<html>
    ...
    <body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <font face="Verdana, Arial, Helvetica, sans-serif"><%=bundle.getString("workflow_status")%></font></td>
        </tr>
        <tr bgcolor="ccffff"> 
        ...
        <td height="452" valign="top" align="left" width="70%" bgcolor="#E9E9E9"><font face="Verdana, Arial, Helvetica, sans-serif" size="3">
            <form name=request action="/globalsight/TranswareReports?reportPageName=WorkflowStatus&act=create" method=POST>
               <center>
                  <table border=0 cellspacing=10>
                  <tr><td align=right><wfsTag:create type="label" param="wfstatuslabel"/></td>
                  <td>
                  <wfsTag:create type="select" param="wfstatus"/>
                  </td>
                  <tr><td align=right><wfsTag:create type="label" param="projectmgrlabel"/></td></td>
                  <td>
                  <wfsTag:create type="select" param="projectmgr"/>
                  </td>
                  <tr><td align=right><wfsTag:create type="label" param="currencylabel"/></td>
                  <td>
                  <wfsTag:create type="select" param="currency"/>
                  </td></tr>
                  <tr><td colspan=2>
                  <center>
