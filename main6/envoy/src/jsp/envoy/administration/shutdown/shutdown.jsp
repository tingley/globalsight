...
<TR><TD><%=bundle.getString("lb_shutdownMsg")%></TD><TD><TEXTAREA  COLS="60" NAME="<%=ShutdownMainHandler.PARAM_MSG%>" MAXLENGTH="150"><%=ShutdownMainHandler.getShutdownMessage(false)%></TEXTAREA></TD></TR>
</TABLE></TD></TR>
