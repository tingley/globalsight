            ...
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td class="tableHeadingListOff">
                        ...
                        <a class="sortHREFWhite" href="<%=importingUrl%>"> <%=bundle.getString("lb_job_creation_status")%></a>
                    ...
                    <td class="tableHeadingListOn">
                        ...
                        <a class="sortHREFWhite" href="<%=selfUrl%>"> <%=bundle.getString("lb_job_export_status")%></a>
            ...
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td id="jobWorkflowsTab" class="tableHeadingListOff">
                        <img src="/globalsight/images/tab_left_gray.gif" border="0" />
                        <a class="sortHREFWhite" href="<%=exportingUrl%>"> <%=bundle.getString("lb_job_create_export")%></a>
                        <img src="/globalsight/images/tab_right_gray.gif" border="0" />
                    </td>
                </tr>
            </table>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td valign="top" id="contentTd">
                            <amb:table bean="requestDefine" id="requestVo" key="requestDefineKey" dataClass="com.globalsight.everest.webapp.pagehandler.administration.systemActivities.jobExportState.RequestFile" pageUrl="self" emptyTableMsg="msg_waiting_request_none">
