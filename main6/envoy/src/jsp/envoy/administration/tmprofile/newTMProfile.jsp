                                ...
                                <TABLE CELLPADDING="2" CELLSPACING="2" BORDER="0" CLASS="standardText">
                                 ...
                                 <%
                                   if(projectTms!=null)
                                   {
                                    ...
                                    <TR ALIGN="LEFT">
                                        <TD><INPUT TYPE="checkbox" NAME="<%=isSaveToProjectTm%>" VALUE="true"><%=lbisSaveToProjectTm%></TD>
                                    </TR>
                                    <TR ALIGN="LEFT">
                                        <TD><INPUT TYPE="checkbox" NAME="<%=isSaveToPageTm%>" VALUE="true" CHECKED><%=lbisSaveToPageTm%></TD>
                                    </TR>
                                </TABLE>
                                <BR>
                                <BR>
