...
%>
<!-- This JSP is envoy/administratin/users/viewProjects.jsp-->
...
%>
    <table cellpadding=0 cellspacing=0 border=0 class="standardText">
      <tr valign="top">
        <td align="right">
          <amb:tableNav bean="projects" key="<%=UserConstants.PROJECT_KEY%>"
                     pageUrl="self" />
        </td>
      </tr>
      <tr>
        <td>
          <amb:table bean="projects" id="project" key="<%=UserConstants.PROJECT_KEY%>"
