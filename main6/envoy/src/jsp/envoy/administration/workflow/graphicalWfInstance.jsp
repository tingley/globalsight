...
<TD WIDTH="100%" HEIGHT="600" ALIGN="LEFT">                  
            ...
            <APPLET type="application/x-java-applet;jpi-version=1.6" 
            		...
            		pluginspage="http://java.sun.com/products/plugin/index.html#download" code="com.globalsight.everest.webapp.applet.admin.graphicalworkflow.gui.planview.GVApplet.class">
            <%}%>
