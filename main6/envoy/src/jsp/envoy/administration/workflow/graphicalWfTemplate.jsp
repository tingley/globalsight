...
<TD WIDTH="100%" HEIGHT="600" ALIGN="CENTER">                
            ...
            <APPLET type="application/x-java-applet;jpi-version=1.8.0_45" id="GPUI"
              height=80% width=80% pluginspage="<%=httpProtocolToUse%>://www.java.com/en/download" code="com.globalsight.everest.webapp.applet.admin.graphicalworkflow.gui.planview.GVApplet.class">
            <%}%>
