...
<TITLE><%=bundle.getString("lb_activity_error")%></TITLE>
...
<P CLASS="mainHeading"><%=bundle.getString("lb_activity_error")%></P>
<P CLASS="standardText" style="color:red"><PRE><%=msg%></PRE></P>
<P CLASS="standardText"><A CLASS="standardHREF" HREF="/globalsight/wl"><%=bundle.getString("msg_return_to_sys4")%></A></P>
</DIV>
</BODY>
</HTML>
