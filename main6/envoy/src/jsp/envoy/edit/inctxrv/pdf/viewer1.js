    ...
    handleEvent: function PDFFindController_handleEvent(e) {
      ...
      this.firstPagePromise.then(function() {
        ...
        if (e.type === 'find') {
          ...
          this.findTimeout = setTimeout(this.nextMatch.bind(this), 0);
        } else {
          this.nextMatch();
        }
      }.bind(this));
...
var o = evt.target;
	...
	{
        var divLeft = o.getBoundingClientRect().left;
        var divWidth = o.getBoundingClientRect().width;
		...
		{
			highlightObjects(o, divLeft, divWidth, clickX);
		}
	}
...
parent.parent.target.content.navigateToDiv(pagennn, pageLeft, pageTop, curScale);
}
