...
<%
    ...
    // labels
    String reportType = "";
    String downloadInstruction = bundle.getString("helper_text_download_qa_report_instruction");
    ...
    String title = bundle.getString("lb_download_qa_report");
...
<%
    ...
    String regenerateReportConfirm = bundle.getString("lb_run_qa_checks_generate_report_confirm");
%>
<HTML>
<HEAD>
<TITLE><%=title%></TITLE>
...
var helpFile = "<%=bundle.getString("help_download_qa_report")%>";
...
function download()
{
    ...
    dojo.xhrPost(
    {
       url:"/globalsight/ControlServlet?activityName=QAReports&taskId=<%=task.getId()%>&action=<%=ReportConstants.ACTION_QA_REPORT_GENERATE%>",
       handleAs: "text", 
       load:function(data)
       {
            finished = true;
...
function recentQAReports()
{
    var url = "/globalsight/ControlServlet?activityName=QAReports&taskId=<%=task.getId()%>";
    ...
    controlWindow = window.open(url, "", specs);
    controlWindow.focus();
}
...
<FORM name="ReportForm" METHOD="POST" TARGET="idReport"
 ACTION="/globalsight/ControlServlet?activityName=QAReports&taskId=<%=task.getId()%>&action=<%=ReportConstants.ACTION_QA_REPORT_GET%>">
</FORM>
        ...
        <TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0">
            <TR>
                <TD CLASS="tableHeadingListOn"><IMG SRC="/globalsight/images/tab_left_blue.gif" BORDER="0">
                    <A ONCLICK='submitForm()' CLASS="sortHREFWhite" HREF="<%=downloadQAReportUrl%>"><%=bundle.getString("lb_download_qa_report")%></A><IMG SRC="/globalsight/images/tab_right_blue.gif" BORDER="0"></TD>
                <TD WIDTH="2"></TD>
                ...
                <%if (showDITAQAChecksTab) {%>
                <TD WIDTH="2"></TD>
                <TD CLASS="tableHeadingListOff"><IMG SRC="/globalsight/images/tab_left_gray.gif" BORDER="0">
                    <A CLASS="sortHREFWhite" HREF="<%=downloadDitaReportUrl%>"><%=bundle.getString("lb_download_dita_qa_report")%></A><IMG SRC="/globalsight/images/tab_right_gray.gif" BORDER="0"></TD>
                <TD WIDTH="2"></TD>
                <TD CLASS="tableHeadingListOff"><IMG SRC="/globalsight/images/tab_left_gray.gif" BORDER="0">
...
<TR><TD COLSPAN="2" WIDTH="500" CLASS="standardText"><%=downloadInstruction%></TD></TR>
<TR><TD COLSPAN="2">&nbsp;</TD></TR>
...
<TR>
    <TD COLSPAN="2" WIDTH="500">
        ...
        <INPUT id="recentReportsButton" TYPE="BUTTON" CLASS="standardText" NAME="recentQAReports" VALUE="<%=bundle.getString("lb_recent_qa_reports")%>" ONCLICK="recentQAReports();">
        <INPUT id="downloadButton" TYPE="BUTTON" CLASS="standardText" NAME="runQAChecks" VALUE="<%=bundle.getString("lb_run_qa_checks_generate_report")%>" ONCLICK="download();">
    </TD>
</TR>
</TABLE>
</DIV>
