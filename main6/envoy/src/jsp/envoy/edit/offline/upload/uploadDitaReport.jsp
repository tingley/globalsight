...
<jsp:useBean id="recreateGS" scope="request" class="com.globalsight.everest.webapp.javabean.NavigationBean" />
...
<%
    ...
    String uploadInstruction = bundle.getString("helper_text_upload_dita_report_instruction");
    ...
    String cancelUrl = cancel.getPageURL() +
            "&" + WebAppConstants.TASK_ACTION + "=" + WebAppConstants.TASK_ACTION_RETRIEVE +
            "&" + WebAppConstants.TASK_STATE + "=" + state +
            "&" + WebAppConstants.TASK_ID + "=" + task_id;

    // labels
    String title = bundle.getString("lb_upload_dita_qa_report");
    ...
    String saveUrl = detail.getPageURL() +
                        "&" + WebAppConstants.TASK_ACTION + "=" + WebAppConstants.TASK_ACTION_SAVEDETAILS +
                        "&" + WebAppConstants.TASK_STATE + "=" + state +
                        "&" + WebAppConstants.TASK_ID + "=" + task_id;
    ...
    String ditaUploadMsg = (String) sessionMgr.getAttribute("ditaUploadMsg");
    sessionMgr.removeElement("ditaUploadMsg");
...
var helpFile = "<%=bundle.getString("help_upload_dita")%>";
var taskId = <%=task_id%>;
...
function submitForm()
{
    ...
    {
       theForm.action = "/globalsight/ControlServlet?activityName=ditaReports&action=upload&taskId="+ taskId;
       theForm.submit();
    }
    else
    {
        ...
        <TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0">
            <TR>
                ...
                <TD CLASS="tableHeadingListOn"><IMG SRC="/globalsight/images/tab_left_blue.gif" BORDER="0">
                    <A ONCLICK='submitForm()' CLASS="sortHREFWhite"><%=bundle.getString("lb_upload_dita_qa_report")%></A><IMG SRC="/globalsight/images/tab_right_blue.gif" BORDER="0"></TD>
            </TR>
        </TABLE>
        <!-- End Tabs table -->
    </TD>
...
<%   if (ditaUploadMsg != null && !"null".toLowerCase().equals(ditaUploadMsg)) { %>
<TR><TD COLSPAN="2" CLASS="standardText" style="color:red"><%=ditaUploadMsg %></TD></TR>
<%   } %>
<TR>
    <TD COLSPAN="2">
        <!-- Lower table -->
        <TABLE CELLPADDING="2" CELLSPACING="0" BORDER="0" CLASS="standardText">
            <TR>
                ...
                <P/>
                    <TABLE CELLPADDING="2" CELLSPACING="0" BORDER="0" CLASS="standardText">
                        <TR><TD COLSPAN="2"><%=uploadInstruction%></TD></TR>
                        <TR><TD COLSPAN="2">
                    ...
                    <INPUT TYPE="BUTTON" CLASS="standardText" NAME="<%=lbCancel%>" VALUE="<%=lbCancel%>" ONCLICK="location.replace('<%=cancelUrl%>')">
                    <INPUT TYPE="BUTTON" CLASS="standardText" NAME="<%=lbStartUpload%>" VALUE="<%=lbStartUpload%>" onclick="submitForm();">
                </TD>
            </TR>
        </TABLE>
        <!-- End lower table-->
