...
<%
    ...
    String startUploadQAReportUrl = startupload.getPageURL();

    String uploadInstruction = bundle.getString("helper_text_upload_qa_report_instruction");
    ...
    // labels
    String title = bundle.getString("lb_upload_qa_report");
        ...
        <TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0">
            <TR>
                ...
                <TD CLASS="tableHeadingListOn"><IMG SRC="/globalsight/images/tab_left_blue.gif" BORDER="0">
                    <A ONCLICK='submitForm()' CLASS="sortHREFWhite"><%=bundle.getString("lb_upload_qa_report")%></A><IMG SRC="/globalsight/images/tab_right_blue.gif" BORDER="0"></TD>
...
<%   if (qaReportUploadMsg != null && !"".equals(qaReportUploadMsg)) { %>
<TR><TD COLSPAN="2" CLASS="standardText" style="color:red"><%=qaReportUploadMsg %></TD></TR>
<%   } %>
<TR>
    <TD COLSPAN="2">
        <!-- Lower table -->
