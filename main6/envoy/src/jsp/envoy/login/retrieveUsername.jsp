...
if(null==mess || mess.length()==0)
{
	...
	mess 	  = bundle.getString("lb_login_retrieveUsername");
}
%>
                
<HTML>
<!-- This JSP is envoy\login\retrieveUsername.jsp -->
<HEAD>
    ...
    function getLangCookie() 
    {
       if (document.cookie.length > 0)
       {
        ...
        if (languageSelected == null)
            languageSelected = "-1";
        setLangCookie(languageSelected);
        return languageSelected;
    }
      
    function setLangCookie(langSent) {
        setCookie("localelang", langSent, 365);
    }
  ...
  function init()
  {
    ...
    //loginForm.isJustChangeUILocale.value = "false";
  }
       ...
       <TR>
        ...
        <TR>
            <TD ALIGN="center">
                ...
                <%=res_email %>:
                <input type="text" name="emailField" size="18" tabIndex="1" style="width:200px" value="" />
                </SPAN>
            </TD>
            <TD></TD>
        </TR>
        ...
        <P>
        <SPAN CLASS="standardText">
        <INPUT type="button" VALUE="Submit" tabIndex="2" NAME="btnSubmit" onClick="fnSubmit('submit')"/>
        &nbsp;&nbsp;&nbsp;
        <INPUT type="button" VALUE="Cancel" tabIndex="3" NAME="btnCancel" onClick="fnSubmit('cancel')"/>
        </SPAN>
        </TD>
        </TR>
        </TABLE>
