...
<TD WIDTH="100%" HEIGHT="410">                 
                ...
                height="95%" width="90%" pluginspage="<%=httpProtocolToUse%>://www.java.com/en/download" code="com.globalsight.everest.webapp.applet.admin.graphicalworkflow.gui.planview.GVApplet.class">
                <%}%>
