...
<%
    ...
    // Labels, etc
    String title= bundle.getString("lb_activities") + " - " + bundle.getString("lb_search");
...
<%@ include file="/envoy/wizards/guides.jspIncl" %>
    ...
    <span class="mainHeading">
     ...
     <% if (request.getAttribute("noresults") != null)
             out.println("<div style='color:red'>" + bundle.getString("msg_activity_search_no_match") + "</div>"); %>
    <p>
