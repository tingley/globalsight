...
// Selection and highlighting requires a stylesheet containing
// .highlighted { border: dashed 1px gray !important; }
// .selected    { border: solid 1px black !important; }

function SelectableElements(oElement, bMultiple, bHighlight) {
    if (oElement == null)
        return;
