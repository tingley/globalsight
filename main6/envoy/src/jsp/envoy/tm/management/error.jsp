...
function doOnLoad()
{
  ...
  if (res == null)
  {
    document.getElementById("idMessage").innerText = arg.message + ": " + errorstring;
  }
  else
  {
	document.getElementById("idMessage").innerText = arg.message + ": "+errorstring.substring(0, res.index);
    str_stacktrace = errorstring.substring(res.lastIndex);
    document.getElementById("idStackTrace").innerText = str_stacktrace;
    enableStackTrace();
  }
