...
public class Constants {
    ...
    public static String APP_VERSION_DOUBLE = "8.0";

    public static String APP_VERSION = "Version: " + APP_VERSION_DOUBLE;
    ...
    public static String APP_RELEASE_DATE = "01/31/2011";
    ...
    static {
        ...
        // log.info(url);
        try {
            PROGRAM_ROOT = java.net.URLDecoder.decode(url.getPath(), System
        ...
        if (PROGRAM_ROOT.indexOf(PACKAGE_ROOT) != -1) {
            PROGRAM_ROOT = PROGRAM_ROOT.substring(0, PROGRAM_ROOT
                    .indexOf(PACKAGE_ROOT));
        }
    ...
    public static String CONFIGURE_XML = RESOURCE_DIRECTORY
            + "configure/configure.xml";

    public static String CONFIGURE_XML_FORMER = RESOURCE_DIRECTORY
            + "configure/configure.former.xml";

    public static String CONFIGURE_XML_PROXY = RESOURCE_DIRECTORY
            + "configure/proxy.properties";

    public static String DI_PROPERTIES_FILE = RESOURCE_DIRECTORY
            + "configure/di.properties";
    
    public static String CVS_CONFIGURE_FILE = RESOURCE_DIRECTORY
    ...
    public static String LOG_FILE = PROGRAM_ROOT + "log.txt";
    static {
    ...
    public static String MSG_ERROR_CONNECTION_SERVER_VERSION_HIGH = "The server does not support this latest version. Please log on to another server or exit.";

    public static String MSG_ERROR_CONNECTION_SERVER_VERSION_LOW = "This version is out of date. Please update your desktop icon.";
    ...
    public static String ERROR_JOB_NAME = "Invalid job name, only alphabetic, number(0-9), plus(+), hyphen(-)," +
    		" underscore(_), periods(.) and spaces can be used";
