...
/**
 * AlignmentPage represents a file to be aligned with the other
 * corresponding file. The class stores Skeleton and BaseTmTuv object
 * of the file.
 */
...
public class AlignmentPage
{
    ...
    private static SkeletonComparator c_skeletonComparator
        = new SkeletonComparator();

    private static SegmentComparator c_segmentComparator
    ...
    public List getAllSkeletons()
    {
        ...
        Collections.sort(skeletons, c_skeletonComparator);
        return skeletons;
    }
    ...
    public List getAllSegments()
    {
        ...
        Collections.sort(segments, c_segmentComparator);
        return segments;
    }
    ...
    private static class SkeletonComparator
