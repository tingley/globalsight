 ...
 */
public class GapReader implements GapConstants
{
    ...
    public void read(Reader p_reader) throws Exception
    {
    ...
    private class GapHandler extends DefaultHandler
    {
        ...
        private void processGap(Attributes p_attributes) throws Exception
        {
            ...
            GlobalSightLocale sourceLocale = localeMgr.getLocaleByString(sourceLocaleName);
            GlobalSightLocale targetLocale = localeMgr.getLocaleByString(targetLocaleName);

            m_alignmentProject.setSourceLocale(sourceLocale);
            m_alignmentProject.setTargetLocale(targetLocale);
        }

        private void processFiles(Attributes p_attributes) throws Exception
        {
            String originalSourceFile = p_attributes.getValue(ATT_ORIGINAL_SOURCE_FILE);
            String originalTargetFile = p_attributes.getValue(ATT_ORIGINAL_TARGET_FILE);
            ...
            AlignmentUnit alignmentUnit = new AlignmentUnit(originalSourceFile, originalTargetFile,
