 ...
 */
public class GapWriter implements GapConstants
{
    ...
    public void write(AlignmentProject p_alignmentProject) throws Exception
    {
        writeHeader(p_alignmentProject.getSourceLocale(), p_alignmentProject.getTargetLocale());
    ...
    private void writeHeader(GlobalSightLocale p_sourceLocale, GlobalSightLocale p_targetLocale)
            throws IOException
    {
        StringBuffer sb = new StringBuffer();

        // DOCTYPE for DTD validation
        sb.append("<!DOCTYPE ").append(ELEM_GAP).append(" SYSTEM \"gap.dtd\">\n");

        // gap root element
        sb.append("<").append(ELEM_GAP).append(" ");
        sb.append(ATT_VERSION).append("=\"1.0\" ");
        sb.append(ATT_SOURCE_LOCALE).append("=\"").append(p_sourceLocale.toString()).append("\" ");
        sb.append(ATT_TARGET_LOCALE).append("=\"").append(p_targetLocale.toString()).append("\"");
        sb.append(">");
    ...
    private void writeFiles(AlignmentUnit p_alignmentUnit) throws IOException
    {
        StringBuffer sb = new StringBuffer();
