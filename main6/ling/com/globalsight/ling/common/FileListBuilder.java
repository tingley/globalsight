...
public class FileListBuilder implements FileFilter {
    ...
    private java.util.Vector m_vTheList = new Vector();;
    ...
    public void add(String p_Dir, String p_Ext) 
    {
        ...
        {
            //... in the current dir
            File[] list = f.listFiles(new FileListBuilder(st.nextToken().trim()));
    ...
    public void addRecursive(String p_Dir, String p_Ext)
    {
        ...
        {
            // ... in current dir
            list = f.listFiles(new FileListBuilder(st.nextToken().trim()) );
            for(int j=0; j < list.length; j++ )
                m_vTheList.add(list[j]);
        }
    ...
    public static void main(java.lang.String[] args) {
     ...
     ff.add("c:\\development\\testfiles\\javaprop",".properties");
     ff.add("c:\\development\\testfiles\\html",".html");
    ...
    /**
     * Decrements the file index by one.
     */
    public void undoGetNextFile() 
    {
