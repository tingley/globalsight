...
public class DiplomatReaderException
    extends GeneralException
{
    public DiplomatReaderException(int p_componentId, int p_exceptionId)
    {
        super(p_componentId, p_exceptionId);
    }

    public DiplomatReaderException(
        int p_componentId,
        int p_exceptionId,
        int p_messageId)
    {
    ...
    {
        // Insert code to print the receiver here.  This
        // implementation forwards the message to super. You may
        // replace or supplement this.
        return super.toString();
    }

    public DiplomatReaderException(int p_exceptionId,
      Exception p_originalException)
    {
