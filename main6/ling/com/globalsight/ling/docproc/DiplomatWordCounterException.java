...
public class DiplomatWordCounterException
    extends GeneralException
{

    public DiplomatWordCounterException(int p_exceptionId)
    {
        super(GeneralExceptionConstants.COMP_EXTRACTOR, p_exceptionId);
    }

    public DiplomatWordCounterException(int p_componentId, int p_exceptionId)
    {
    ...
    public DiplomatWordCounterException(int p_exceptionId,
      Exception p_originalException)
    {
        super(GeneralExceptionConstants.COMP_WORDCOUNTER,
          p_exceptionId, p_originalException);
    }

    public DiplomatWordCounterException(int p_exceptionId, String p_message)
    {
        super(GeneralExceptionConstants.COMP_WORDCOUNTER,
