...
import com.globalsight.ling.docproc.extractor.cpp.Extractor;

import com.globalsight.ling.common.EncodingChecker;
import com.globalsight.ling.common.CppEscapeSequence;
 ...
 * CPP parser.</P>
 *
 * <p>The Cpp ExtractionHandler honors GSA comments (see the
    ...
    implements IParseEvents
{
            ...
            if (m_whiteToTranslatable && !m_extractor.exclude())
            {
                ...
                try
                {
                    m_output.setTranslatableAttrs(
                      ExtractorRegistry.FORMAT_CPP, "string");
                }
        ...
        try
        {
            switch (commentType)
            {
                case SINGLE_LINE_COMMENT:
                    m_extractor.readMetaMarkup(s);
                    break;
                case MULTI_LINE_COMMENT:
                    m_extractor.readMetaMarkup(s.substring(0, s.length() - 2));
                    break;
                default: // do nothing
                    break;
            }
    ...
    public void handleString(String s)
    {
        ...
        // Decode C++ character escapes (\n etc), but don't decode
        // embedded protected \' and \" chars!!
        s = CppEscapeSequence.decodeString(s);
    ...
    private void outputEmbeddedString(String s)
    {
        ...
        m_extractor.addToEmbeddedString(" datatype=\"" +
          ExtractorRegistry.FORMAT_CPP + "\" type=\"string\">");
