...
public class Html2TmxMap
{
        ...
        boolean p_bStart)
    {
        ...
        TmxTagGenerator tmxTag = getPairedTmxTag(p_tag.tag, p_bStart, false, hasAttributes);
        ...
        boolean p_bStart, boolean p_bIsolated)
    {
        ...
        return getBuildedPairedTmxTag(p_tag.tag, p_bStart, p_bIsolated,
            hasAttributes);
    }
    ...
    {
        TmxTagGenerator tmxTag = getPairedTmxTag(p_tagName,
                p_bStart, p_bIsolated, p_hasAttributes);
        tmxTag.makeTags();
    ...
    public static String getType(String p_nType)
    {
        ...
        case TmxTagGenerator.X_EM:
            ...
            break;    
        default: strType = String.valueOf(p_nType);
            break;
        }
