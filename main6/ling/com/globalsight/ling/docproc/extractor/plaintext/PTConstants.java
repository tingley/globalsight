...
/**
 * This interface defines constants used by the PlainText Extractor.
 */
public interface PTConstants
{
    /** Encoded TMX formatting cannot be erased. */
    static int ALL_TMX_NON_ERASABLE     =   0;
    /** Encoded TMX formatting can be erased. */
    static int ALL_TMX_ERASABLE         =   1;
    /** Only leading TMX formatting can be erased. */
    static int LEADING_TMX_NON_ERASABLE =   3;
}
