...
/**
 * Helper class to map troff tags to TMX tags.
 */
public class Tag2TmxMap
{
     ...
     */
    public TmxTagGenerator getPairedTmxTag(Token p_tag,
        boolean p_bStart, boolean p_bIsolated)
    {
        // TODO
        return getPairedTmxTag(p_tag.toString(), p_bStart, p_bIsolated);
    }
