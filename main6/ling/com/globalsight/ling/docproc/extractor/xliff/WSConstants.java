...
public interface WSConstants
{
    ...
    static public final String IWS_SEGMENT_DATA = "iws:segment-metadata";
    static public final String IWS_STATUS = "iws:status";
    static public final String IWS_SID = "sid";
    static public final String IWS_TRANSLATION_STATUS = "translation_status";
    static public final String IWS_LOCK_STATUS = "lock_status";
}
