...
/**
 * <p>
 * Utility class used by the XML Extractor. Basically it manages index numbers
 * for &lt;bpt&gt;'s <code>i</code> attribute.
 * </p>
 *
 * <p>
 * Index numbers must be incremented monotonically and not reset to 1, or the
 * XML Extractor/Segmenter will produce wrong isolated tags when
 * segment-breaking tags occur inside a tag.
 * </p>
 */
