...
import com.globalsight.ling.docproc.extractor.xptag.Tag2TmxMap;
import com.globalsight.ling.docproc.extractor.xptag.XPTagObjects;
import com.globalsight.ling.docproc.extractor.xptag.XPTagProperties;
    ...
    implements IHandler, ExtractorExceptionConstants
{
    ...
    private XPTagProperties m_rules = null;
    ...
    public String checkError()
    {
        ...
        {
            return "An error has occured during XPTAG extraction.";
        }
    ...
    public void handleVersion(XPTagObjects.Version t)
    {
        if (m_bHasError)
        {
            return;
    ...
    public void handleEncoding(XPTagObjects.Encoding t)
    {
        if (m_bHasError)
        {
            return;
    ...
    public void handleStyleDefinition(XPTagObjects.StyleDefinition t)
    {
        if (m_bHasError)
        {
            return;
    ...
    public void handleStyleSelection(XPTagObjects.StyleSelection t)
    {
        if (m_bHasError)
        {
            return;
    ...
    public void handleParagraphTag(XPTagObjects.ParaTag t)
    {
        if (m_bHasError)
        {
            return;
    ...
    public void handleCharacterTag(XPTagObjects.CharTag t)
    {
        if (m_bHasError)
        {
            return;
        ...
        //String tag = t.tag.substring(1, t.tag.length() - 2);
    ...
    public void handleText(XPTagObjects.Text t)
    {
        ...
        // Keep in sync with
        // /diplomatVOB/../com/globalsight/cxe/adapter/copyflow/DesktopAppHelper
        // callConverterForNative().
        if (t.toString().startsWith("#quark_text_box_"))
        {
            try
            {
                flushText();
