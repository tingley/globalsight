...
public class AttVal extends Object implements Cloneable
{
     ...
     * @param value attribute value
     */
    public AttVal(AttVal next, Attribute dict, Node asp, Node php, int delim,
        String attribute, String value)
    {
        this.next = next;
        this.dict = dict;
    ...
    /**
     * Check the attribute value for uppercase letters (only if the
     * value should be lowercase, required for literal values in
     * xhtml).
     * @param lexer Lexer
    ...
    public Attribute checkAttribute(Lexer lexer, Node node)
    {
        ...
        if (attr != null)
        {
            ...
            else if (attr != AttributeTable.attrTitle ||
            ...
            else if (TidyUtils.toBoolean(
                this.dict.getVersions() & Dict.VERS_PROPRIETARY))
            {
                lexer.report.attrError(lexer, node, this,
            ...
            !(node.tag == null) &&
            this.asp == null &&
            !(node.tag != null && (TidyUtils.toBoolean(
                node.tag.versions & Dict.VERS_PROPRIETARY))))
        {
