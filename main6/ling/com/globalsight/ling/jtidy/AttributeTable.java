...
public class AttributeTable
{
     ...
     * add attribute.
     */
    protected static Attribute attrAdd;

    /**
     * added attribute.
     */
    protected static Attribute attrAdded;

    /**
     * delete attribute.
     */
    protected static Attribute attrDelete;

    /**
     * deleted attribute.
     */
    protected static Attribute attrDeleted;
    ...
    private static final Attribute[] ATTRS = {
        ...
        new Attribute("add", Dict.VERS_ALL, AttrCheckImpl.TEXT), // GS add
        new Attribute("added", Dict.VERS_ALL, AttrCheckImpl.TEXT), // GS added
        ...
        new Attribute("delete", Dict.VERS_ALL, AttrCheckImpl.BOOL), // GS delete
        new Attribute("deleted", Dict.VERS_ALL, AttrCheckImpl.TEXT), // GS deleted
        ...
        new Attribute("name", Dict.VERS_ALL, AttrCheckImpl.NAME), // also for GS name
    ...
    {
        // Henry Zrepa reports that some folk are using embed with
        // script attributes where newlines are signficant.
        // These need to be declared and handled specially!
    ...
    public static AttributeTable getDefaultAttributeTable()
    {
        if (defaultAttributeTable == null)
        {
            ...
            // CvdL: for GS tags
            attrAdd = defaultAttributeTable.lookup("add");
            attrAdded = defaultAttributeTable.lookup("added");
            attrDelete = defaultAttributeTable.lookup("delete");
            attrDeleted = defaultAttributeTable.lookup("deleted");
