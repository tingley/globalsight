...
import com.globalsight.ling.jtidy.TidyMessage.Level;


/**
 * Error/informational message reporter. You should only need to edit
 * the file TidyMessages.properties to localize HTML tidy.
...
public final class Report
{
    ...
    public static final String RELEASE_DATE_STRING =
        new SimpleDateFormat("dd MMM yyyy").format(RELEASE_DATE);
    ...
    /**
     * attribute: gs id syntax &lt;GS added=... id=...&gt;.
     */
    public static final short GS_ID_SYNTAX = 83;
    ...
    static
    {
        try
        {
            res = ResourceBundle.getBundle(
                "com/globalsight/ling/jtidy/TidyMessages");
        }
    ...
    /**
     * Generates a complete message for the warning/error. The message
     * is composed by:
     * <ul>
     ...
     * @throws MissingResourceException if <code>message</code> key is
     * not available in jtidy resource bundle.
     * @see TidyMessage
     */
    protected String getMessage(int errorCode, Lexer lexer, String message,
        ...
        throws MissingResourceException
    {
        ...
        if (listener != null)
        {
            TidyMessage msg = new TidyMessage(errorCode,
     ...
     * @see TidyMessage
     */
    private void printMessage(int errorCode, Lexer lexer, String message,
        Object[] params, Level level)
    {
        String resource;
        try
    ...
    /**
     * Prints a message to errout after calling getMessage().  Used
     * when lexer is not yet defined.
     ...
     * @see TidyMessage
     */
    private void printMessage(PrintWriter errout, String message,
        Object[] params, Level level)
    {
        String resource;
        try
    ...
    {
        printMessage(p, "version_summary",
            new Object[]{RELEASE_DATE}, Level.SUMMARY);
    }

    /**
     * Returns a formatted tag name handling start and end tags,
     * nulls, doctypes, and text.
     * @param tag Node
    ...
    /**
     * Prints an "unknown option" error message. Lexer is not defined
     * when this is called.
    ...
    public void unknownOption(String option)
    {
        try
        {
            System.err.println(MessageFormat.format(
                res.getString("unknown_option"), new Object[]{option}));
        }
        catch (MissingResourceException e)
        {
    ...
    /**
     * Prints a "bad argument" error message. Lexer is not defined
     * when this is called.
    ...
    public void badArgument(String key, String value)
    {
        ...
        {
            System.err.println(MessageFormat.format(
                res.getString("bad_argument"), new Object[]{value, key}));
        }
        catch (MissingResourceException e)
        {
            System.err.println(e.toString());
    ...
    public void encodingError(Lexer lexer, int code, int c)
    {
        ...
        if (lexer.configuration.showWarnings)
        {
            ...
            else if ((code & ~DISCARDED_CHAR) == INVALID_UTF8)
            {
                ...
                printMessage(code, lexer, "invalid_utf8",
                    new Object[]{new Integer(code & DISCARDED_CHAR), buf},
                    Level.WARNING);
            }
            ...
            else if ((code & ~DISCARDED_CHAR) == INVALID_UTF16)
            {
                ...
                printMessage(code, lexer, "invalid_utf16",
                    new Object[]{new Integer(code & DISCARDED_CHAR), buf},
                    Level.WARNING);
            ...
            else if ((code & ~DISCARDED_CHAR) == INVALID_NCR)
            {
                ...
                printMessage(code, lexer, "invalid_ncr",
                    new Object[]{new Integer(code & DISCARDED_CHAR), buf},
                    Level.WARNING);
            }
        }
        ...
        if (lexer.configuration.showWarnings)
        {
            switch (code)
            {
                case MISSING_SEMICOLON :
                    printMessage(code, lexer, "missing_semicolon",
                        new Object[]{entity}, Level.WARNING);
                    break;
                case MISSING_SEMICOLON_NCR :
                    printMessage(code, lexer, "missing_semicolon_ncr",
                        new Object[]{entity}, Level.WARNING);
                    break;
                case UNKNOWN_ENTITY :
                    printMessage(code, lexer, "unknown_entity",
                        new Object[]{entity}, Level.WARNING);
                    break;
                case UNESCAPED_AMPERSAND :
                    printMessage(code, lexer, "unescaped_ampersand",
                        null, Level.WARNING);
                    break;
                case APOS_UNDEFINED :
                    printMessage(code, lexer, "apos_undefined",
                        null, Level.WARNING);
                    break;
                default :
    ...
    public void attrError(Lexer lexer, Node node, AttVal attribute, short code)
    {
        ...
        {
            printMessage(code, lexer, "unexpected_gt",
                new Object[]{getTagName(node)}, Level.ERROR);
            return;
        }
        ...
        switch (code)
        {
            case UNKNOWN_ATTRIBUTE :
                printMessage(code, lexer, "unknown_attribute",
                    new Object[]{attribute.attribute}, Level.WARNING);
                break;

            case INVALID_ATTRIBUTE :
                // CvdL: incorrect GS tag attributes are errors
                ...
                printMessage(code, lexer, "invalid_attribute",
                    new Object[]{attribute.attribute}, Level.WARNING);
                break;

            case MISSING_ATTRIBUTE :
                printMessage(code, lexer, "missing_attribute",
                    new Object[]{getTagName(node), attribute.attribute},
                    Level.WARNING);
                break;

            case MISSING_ATTR_VALUE :
                printMessage(code, lexer, "missing_attr_value",
                    new Object[]{getTagName(node), attribute.attribute},
                    Level.WARNING);
                break;

            case MISSING_IMAGEMAP :
                printMessage(code, lexer, "missing_imagemap",
                    new Object[]{getTagName(node)}, Level.WARNING);
                lexer.badAccess |= MISSING_IMAGE_MAP;
                break;

            case BAD_ATTRIBUTE_VALUE :
                printMessage(code, lexer, "bad_attribute_value",
                    new Object[]{
                    getTagName(node),
                    attribute.attribute,
            ...
            case XML_ID_SYNTAX :
                printMessage(code, lexer, "xml_id_sintax",
                    new Object[]{getTagName(node), attribute.attribute},
                    Level.WARNING);
                break;

            case GS_ID_SYNTAX :
                printMessage(code, lexer, "gs_numeric_id",
                    new Object[]{getTagName(node), attribute.attribute},
                    Level.ERROR);
                break;

            case XML_ATTRIBUTE_VALUE :
                printMessage(code, lexer, "xml_attribute_value",
                    new Object[]{getTagName(node), attribute.attribute},
                    Level.WARNING);
                break;

            case UNEXPECTED_QUOTEMARK :
                printMessage(code, lexer, "unexpected_quotemark",
                    new Object[]{getTagName(node)}, Level.WARNING);
                break;

            case MISSING_QUOTEMARK :
                printMessage(code, lexer, "missing_quotemark",
                    new Object[]{getTagName(node)}, Level.WARNING);
                break;

            case REPEATED_ATTRIBUTE :
                printMessage(code, lexer, "repeated_attribute",
                    new Object[]{
                    getTagName(node),
                    attribute.value,
            ...
            case PROPRIETARY_ATTR_VALUE :
                printMessage(code, lexer, "proprietary_attr_value",
                    new Object[]{getTagName(node), attribute.value},
                    Level.WARNING);
                break;

            case PROPRIETARY_ATTRIBUTE :
                printMessage(code, lexer, "proprietary_attribute",
                    new Object[]{getTagName(node), attribute.attribute},
                    Level.WARNING);
                break;
            ...
            case UNEXPECTED_END_OF_FILE :
                ...
                printMessage(code, lexer, "unexpected_end_of_file",
                    new Object[]{getTagName(node)}, Level.WARNING);
                break;

            case ID_NAME_MISMATCH :
                printMessage(code, lexer, "id_name_mismatch",
                    new Object[]{getTagName(node)}, Level.WARNING);
                break;

            case BACKSLASH_IN_URI :
                printMessage(code, lexer, "backslash_in_uri",
                    new Object[]{getTagName(node)}, Level.WARNING);
                break;

            case FIXED_BACKSLASH :
                printMessage(code, lexer, "fixed_backslash",
                    new Object[]{getTagName(node)}, Level.WARNING);
                break;
            ...
            case ESCAPED_ILLEGAL_URI :
                printMessage(code, lexer, "escaped_illegal_uri",
                    new Object[]{getTagName(node)}, Level.WARNING);
                break;

            case NEWLINE_IN_URI :
                printMessage(code, lexer, "newline_in_uri",
                    new Object[]{getTagName(node)}, Level.WARNING);
                break;

            case ANCHOR_NOT_UNIQUE :
                printMessage(code, lexer, "anchor_not_unique",
                    new Object[]{getTagName(node), attribute.value},
                    Level.WARNING);
                break;
            ...
            case JOINING_ATTRIBUTE :
                printMessage(code, lexer, "joining_attribute",
                    new Object[]{getTagName(node), attribute.attribute},
                    Level.WARNING);
                break;

            case UNEXPECTED_EQUALSIGN :
                printMessage(code, lexer, "expected_equalsign",
                    new Object[]{getTagName(node)}, Level.WARNING);
                break;

            case ATTR_VALUE_NOT_LCASE :
                printMessage(code, lexer, "attr_value_not_lcase",
                    new Object[]{
                    getTagName(node),
                    attribute.value,
                    attribute.attribute}, Level.WARNING);
    ...
    public void warning(Lexer lexer, Node element, Node node, short code)
    {
        ...
        if (lexer.configuration.showWarnings)
        {
            switch (code)
            {
                case MISSING_ENDTAG_FOR :
                    printMessage(code, lexer, "missing_endtag_for",
                ...
                case DISCARDING_UNEXPECTED :
                    if (lexer.badForm == 0)
                    {
                        // the case for when this is an error not a
                        // warning, is handled later
                        printMessage(
                            code,
                            lexer,
                ...
                case NESTED_EMPHASIS :
                    printMessage(code, lexer, "nested_emphasis",
                        new Object[]{getTagName(node)}, Level.INFO);
                    break;

                case COERCE_TO_ENDTAG :
                    printMessage(code, lexer, "coerce_to_endtag",
                        new Object[]{element.element}, Level.INFO);
                    break;
                ...
                case MISSING_STARTTAG :
                    printMessage(code, lexer, "missing_starttag",
                ...
                case UNEXPECTED_ENDTAG :
                    ...
                    {
                        printMessage(code, lexer, "unexpected_endtag",
                            new Object[]{node.element}, Level.WARNING);
                    }
                    break;
                ...
                case TOO_MANY_ELEMENTS :
                    ...
                    {
                        printMessage(code, lexer, "too_many_elements",
                            new Object[]{node.element}, Level.WARNING);
                    }
                    break;

                case USING_BR_INPLACE_OF :
                    printMessage(code, lexer, "using_br_inplace_of",
                        new Object[]{getTagName(node)}, Level.WARNING);
                    break;

                case INSERTING_TAG :
                    printMessage(code, lexer, "inserting_tag",
                        new Object[]{node.element}, Level.WARNING);
                    break;

                case CANT_BE_NESTED :
                    printMessage(code, lexer, "cant_be_nested",
                        new Object[]{getTagName(node)}, Level.WARNING);
                    break;

                case PROPRIETARY_ELEMENT :
                    printMessage(code, lexer, "proprietary_element",
                        new Object[]{getTagName(node)}, Level.WARNING);
                ...
                case OBSOLETE_ELEMENT :
                    ...
                    {
                        printMessage(code, lexer, "obsolete_element",
                            new Object[]{
                            getTagName(element),
                    ...
                    {
                        printMessage(code, lexer, "replacing_element",
                            new Object[]{
                            getTagName(element),
                            getTagName(node)}, Level.WARNING);
                    }
                ...
                case UNESCAPED_ELEMENT :
                    printMessage(code, lexer, "unescaped_element",
                        new Object[]{getTagName(element)}, Level.WARNING);
                    break;

                case TRIM_EMPTY_ELEMENT :
                    printMessage(code, lexer, "trim_empty_element",
                        new Object[]{getTagName(element)}, Level.WARNING);
                    break;

                case MISSING_TITLE_ELEMENT :
                    printMessage(code, lexer, "missing_title_element",
                        null, Level.WARNING);
                    break;

                case ILLEGAL_NESTING :
                    printMessage(code, lexer, "illegal_nesting",
                        new Object[]{getTagName(element)}, Level.WARNING);
                    break;

                case NOFRAMES_CONTENT :
                    printMessage(code, lexer, "noframes_content",
                        new Object[]{getTagName(node)}, Level.WARNING);
                    break;
                ...
                case BAD_CDATA_CONTENT :
                    printMessage(code, lexer, "bad_cdata_content",
                        null, Level.WARNING);
                    break;

                case INCONSISTENT_NAMESPACE :
                    printMessage(code, lexer, "inconsistent_namespace",
                        null, Level.WARNING);
                    break;
                ...
                case NESTED_QUOTATION :
                    printMessage(code, lexer, "nested_quotation",
                        null, Level.WARNING);
                    break;

                case ELEMENT_NOT_EMPTY :
                    printMessage(code, lexer, "element_not_empty",
                        new Object[]{getTagName(element)}, Level.WARNING);
                    break;

                case MISSING_DOCTYPE :
                    printMessage(code, lexer, "missing_doctype",
                        null, Level.WARNING);
                    break;
        ...
        if ((code == DISCARDING_UNEXPECTED) && lexer.badForm != 0)
        {
            // the case for when this is a warning not an error, is
            // handled earlier
            printMessage(code, lexer, "discarding_unexpected",
                new Object[]{getTagName(node)}, Level.ERROR);
        }
    ...
    public void error(Lexer lexer, Node element, Node node, short code)
    {
        ...
        {
            printMessage(code, lexer, "unknown_element",
                new Object[]{getTagName(node)}, Level.ERROR);
        }
        else if (code == UNEXPECTED_ENDTAG)
        {
            ...
            {
                printMessage(code, lexer, "unexpected_endtag",
                    new Object[]{node.element}, Level.ERROR);
            }
        }
    }
    ...
    public void errorSummary(Lexer lexer)
    {
        ...
        if (lexer.badChars != 0)
        {
            if ((lexer.badChars & VENDOR_SPECIFIC_CHARS) != 0)
            {
                ...
                printMessage(VENDOR_SPECIFIC_CHARS, lexer,
                    "vendor_specific_chars_summary",
                    new Object[]{new Integer( encodingChoiche)}, Level.SUMMARY);
            }

            if ((lexer.badChars & INVALID_SGML_CHARS) != 0 ||
                (lexer.badChars & INVALID_NCR) != 0)
            {
                int encodingChoiche = 0;
                ...
                printMessage(INVALID_SGML_CHARS, lexer,
            ...
            {
                printMessage(INVALID_UTF8, lexer, "invalid_utf8_summary",
                    null, Level.SUMMARY);
            }

            if ((lexer.badChars & INVALID_UTF16) != 0)
            {
                printMessage(INVALID_UTF16, lexer, "invalid_utf16_summary",
                    null, Level.SUMMARY);
            }

            if ((lexer.badChars & INVALID_URI) != 0)
            {
                printMessage(INVALID_URI, lexer, "invaliduri_summary",
                    null, Level.SUMMARY);
            }
        }
        ...
        if (lexer.badForm != 0)
        {
            printMessage(BADFORM_SUMMARY, lexer, "badform_summary",
                null, Level.SUMMARY);
        }
        ...
        if (lexer.badAccess != 0)
        {
            ...
            {
                printMessage(MISSING_SUMMARY, lexer, "badaccess_missing_summary",
                    null, Level.SUMMARY);
            }

            if ((lexer.badAccess & MISSING_IMAGE_ALT) != 0)
            {
                printMessage(MISSING_IMAGE_ALT, lexer, "badaccess_missing_image_alt",
                    null, Level.SUMMARY);
            }

            if ((lexer.badAccess & MISSING_IMAGE_MAP) != 0)
            {
                printMessage(MISSING_IMAGE_MAP, lexer, "badaccess_missing_image_map",
                    null, Level.SUMMARY);
            }

            if ((lexer.badAccess & MISSING_LINK_ALT) != 0)
            {
                printMessage(MISSING_LINK_ALT, lexer, "badaccess_missing_link_alt",
                    null, Level.SUMMARY);
            }
            ...
            if (((lexer.badAccess & USING_FRAMES) != 0) &&
                ((lexer.badAccess & USING_NOFRAMES) == 0))
            {
                printMessage(USING_FRAMES, lexer, "badaccess_frames",
                    null, Level.SUMMARY);
            }

            /*CvdL - this is unwanted advertising.
            printMessage(BADACCESS_SUMMARY, lexer, "badaccess_summary",
        ...
        if (lexer.badLayout != 0)
        {
            ...
            {
                printMessage(USING_LAYER, lexer, "badlayout_using_layer",
                    null, Level.SUMMARY);
            }

            if ((lexer.badLayout & USING_SPACER) != 0)
            {
                printMessage(USING_SPACER, lexer, "badlayout_using_spacer",
                    null, Level.SUMMARY);
            }

            if ((lexer.badLayout & USING_FONT) != 0)
            {
                printMessage(USING_FONT, lexer, "badlayout_using_font",
                    null, Level.SUMMARY);
            }

            if ((lexer.badLayout & USING_NOBR) != 0)
            {
                printMessage(USING_NOBR, lexer, "badlayout_using_nobr",
                    null, Level.SUMMARY);
            }

            if ((lexer.badLayout & USING_BODY) != 0)
            {
                printMessage(USING_BODY, lexer, "badlayout_using_body",
                    null, Level.SUMMARY);
            }
        }
    }
    ...
    {
        printMessage(errout, "unrecognized_option",
            new Object[]{new String(new char[]{c})}, Level.ERROR);
    }
    ...
    {
        printMessage(errout, "unknown_file",
            new Object[]{"Tidy", file}, Level.ERROR);
    }
    ...
    {
        printMessage(errout, "slides_found",
            new Object[]{new Integer(count)}, Level.SUMMARY);
    }
    ...
    {
        printMessage(errout, "hello_message",
            new Object[]{Report.RELEASE_DATE, this.currentFile}, Level.SUMMARY);
    }
     ...
     */
    public void reportVersion(PrintWriter errout, Lexer lexer,
        String filename, Node doctype)
    {
        int i, c;
        int state = 0;
        ...
        if (doctype != null)
        {
            ...
            printMessage(DOCTYPE_GIVEN_SUMMARY, lexer, "doctype_given",
                new Object[]{filename, doctypeBuffer}, Level.SUMMARY);
        }

        printMessage(REPORT_VERSION_SUMMARY, lexer, "report_version",
            new Object[]{ filename,
    ...
    public void reportNumWarnings(PrintWriter errout, Lexer lexer)
    {
        ...
        {
            printMessage(errout, "num_warnings",
    ...
    {
        printMessage(out, "help_text",
            new Object[]{"Tidy", RELEASE_DATE}, Level.SUMMARY);
    }
