 ...
 *
 *         A filter that stems Dutch words. It supports a table of
 *         words that should not be stemmed at all. The stemmer used
 *         can be changed at runtime after the filter object is
    ...
    extends GSTokenFilter
{
    ...
    /**
     * @param stemdictionary Dictionary of word stem pairs, that
     * overrule the algorithm
     */
