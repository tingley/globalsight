 ...
 * @version $Id: RussianStemmer.java,v 1.1 2009/04/14 15:09:35 yorkjin Exp $
 */
class RussianStemmer
{
    ...
    /**
     * Finds ending among given ending class and returns the length of
     * ending found(0, if not found).
     */
    private int findEnding(StringBuffer stemmingZone, int startIndex,
        char[][] theEndingClass)
    {
        boolean match = false;
    ...
    /**
     * Finds the ending among the given class of endings and removes
     * it from stemming zone.
     */
    ...
    /**
     * Finds the ending among the given class of endings, then checks
     * if this ending was preceded by any of given predessors, and if
     * so, removes it from stemming zone.
     */
    private boolean findAndRemoveEnding(StringBuffer stemmingZone,
