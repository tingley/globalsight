...
/**
 * <p>Class for boolean data objects that have 3 states: not
    ...
    extends TriState
{
    ...
    public BooleanTriState(boolean p_default)
    {
        m_value = p_default;
    }
    ...
    {
        if (p_other instanceof BooleanTriState)
        {
            BooleanTriState o1 = this;
            BooleanTriState o2 = (BooleanTriState)p_other;
