...
import com.globalsight.ling.sgml.catalog.InvalidCatalogEntryTypeException;
import com.globalsight.ling.sgml.catalog.InvalidCatalogEntryException;
...
public class CatalogEntry
{
    ...
    /**
     * Since spec2 is volatile, the pathname gets modified by Catalog,
     * store the original pathname here.
     */
    private String spec2orig = "";
    ...
    {
        if (entryType == DOCTYPE  || entryType == ENTITY ||
            entryType == LINKTYPE || entryType == NOTATION)
        {
            return spec1;
        }
        else
    ...
    {
        if (entryType == DTDDECL || entryType == PUBLIC)
        {
            return spec1;
        }
        else
    ...
    /**
     * Returns the original SYSTEM id path name, before pathname
     * rewriting, local to the CATALOG_ROOT directory.
     */
     ...
     * (e.g. {@link com.globalsight.ling.sgml.catalog.Catalog}),
    ...
    public String toString()
    {
        switch (entryType)
        {
        case BASE:     return "BASE " + spec1;
        case CATALOG:  return "CATALOG " + spec1;
        case DOCUMENT: return "DOCUMENT " + spec1;
        case OVERRIDE: return "OVERRIDE " + spec1 +
          " -- YES: prefer public identifiers to system identifiers --";
        case SGMLDECL: return "SGMLDECL " + spec1;

        case DELEGATE: return "DELEGATE \"" + spec1 + "\" \"" + spec2orig + "\"";
        case DOCTYPE:  return "DOCTYPE \"" + spec1 + "\" \"" + spec2orig + "\"";
        case DTDDECL:  return "DTDDECL \"" + spec1 + "\" \"" + spec2orig + "\"";
        case ENTITY:   return "ENTITY \"" + spec1 + "\" \"" + spec2orig + "\"";
        case LINKTYPE: return "LINKTYPE \"" + spec1 + "\" \"" + spec2orig + "\"";
        case NOTATION: return "NOTATION \"" + spec1 + "\" \"" + spec2orig + "\"";
        case PUBLIC:   return "PUBLIC \"" + spec1 + "\" \"" + spec2orig + "\"";
        case SYSTEM:   return "SYSTEM \"" + spec1 + "\" \"" + spec2orig + "\"";
        }

        return " -- unknown type " + entryType +
            " spec1=`" + spec1 + "' spec2=`" + spec2orig + "' -- ";
    }
}
