...
class Scanner
{
    ...
    public static final TokenType AMPERSAND = new TokenType(21, "AMPERSAND");
    public static final TokenType PLUS_LPAREN = new TokenType(22, "PLUS LPAREN");
    public static final TokenType MINUS_LPAREN = new TokenType(23, "MINUS LPAREN");
        ...
        throws IOException
    {
        ...
        if (trace)
        {
            ...
            // CvdL: use this for debugging to see the charcode.
        ...
        throws IOException
    {
        ...
        if (ch < 0)
        {
            throw new DTDParseException(getUriId(),
                MessageFormat.format(Messages.getString("Scanner.5"),
                    new Object[] { String.valueOf(stopChar) }),
        ...
        throws IOException
    {
        ...
        while ((ch = read()) >= 0)
        {
            ...
            {
                throw new DTDParseException(getUriId(),
                    MessageFormat.format(Messages.getString("Scanner.6"),
                        new Object[] { String.valueOf(stopChar) }),
                    getLineNumber(), getColumn());
            }
        ...
        for (;;)
        {
            ...
            if ((ch == '-') && (peekChar() == '-'))
            {
                ...
                for (;;)
                {
                    ...
                    {
                        throw new DTDParseException(getUriId(),
                            MessageFormat.format(Messages.getString("Scanner.1"),
                                    new Object[] { "--"+buff.toString() }),
                            getLineNumber(), getColumn());
                    }
                    else if (tempCh == '-')
                    {
            ...
            if (ch == '<')
            {
                ...
                if (ch == '!')
                {
                    ...
                    else
                    {
                        ...
                        {
                            throw new DTDParseException(getUriId(),
                                MessageFormat.format(Messages.getString("Scanner.2"),
                                        new Object[] { "<!-"+(char)read() }),
                                getLineNumber(), getColumn());
                        }
                        read();
            ...
            else if (ch == ']')
            {
                ...
                {
                    throw new DTDParseException(getUriId(),
                            MessageFormat.format(Messages.getString("Scanner.3"),
                                    new Object[] { ""+(char)ch }),
                            getLineNumber(), getColumn());
                }
                if (read() != '>')
            ...
            else if ((ch == '&') || (ch == '%'))
            {
                ...
                else if ((ch == '&') && Character.isWhitespace((char)peekChar()))
                {
                ...
                if (peekChar() == ';') read(); // Skip ; if there is one
            ...
            else if (ch < 0)
            {
                if (atEOF)
                {
                    throw new IOException(Messages.getString("Scanner.4"));
                }
                atEOF = true;
