...
/**
 * This comparator is used to order exact candidate matches by date.
 *
 * Sort order:
 * 1) match type (in numeric order)
 * 2) target locale
 * 3) timestamp of target tuv
 */
public class CandidateMatchTypeTimeComparator
    implements Comparator
{
    private Locale m_targetLocale;

    public CandidateMatchTypeTimeComparator(Locale p_targetLocale)
    {
        super();
