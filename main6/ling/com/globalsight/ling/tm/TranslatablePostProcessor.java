...
class TranslatablePostProcessor
    extends BasePostProcessor
{
     ...
     */
    public TranslatablePostProcessor(LgemHitsResult p_hitResult,
        Map p_originalTuvs, long p_sourcePageId,
        LeveragingLocales p_leveragingLocales)
    {
        super(LeverageMatchType.FUZZY_MATCH,
