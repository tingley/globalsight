...
/**
 * PageJobDataQueryResult is a wrapper of a ResultSet object that is
 * returned by PageJobDataRetriever#query() method.
 */

public class PageJobDataQueryResult
    extends SegmentQueryResult
{
     ...
     * constructor
     *
     * @param p_resultSet ResultSet object
     */
    ...
    private String getTuvState()
        throws Exception
    {
        return m_resultSet.getString(10);
    }
    
    private String getTuvMergeState()
        throws Exception
    {
        return m_resultSet.getString(11);
    }
    
    private Timestamp getTuvModifyTime()
        throws Exception
    {
    ...
    private String getSourceTmName()
    	throws Exception
    {
    	return m_resultSet.getString(14);
    }
    
    private String getTuvMofifyUser()
    	throws Exception
    {
    	return m_resultSet.getString(15);
    }
    
    private Timestamp getTuvCreationTime()
    	throws Exception
    {
    	return m_resultSet.getTimestamp(16);
    }
    
    private String getTuvCreationUser()
    	throws Exception
    {
    	return m_resultSet.getString(17);
    }
    
    private String getTuvUpdatedProject()
    	throws Exception
    {
