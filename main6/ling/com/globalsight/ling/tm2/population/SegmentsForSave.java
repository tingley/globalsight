...
public class SegmentsForSave
{
    ...
    /**
     * Add a Tu that creates a new entry in the database. All Tuvs
     * this Tu owns are added to the database as well.
     *
     * @param p_tu Tu to be added to the database
     */
     ...
     *
     * @param p_tu Tu to be changed its source tm name in database
     */
     ...
     *
     * @param p_tuId Existing Tu id in the database. Which Tm table
     * this id belongs is known 'a priori'. This class hold only
     * either of Page TM data or Segment TM data, not both.
     * @param p_tuv Tuv to be added to the database
     */
     ...
     *
     * @param p_tuId Existing Tuv's Tu's id
     * @param p_tuvId Existing Tuv's id in the database. Which Tm table
     * this id belongs is known 'a priori'. This class hold only
     * either of Page TM data or Segment TM data, not both.
     * @param p_tuv Tuv that has newer modifyDate
     */
    ...
    /**
     * Add all target Tuvs in a given Tu that are added to an existing
     * Tu in the database. This method should be used for Page Tm
     * addition. If there is an identical source segment in a Page Tm,
     * all target segments are added to the Tu. Previously existed
     * target segments are deleted before adding the new ones.
     *
     * @param p_tuId Existing Tu id in the database. Which Tm table
     * this id belongs is known 'a priori'. This class hold only
     * either of Page TM data or Segment TM data, not both.
     * @param p_tu Tu whose target Tuvs are added to the database
     */
    ...
    /**
     * Add a Tu that is removed from the database. All Tuvs
     * this Tu owns are also removed.
     *
     * @param p_tu Tu to be removed from the database
     */
    ...
    /**
     * Add a tuv of which an identical segment is already in the
     * Tm. This method should be used only for the Segment Tm for
     * building corpus Tm.
     *
     * @param p_tuId Existing Tuv's Tu's id
     * @param p_tuvId Existing Tuv's id in the Tm.
     * @param p_tuv Tuv from translation_unit_variant table.
     */
    ...
    public String toDebugString()
    {
        ...
        sb.append("  Source locale: ")
            .append(m_sourceLocale.toString()).append("\n");
