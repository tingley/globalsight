...
public class HibernateConfig
{
    ...
    {
        Configuration cfg = extendConfiguration(new Configuration()).addProperties(properties);
        return cfg.buildSessionFactory();
    }

    public static Configuration extendConfiguration(Configuration config)
    {
        return config.addResource(
                "com/globalsight/ling/tm3/core/persistence/xml/MultilingualSharedTm.hbm.xml")
