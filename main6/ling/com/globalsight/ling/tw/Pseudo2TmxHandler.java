...
public class Pseudo2TmxHandler
    implements PseudoBaseHandler
{
    ...
    /**
     * Constructor
     * @param p_PData, the current PseudoData object.
     */
    ...
    /**
     * Returns a TMX string which is the result of this PTag to TMX
     * conversion.
     */
     ...
     * @param tagName  - the pseudo tag content
     * @param originalString - the full tag including delimiters
     */
     ...
     * @param strText, the next chunk of text from the text parser.
     */
    ...
    /**
     * <p>Returns the full TMX representation of an addable PTag.</p>
     *
     * <p>The TMX "i" attribute is automatically adjusted to be unique
     * within the segment.</p>
     *
     * @param p_PTag - the addable PTag you want to search for.
     * @return the TMX representation of the PTag if found, otherwise
     * null.
     */
    public String getAddableTMX(String p_PTag)
    {
            ...
            PseudoConstants.PSEUDO_END_TAG_MARKER)))
        {
            ...
            Stack s = (Stack)m_hType2BptIndexStack.get(
                p_PTag.substring(1).toLowerCase());
        ...
        {
            tmp.append("type=\"");
            tmp.append(POMI.m_hAttributes.get(
                PseudoConstants.ADDABLE_TMX_TYPE));
            tmp.append("\" ");

            tmp.append("erasable=\"");
            tmp.append(POMI.m_hAttributes.get(
                PseudoConstants.ADDABLE_ATTR_ERASABLE));
            tmp.append("\"");
