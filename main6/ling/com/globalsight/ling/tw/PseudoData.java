...
public class PseudoData
{
    ...
    */
    ...
    /**
     * Returns the current PTag mode.
     * PseudoConstants.PSEUDO_VERBOSE or  PseudoConstants.PSEUDO_COMPACT
     */
    public int getMode()
    {
        return m_nMode;
    ...
    /**
     * Determines whether addable-tags (in general) are allowed.<p>
     * Use getAddablesMode() to determine exactly what mode we are in.<p>
     * @return true if addables are allowed. Otherwise false.
     */
    public boolean isAddableAllowed()
    {
        return (m_nAddablesMode != PseudoConstants.ADDABLES_DISABLED) ?
            true : false;
    }
    ...
    public Hashtable getPseudo2NativeMap()
    {
        ...
        if (this.m_hPseudo2NativeMap != null)
        {
            ...
            String key;
            for (Enumeration e = this.m_hPseudo2NativeMap.keys();
                 e.hasMoreElements(); )
            {
    ...
    /**
     * Returns the mapping of Tmx tags to Pseudo tags for a given
     * diplomat string.
     * @return Hashtable
     */
    ...
    * @param p_strKey - the name of a TMX-type that appears in the map.
    ...
    */
    ...
    /**
     * Returns a TagNode which holds all the information about a given
     * source tag.
     * @param p_idx - the index of the item in the source list.
    ...
    /**
     * Returns the starting point from which to create new (unique)
     * "i" attributes for newly added tags.
     */
    ...
    /**
    * Records the results of the last diplomat 2 psuedo conversion.
    * This becomes the PTag source string for display.
    */
    ...
    */
     ...
     * @param p_nMode - 1=verbose, 2=compact
     */
    ...
    */
     ...
     * <p>
     * NOTE:<p>
     * All TMX types do not necessarily have a corresponding
     * override defined.
     * An entry in this table is made only if:<p>
     *   - You want a particular TMX type to appear unnumbered to the user.
     *     (Everything else is numbered by default)<p>
     *     Also NOTE: Anything unnumbered MUST also be addable.<p>
     *   - You want an alternate name for verbose or compact modes.<p>
     *     If the TMX type is not defined in the diplomat string,
     *     we default to numbered "x" or "g".<p>
     *     (See the makePseudoTagName method)<p>
     * These mappings apply to diplomat input without respect to
     * the parser.<p>
        ...
        throws PseudoOverrideItemException
    {
        ...
        // bold
        String strB =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.BOLD);
        ...
        //BOLD
        String cStrB =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_BOLD);
        ...
        // strong
        String strStrong =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.STRONG);
        ...
        // STRONG
        String cStrStrong =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_STRONG);
        ...
        // em
        String strEm =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.EM);
        ...
        // EM
        String cStrEm =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_EM);
        ...
        // i
        String strI =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.ITALIC);
        ...
        // I
        String cStrI =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_ITALIC);
        ...
        // u
        String strU =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.UNDERLINE);
        ...
        // U
        String cStrU =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_UNDERLINE);
        ...
        // Nbsp
        String strNbsp =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.NBSPACE);
        ...
        // br
        String strBr =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.X_BR);
        ...
        // BR
        String cStrBr =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_BR);
        ...
        // not addable.
        String strXB =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.X_BOLD);
        String strXSTRONG =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.X_STRONG);
        String strXI =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.X_ITALIC);
        String strXEM =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.X_EM);
        String strXU =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.X_UNDERLINE);
        String strL =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.LINK);
        String strFC =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.FONTCHANGE);
        String strLB =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.LINEBREAK);
        String strSP =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.SPACE);
        String strTab =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.TAB);
        String strFF =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.FORMFEED);
        
        String cStrXB =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_X_BOLD);
        String cStrXSTRONG =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_X_STRONG);
        String cStrXI =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_X_ITALIC);
        String cStrXEM =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_X_EM);
        String cStrXU =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_X_UNDERLINE);
        String cStrL =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_LINK);
        String cStrFC =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_FONTCHANGE);
        String cStrLB =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_LINEBREAK);
        String cStrTab =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_TAB);
        String cStrFF =
            TmxTagGenerator.getInlineTypeName(TmxTagGenerator.C_FORMFEED);
        ...
        p.put(strStrong, new PseudoOverrideMapItem(strStrong, true , "strong",  "strong",false, STRONG_Data));
        p.put(cStrStrong, new PseudoOverrideMapItem(cStrStrong, true , "STRONG","STRONG",false,C_STRONG_Data));
        p.put(strXSTRONG,new PseudoOverrideMapItem(strXSTRONG, true ,"strong",  "strong",true,  null));
        p.put(cStrXSTRONG,new PseudoOverrideMapItem(cStrXSTRONG, true ,"strong","strong",true,  null));
    ...
    private static Hashtable mapAddableTags(Hashtable p_hMainOverrideMap)
    {
        ...
        for (Enumeration e = p_hMainOverrideMap.keys() ; e.hasMoreElements() ;)
        {
            ...
            PseudoOverrideMapItem item =
                (PseudoOverrideMapItem)p_hMainOverrideMap.get(key);

            if (item.m_hAttributes != null)
            {
                // Map both forms of the ptag (verbose/compact) for look up
                if (item.m_strVerbose != null &&
                    item.m_strVerbose.length() > 0)
                {
                ...
                if (item.m_strCompact != null &&
                    item.m_strCompact.length() > 0)
                {
    ...
    /**
     * Checks if this tag name appears in the addable tag list (for **ANY** native format!!).
     * @return the OverrideMapkey if it appears in the list, otherwise null.
     * @param p_strTagName - the tag name to lookup (with out without brackets).
     */
    ...
    /**
     * Checks if this tag name appears in the addable tag list (for the specified native format).
     * @return the OverrideMapkey if it appears in the list, otherwise null.
     * @param p_strTagName - the tag name to lookup (with out without brackets).
     * @param p_formatName - the format name under which to look. Example: html
     */
    public String isAddableInFormat(String p_strTagName, String p_nativeFormatName)
    {
        ...
        // set the addable attribute we need to confirm (we could use any of the addable attributes)
        ...
        //overrideMapKey = (String)m_hAddableTagMap.get(p_strTagName.toLowerCase());
    ...
    /**
    * Adds an entry to the tag listings for the source string.<p>
    *
    * This source list is a complete list of all tags found in the
    * source (in the order in which they appear).<p>
    *
    * The table can be retrieved with the getSrcCompleteTagList().<p>
    *
    * @param p_PTagItem - the item to be added.
    ...
    */
    ...
    /**
     * Returns a TagNode which holds all the information about a given
     * source tag.  The item is searched for by the target PTag name
     * to which is was mapped.
     * @param p_TrgPTag - the name of the tag in the target string.
     ...
     * Returns a TagNode which holds all the information about a given
     * source tag.  The item is searched for by the target PTag name
     * to which is was mapped and a matching set of attributes.
     *
     * @param p_TrgPTag - the name of the tag in the target string.
     * @return a TagNode. Null if it is not found.
     */
    public TagNode findSrcItemByTrgName(String p_PTag, Hashtable p_hAttributes)
    {
        ...
        if (srcListItem != null)
        {
            ...
            while (thisTagKeys.hasMoreElements())
            {
                ...
                if (!thisTagAttrVal.equals(
                    srcListItem.getAttributes().get(thisTagAttrKey)))
                {
                    return null;
                }
            }
    ...
    /*
     * Set addables mode.<p>
     * @param p_nMode if mode equals 0, addables are disabled. If set
     * to 1, HTML addables are enabled.
    ...
    /*
     * Sets the locale (mainly for error messages)
     * And re-loads resources.
     * @param p_locale
     */
    public void setLocale(String p_locale)
    {
        ...
        {
            locale = new Locale(p_locale.substring(0, 2),
    ...
    /*
     * Sets the locale (mainly for error messages) and re-loads
     * resources.
     * @param p_locale
     */
    ...
    /**
     * Builds a new pseudo tag name based the Tmx type.
     * Numbering is determined automatically.
     * @param p_tmxTagName - The TMX tag name.
     * @param p_attributes - The TMX tag attributes.
     * @param p_strDefaultName - the default name to use.
        ...
        throws  DiplomatBasicParserException
    {
        ...
        return (makePseudoTagName(p_tmxTagName, p_attributes,
            p_strDefaultName, false));
    }

    /**
     * Builds a new pseudo tag name based the Tmx type.
     * Numbering can be forced ON or left on automatic.
     * @param p_tmxTagName - The TMX tag name.
     * @param p_attributes - The TMX tag attributes.
     * @param p_strDefaultName - the default name to use.
     * @param p_bMakeNumbered - true forces "mapped" types to be
     * numbered.<p> When false, numbering is done according to the
     * mapped override attributes..
     * @return the PTag name as a string.
     */
    public String makePseudoTagName(String p_tmxTagName,
        Hashtable p_attributes, String p_strDefaultName,
        boolean p_bMakeNumbered)
        throws  DiplomatBasicParserException
    {
        String tag = "";
        ...
        else // look for an override for this type
        {
            PseudoOverrideMapItem PNameItem =
                (PseudoOverrideMapItem) m_hPseudoOverrideMap.get(p_strType);
    ...
    private void addInternalTags(String tag, String segment) throws TagNodeException
    {
