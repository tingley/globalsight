...
public class OnlineApplet extends Applet implements PseudoBaseHandler
{
    ...
    {
        super.init();
        // setName("PlaceholderUtilities"); caused problems on Mac
        setLayout(null);
        // setSize(1, 1); caused probelms on Mac
