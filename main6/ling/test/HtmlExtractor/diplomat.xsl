...
<!--  <xsl:template match="segment"><SYM:W>Ö</SYM:W><xsl:apply-templates/><SYM:W>Õ</SYM:W></xsl:template> -->
  ...
  <xsl:template match="sub">
    <SPAN class="clsTMXtag">&lt;sub<xsl:if test="@locType"> locType="<xsl:value-of select="@locType"/>"</xsl:if><xsl:if test="@type"> type="<B><xsl:value-of select="@type"/></B>"</xsl:if><xsl:if test="@i"> i="<xsl:value-of select="@i"/>"</xsl:if>&gt;</SPAN>
    <SPAN>
  ...
  <xsl:template match="it">
    <BR/><SPAN class="clsTMXisolated">&lt;it<xsl:if test="@type"> type="<xsl:value-of select="@type"/>"</xsl:if><xsl:if test="@pos"> pos="<xsl:value-of select="@pos"/>"</xsl:if><xsl:if test="@x"> x="<xsl:value-of select="@x"/>"</xsl:if>&gt;</SPAN>
    <SPAN class="clsTMX"><xsl:apply-templates/></SPAN>
