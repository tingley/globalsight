...
*/
public class SegmentTagsAlignerTest 
extends TestCase
{
    ...
    public void setUp()
    {
        ...
        m_SourceDiplomat4 =
        "<segment segmentId=\"1\" wordcount=\"5\">A very simple <bpt i=\"1\" type=\"link\" x=\"1\">&lt;a href=&quot;<sub type=\"url-a\" locType=\"localizable\">test.html</sub>&quot;&gt;</bpt>link<ept i=\"1\">&lt;/a&gt;</ept> segment.</segment>";
        
        m_TargetDiplomat4 =
        "<segment segmentId=\"1\" wordcount=\"5\">A very simple <bpt i=\"1\" type=\"link\" x=\"2\">&lt;a href=&quot;<sub type=\"url-a\" id=\"1\" locType=\"localizable\">test.html</sub>&quot;&gt;</bpt>link<ept i=\"1\">&lt;/a&gt;</ept> segment.</segment>";

        m_SourceDiplomat5 =
        "<bpt i=\"1\" type=\"link\" x=\"1\">link1</bpt><ept i=\"1\">link1</ept>";
        
        m_TargetDiplomat5 =
        "aaa<bpt i=\"3\" erasable = \"yes\" type=\"addable\" x=\"3\">addable</bpt><ept i=\"3\">addable</ept>xxx<bpt i=\"1\" type=\"link\" x=\"1\">link1</bpt><ept i=\"1\">link1</ept>yyyzzz";
        
        m_newTargetDiplomat5 = 
        "aaa<bpt i=\"3\" erasable=\"yes\" type=\"addable\" x=\"3\">addable</bpt><ept i=\"3\">addable</ept>xxx<bpt i=\"1\" type=\"link\" x=\"1\">link1</bpt><ept i=\"1\">link1</ept>yyyzzz";        
      //"aaa<bpt i=\"3\" erasable=\"yes\" type=\"addable\" x=\"3\">addable</bpt>xxx<bpt i=\"1\" type=\"link\" x=\"1\">link1</bpt><ept i=\"1\">link1</ept>yyyzzz"
        m_SourceDiplomat6 =
        "<bpt i=\"1\" type=\"link\" x=\"1\">&lt;a href=&quot;<sub type=\"url-a\" locType=\"localizable\">a.html</sub>&quot;&gt;</bpt>Translation Memory.<ept i=\"1\">&lt;/a&gt;</ept>";
        
        m_TargetDiplomat6 =
        "<bpt i=\"1\" type=\"link\" x=\"1\">&lt;a href=&quot;<sub type=\"url-b\" locType=\"localizable\">a.html</sub>&quot;&gt;</bpt>Translation Memory.<ept i=\"1\">&lt;/a&gt;</ept>";
        
        m_newTargetDiplomat6 = 
        "Translation Memory.";   
        
        m_SourceDiplomat7 =
        "<segment segmentId=\"1\" wordcount=\"27\"><bpt i=\"1\" type=\"link\" x=\"1\">&lt;a href=&quot;<sub type=\"url-a\" locType=\"localizable\">seg_one_Link_one</sub>&quot;&gt;</bpt>Seg xxxxx link1 text<ept i=\"1\">&lt;/a&gt;</ept> seg one normal1 text <bpt i=\"2\" type=\"link\" x=\"2\">&lt;a href=&quot;<sub type=\"url-a\" locType=\"localizable\">seg_one_Link_two</sub>&quot;&gt;</bpt> seg one link2 text<ept i=\"2\">&lt;/a&gt;</ept> seg one more normal2 text<bpt i=\"3\" type=\"link\" x=\"3\">&lt;a href=&quot;<sub type=\"url-a\" locType=\"localizable\">seg_one_Link_three</sub>&quot;&gt;</bpt> seg one link3 text<ept i=\"3\">&lt;/a&gt;</ept> seg one still more normal3 text.</segment>";
        
        m_TargetDiplomat7 =
        "<segment segmentId=\"1\" wordcount=\"27\"><bpt i=\"1\" type=\"link\" x=\"1\">&lt;a href=&quot;<sub type=\"url-a\" locType=\"localizable\">seg_one_Link_one</sub>&quot;&gt;</bpt>Seg xxxxx link1 text<ept i=\"1\">&lt;/a&gt;</ept> seg one normal1 text <bpt i=\"2\" type=\"link\" x=\"2\">&lt;a href=&quot;<sub type=\"url-a\" locType=\"localizable\">seg_one_Link_two</sub>&quot;&gt;</bpt> seg one link2 text<ept i=\"2\">&lt;/a&gt;</ept> seg one more normal2 text<bpt i=\"3\" type=\"link\" x=\"3\">&lt;a href=&quot;<sub type=\"url-a\" locType=\"localizable\">seg_one_Link_three</sub>&quot;&gt;</bpt> seg one link3 text<ept i=\"3\">&lt;/a&gt;</ept> seg one still more normal3 text.</segment>";
        
        m_newTargetDiplomat7 = 
        "<segment segmentId=\"1\" wordcount=\"27\">Seg xxxxx link1 text seg one normal1 text  seg one link2 text seg one more normal2 text seg one link3 text seg one still more normal3 text.</segment>";   
    ...
    public void test4()
    {
        ...
        try
        {
            newTarget = tagAligner.alignTags(m_SourceDiplomat4, m_TargetDiplomat4);
        }
        catch (LingManagerException e)
        {
            ex = e;
    ...
    public void test5()
    {
        ...
        try
        {
            newTarget = tagAligner.removeUnmatchedTargetTags(m_SourceDiplomat5, m_TargetDiplomat5);
        }
        catch (LingManagerException e)
        {
            ex = e;
    ...
    public void test6()
    {
        ...
        try
        {
            newTarget = tagAligner.removeUnmatchedTargetTags(m_SourceDiplomat6, m_TargetDiplomat6);
        }
        catch (LingManagerException e)
        {
            ex = e;
    ...
    public void test7()
    {
        ...
        try
        {
            newTarget = tagAligner.removeUnmatchedTargetTags(m_SourceDiplomat7, m_TargetDiplomat7);
        }
        catch (LingManagerException e)
        {
            ex = e;
