...
/**
 * Wrapper class to run the HTML extractor.
 */
public class HTMLExtractorWrapper 
{
     ...
     */
    public String convertFile2DiplomatString(String p_strFilePath) throws ExtractorException
    {
        ...
        input.setURL("file:///" + p_strFilePath);
