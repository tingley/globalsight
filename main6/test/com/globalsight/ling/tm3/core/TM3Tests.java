...
public abstract class TM3Tests
{
            ...
            final GlobalSightLocale tgtLocale) throws Exception
    {
        ...
        try
        {
            ...
            tm.save(srcLocale, srcData2, null, tgtLocale, tgtData2,
                    TM3SaveMode.MERGE, currentTestEvent);
            tx.commit();
            ...
            TM3LeverageResults<TestData> results = tm.findMatches(tgtData1,
                    tgtLocale, null, TM3Attributes.NONE, TM3MatchType.ALL,
                    false);
    ...
    // Ensure the TUVs can handle unicode (ie, we are creating storage
    // correctly)
    public void testUnicodeContent(TM3Tm<TestData> tm,
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            // Now let's create some segments.
            TestData srcData1 = new TestData("This is source 1");
            TestData tgtData1 = new TestData("\u306b\u307b\u3093");
            tm.save(srcLocale, srcData1, null, tgtLocale, tgtData1,
                    TM3SaveMode.MERGE, currentTestEvent);
            tx.commit();
    ...
    public void testExactMatchingWithAttrs(TM3Tm<TestData> tm,
            GlobalSightLocale srcLocale, final GlobalSightLocale tgtLocale)
            throws Exception
    {
        Session session = HibernateUtil.getSession();
        ...
        try
        {
            ...
            results = tm
                    .findMatches(key, srcLocale, null,
                            TM3Attributes.one(attr1, "good"),
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            // Save two segments that are identical in text and
            ...
            tm.save(srcLocale, srcData1, TM3Attributes.many(
                    ...
                    TM3Attributes.entry(attr2, "optional1")), tgtLocale,
                    tgtData1, TM3SaveMode.MERGE, currentTestEvent);
            tm.save(srcLocale, srcData1, TM3Attributes.many(
                    TM3Attributes.entry(attr1, "required"),
                    TM3Attributes.entry(attr2, "optional2")), tgtLocale,
            ...
            TM3LeverageResults<TestData> results = tm.findMatches(srcData1,
                    srcLocale, null, TM3Attributes.one(attr1, "required"),
                    TM3MatchType.EXACT, false);
            assertEquals(1, results.getMatches().size());
    ...
    public void testExactMatchingWithInlineAttrs(TM3Tm<TestData> tm,
            GlobalSightLocale srcLocale, final GlobalSightLocale tgtLocale)
            throws Exception
    {
        Session session = HibernateUtil.getSession();
        ...
        try
        {
            ...
            tm.save(srcLocale, srcData1, TM3Attributes.many(
                    ...
                    TM3Attributes.entry(attr3, false)), tgtLocale, tgtData1,
                    TM3SaveMode.MERGE, currentTestEvent);
            tm.save(srcLocale, srcData1, TM3Attributes.many(
            ...
            results = tm.findMatches(key, srcLocale, null, TM3Attributes.many(
                    TM3Attributes.entry(attr1, "good"),
                    TM3Attributes.entry(attr2, "GOOD"),
                    TM3Attributes.entry(attr3, true)), TM3MatchType.EXACT,
                    false);
            assertEquals(1, results.getMatches().size());
            TM3LeverageMatch<TestData> match = results.getMatches().first();
            assertTrue(match.isExact());
    ...
    public void testExactMatchWithTargetLocales(TM3Tm<TestData> tm,
            GlobalSightLocale srcLocale, final GlobalSightLocale tgtLocale,
            final GlobalSightLocale altLocale) throws Exception
    {
        ...
        try
        {
            ...
            TM3LeverageResults<TestData> results = tm.findMatches(srcData1,
                    srcLocale, Collections.singleton(tgtLocale), null,
                    TM3MatchType.EXACT, false);
            ...
            results = tm.findMatches(srcData1, srcLocale, tgtPlusAltLocales,
                    null, TM3MatchType.EXACT, false);
            expectResults(results, expected(srcData1, true));

            // exact match with the wrong target locale
            results = tm.findMatches(srcData1, srcLocale,
                    Collections.singleton(altLocale), null, TM3MatchType.EXACT,
                    false);
            expectResults(results);

            // exact target match with the correct source locale
            results = tm.findMatches(tgtData1, tgtLocale,
                    Collections.singleton(srcLocale), null, TM3MatchType.EXACT,
                    true);
            ...
            results = tm.findMatches(tgtData1, tgtLocale, srcPlusAltLocales,
                    null, TM3MatchType.EXACT, true);
            expectResults(results, expected(tgtData1, true));
    ...
    public void testFuzzyMatching(TM3Tm<TestData> tm,
            GlobalSightLocale srcLocale, final GlobalSightLocale tgtLocale)
            throws Exception
    {
        Session session = HibernateUtil.getSession();
        ...
        try
        {
            ...
            TM3LeverageResults<TestData> results = tm.findMatches(key,
                    ...
                    false);
            expectResults(results, expected(srcData3, false),
    ...
    public void testFuzzyTargetMatching(TM3Tm<TestData> tm,
            GlobalSightLocale srcLocale, final GlobalSightLocale tgtLocale)
            throws Exception
    {
        Session session = HibernateUtil.getSession();
        ...
        try
        {
            ...
            results = tm.findMatches(key, tgtLocale, null, TM3Attributes.NONE,
                    TM3MatchType.ALL, true);
            expectResults(results, expected(tgtData3, false),
    ...
    public void testFuzzyMatchingWithAttributes(TM3Tm<TestData> tm,
            GlobalSightLocale srcLocale, final GlobalSightLocale tgtLocale)
            throws Exception
    {
        Session session = HibernateUtil.getSession();
        ...
        try
        {
            ...
            TM3LeverageResults<TestData> results = tm.findMatches(key,
                    srcLocale, null, TM3Attributes.one(attr1, "yes"),
                    TM3MatchType.ALL, false);
            assertEquals(1, results.getMatches().size());
