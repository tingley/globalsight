...
public class OnlineAppletTest
{
    ...
    public void setUp()
    {
        m_diplomat = "This ia a "
                + "<bpt x=\"1\" type=\"italic\" i=\"1\" erasable=\"yes\">&lt;i&gt;</bpt>" + "big"
                + "<ept i=\"1\">&lt;/i&gt;</ept>"
                + "<bpt x=\"2\" type=\"bold\" i=\"2\"erasable=\"yes\">&lt;b&gt;</bpt>" + "fat"
                + "<ept i=\"2\">&lt;/b&gt;</ept>" + " segment.";
        ...
        m_colorTestDiplomat = "This ia a "
                + "<bpt x=\"1\" type=\"italic\" i=\"1\" erasable=\"yes\">&lt;i&gt;</bpt>" + "big"
                + "<ept i=\"1\">&lt;/i&gt;</ept>"
                + "<bpt x=\"2\" type=\"bold\" i=\"2\"erasable=\"yes\">&lt;b&gt;</bpt>" + "fat"
                + "<ept i=\"2\">&lt;/b&gt;</ept>" + " segment. &lt; &gt; &amp; &quot;";
        m_colorTestPtagCompact = "This ia a <SPAN DIR=ltr class=ptag UNSELECTABLE=on CONTENTEDITABLE=false>[i]</SPAN>big<SPAN DIR=ltr class=ptag UNSELECTABLE=on CONTENTEDITABLE=false>[/i]</SPAN><SPAN DIR=ltr class=ptag UNSELECTABLE=on CONTENTEDITABLE=false>[b]</SPAN>fat<SPAN DIR=ltr class=ptag UNSELECTABLE=on CONTENTEDITABLE=false>[/b]</SPAN> segment. &lt; &gt; &amp; &quot;";
        m_colorTestPtagVerbose = "This ia a <SPAN DIR=ltr class=ptag UNSELECTABLE=on CONTENTEDITABLE=false>[italic]</SPAN>big<SPAN DIR=ltr class=ptag UNSELECTABLE=on CONTENTEDITABLE=false>[/italic]</SPAN><SPAN DIR=ltr class=ptag UNSELECTABLE=on CONTENTEDITABLE=false>[bold]</SPAN>fat<SPAN DIR=ltr class=ptag UNSELECTABLE=on CONTENTEDITABLE=false>[/bold]</SPAN> segment. &lt; &gt; &amp; &quot;";
        // for length test
        ...
        m_lenTestPtagCompact = "[x1][b]Shop[/b] ? [l3]Auctions[/l3] ?[l4]Classifieds[/l4] ?[l5][b]Shopping[/b][/l5] ?[l7]Travel[/l7] ? [l8]Yellow Pgs[/l8] ? [l9]Maps[/l9] [nbsp10] [b]Media[/b] ? [l12]News[/l12] ? [l13]Sports[/l13] ? [l14][b]Stock Quotes[/b][/l14] ?[l16]TV[/l16] ? [l17]Weather[/l17]";
    ...
    public void test3()
    {
        ...
        try
        {
            m_placeholderUtils.setInputSegment(m_diplomat, "", "HTML");
            compact = m_placeholderUtils.getCompact();
            error = m_placeholderUtils.errorCheck(compact, m_diplomat, 0, "UTF-8", 0, "UTF-8");
        }
        catch (DiplomatBasicParserException e)
        {
            ex = e;
    ...
    public void test4()
    {
        String gxml = "Copyright <bpt internal=\"yes\" i=\"1\" x=\"1\">&lt;tag&gt;</bpt>&amp;<ept i=\"1\">&lt;/tag&gt;</ept>copy"
                + "<bpt internal=\"yes\" i=\"2\" x=\"2\"/>;<ept i=\"2\"/> <bpt internal=\"yes\" i=\"3\" x=\"3\"/>2011<ept i=\"3\"/> Trend Micro Incorporated. ";
        Exception ex = null;
        String result = null;
        try
        {
            m_placeholderUtils.setInputSegment(gxml, "", "HTML");
            result = m_placeholderUtils.makeInlineVerboseColoredPtags(gxml);
        }
        catch (DiplomatBasicParserException e)
        {
            ex = e;
        ...
        assertNull(ex);
        assertEquals("Copyright &amp;copy; 2011 Trend Micro Incorporated. ", result);
    }

    @Test
    public void test5()
    {
        String gxml = "Copyright <bpt internal=\"yes\" i=\"1\" x=\"1\"></bpt>\n<ept i=\"1\"></ept>";
        Exception ex = null;
        String result = null;
        try
        {
            m_placeholderUtils.setInputSegment(gxml, "", "HTML");
            result = m_placeholderUtils.getCompact();
        }
        catch (DiplomatBasicParserException e)
        {
            ex = e;
    ...
    public void testStringLengthValidation()
    {
        ...
        try
        {
            ...
            assertNull(
                    "Ignore legnth failed",
                    (err = m_placeholderUtils.errorCheck(simulateTrgCompact, m_diplomatWithSubs, 0,
                            "", 0, "")));
            // test gxml too long
            assertNotNull(
                    "Gxml legnth did not fail",
                    (err = m_placeholderUtils.errorCheck(simulateTrgCompact, m_diplomatWithSubs,
                            100, "UTF8", 0, "")));
            // native too long
            assertNotNull(
                    "Native legnth did not fail",
                    (err = m_placeholderUtils.errorCheck(simulateTrgCompact, m_diplomatWithSubs, 0,
                            "", 100, "8859_1")));
            // normal pass
            assertNull(
                    "Did not pass when it should",
                    (err = m_placeholderUtils.errorCheck(simulateTrgCompact, m_diplomatWithSubs,
                            4000, "UTF8", 4000, "8859_1")));
        ...
        assertNull(ex);
        assertEquals("Compare compact failed",
                (simulateTrgCompact.compareTo(m_lenTestPtagCompact)), 0);
    }
}