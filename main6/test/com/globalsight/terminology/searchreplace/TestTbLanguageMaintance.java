...
public class TestTbLanguageMaintance implements TermbaseTestConstants
{
    static TbLanguageMaintance m_instance;
    static Termbase m_termbase;
    static long m_tbid = -1;
    static SessionInfo m_session;
    static SearchReplaceParams m_rp;
    static String m_searchText;
    ...
    public static void beforeClass()
    {
        ...
        m_searchText = FIELD_LANGUAGE_LEVEL_STR; 
        ...
        m_rp = new SearchReplaceParams(m_searchText, searchType, level, language, 
                   field, fieldName, caseInsensitive, smartReplace, wholeword);
        
        m_instance = new TbLanguageMaintance(m_rp, m_termbase);
    }
    ...
    public void testSearch()
    {
        ...
        assertNotNull(arrayList);
        SearchResult result = (SearchResult) arrayList.get(0);
        assertTrue(m_searchText.equals(result.getField()));
    }
