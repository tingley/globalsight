...
public class MTPLanguagesController implements DispatcherConstants
{
    ...
    {
        boolean isExist = false;
        MTPLanguage mtpLang = mtpLangDAO.getMTPLanguage(p_mtpLang.getSrcLocale(), p_mtpLang.getTrgLocale());
        if (mtpLang != null && mtpLang.getId() != p_mtpLang.getId())
            isExist = true;
