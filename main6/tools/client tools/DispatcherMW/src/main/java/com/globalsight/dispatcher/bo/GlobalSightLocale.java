 ...
 */
public class GlobalSightLocale implements Comparable<GlobalSightLocale>
{
     ...
     * Constructor
     */
    public GlobalSightLocale(String p_language, String p_country,
    ...
    public GlobalSightLocale(String p_language, String p_country, long p_id)
    {
        this(p_language, p_country, false);
        this.setId(p_id);
    }
    ...
    /**
     * Wraps the call to the Java locale object to return the language
     * and country in a nice format (en_US = English (United States))
     * The nice format also includes the locale code in brackets.
     *
    ...
    /**
     * Wraps the call to the Java locale object to return the language
     * and country in a nice format.
     *
     * @param p_locale The locale to return this locale's name in.
     * @return String A displayable/readable name for the locale.
     */
     ...
     * in a nice format (en = English)
     *
     * @param p_locale The locale to return this locale's language in.
     * @return String A displayable/readable name for the locale's language.
     */
    ...
    /**
     * Wraps the call to the Java locale object to return the country
     * in a nice format (US = United States)
     *
     ...
     * in a nice format (US = United States)
     *
     * @param p_locale The locale to return this locale's country in.
     * @return String A displayable/readable name for the locale's country.
     */
    ...
    /**
     * Returns 'true' if the ids of the Locale objects are equal,
     * 'false' if they aren't.
     *
     *  @param p_locale  The GlobalSightLocale object to compare with
     ...
     * Converts any old iso language codes to the
     * new codes.  The Java locale object preserves the
     * old ones.
    ...
    static public Locale makeLocaleFromString(String p_localeName)
...
//    }
    ...
    // Collections.Sorted by Display Full Name.
    public int compareTo(GlobalSightLocale p_gsLocale)
    {
        return getDisplayName().compareToIgnoreCase(p_gsLocale.getDisplayName());
    }
