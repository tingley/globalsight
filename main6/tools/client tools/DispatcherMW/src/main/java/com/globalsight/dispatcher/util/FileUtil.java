...
/**
 * A utility class, let operate file more easy.
 * 
 */
public class FileUtil
{
     ...
     */
    public static void sendFile(File p_file, String p_attachFileName, HttpServletResponse p_response, 
            boolean p_isDelete) 
    ...
    public static boolean isExists(File p_file)
    {
