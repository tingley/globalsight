...
//			transUnitObj.setMatchType(matchType.getText());
	...
	public String getAnnotation(Document doc) throws Exception {
		...
		for (Iterator iFile = root.elementIterator(XliffConstants.FILE); iFile
			...
			for (Iterator iheader = file.elementIterator(XliffConstants.HEADER); iheader
				...
				header=header.element(XliffConstants.NOTE);
	...
	public Element getXFile(Document doc) throws Exception {
        String result = doc.asXML();
    ...
    public String getSourceLanguage(Element xFile)
    {
       String sourceLanguage= xFile.attributeValue(XliffConstants.SOURCELANGUAGE);
        return sourceLanguage;
    }

    public String getTargetLanguage(Element xFile)
    {
        String targetLanguage= xFile.attributeValue(XliffConstants.TARGETLANGUAGE);
