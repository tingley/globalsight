...
public class BuildUtil
{
    ...
    {
        File file = new File(CvsUtil.SERVER_NAME);
        if (file.exists())
        {
            file.delete();
        }
        ...
        if (Main.IS_PATCH)
        {
            CvsUtil.buildGlobalSight();
            file = new File(CvsUtil.SERVER_NAME);
        }
        else
        {
            file = new File(DIST + "/" + CvsUtil.SERVER_NAME);
            if (file.exists())
            {
                file.delete();
            }
        ...
        File newFile = new File(getGlobalSightRoot() + CvsUtil.SERVER_NAME);
