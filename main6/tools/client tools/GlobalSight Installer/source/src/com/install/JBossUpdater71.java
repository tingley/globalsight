...
public class JBossUpdater71 extends JBossUpdater
{
    private static Logger log = Logger.getLogger(JBossUpdater71.class);
    
    private Boolean isJboss71 = null;
    ...
    protected boolean isUpdate()
    {
        if (isJboss71 == null)
        {
            File f = new File(ServerUtil.getPath() + "/jboss/server/modules/sun");
            isJboss71 = f.exists();
        }
