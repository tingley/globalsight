 ...
 *  
 */
package com.globalsight.restful.util;
...
public class URLEncoder
{
    ...
    public static String encodeUrlString(String url)
    {
        ...
        for (int i = 0; i < segments.length; i++)
        {
            ...
            {
                sb.append(URLEncoder.URL_SEPERATOR).append(URLEncoder.encode(segments[i]));
            }
        }
            ...
            for (int i = 0; i < segments.length; i++)
            {
                if (!StringUtils.isEmpty(segments[i]))
                {
                    sb.append(URLEncoder.URL_SEPERATOR)
                            .append(UrlUtil.encode(segments[i], "utf-8"));
                }
            }
        }
        catch (Exception e)
     ...
     * @param s
     * @param enc
     *            We will ignore this parameter, and use "UTF-8" instead.
     * @return
     */
