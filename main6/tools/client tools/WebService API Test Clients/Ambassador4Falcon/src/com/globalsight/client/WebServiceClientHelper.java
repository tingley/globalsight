...
public class WebServiceClientHelper 
{
	 ...
	 * @throws Exception
	 */
    public static Ambassador4Falcon getClientAmbassador(String p_hostName,
            ...
            throws Exception
    {
        ...
        return loc.getAmbassador4Falcon(url, userName, password);
    }
	 ...
	 * @throws Exception
	 */
    public static Ambassador4Falcon getClientAmbassador(String p_endpoint,
