 ...
 *
 */
public class COTIXml
{
    private long companyId;
    private Element root = null;

    public COTIXml(Element root)
    {
        this.root = root;
    }
    ...
    {
        return root.getAttribute("creationdate");
    }
    ...
    public Element getFirstElement(Element parent, String name)
    {
    ...
    /**
     * Parses the given string with xerces DOM (no validation)
     * 
