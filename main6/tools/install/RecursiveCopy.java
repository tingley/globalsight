...
public class RecursiveCopy extends installer.EventBroadcaster
{
    static private final int BUFFER_SIZE = 16384;

    private int m_fileNum = 0;

    public void copy(String p_sourceDir, String p_destDir) throws Exception
    {
        copy(p_sourceDir, p_destDir, new ArrayList());
    }

    public void copy(String p_sourceDir, String p_destDir, ArrayList p_excludedDirs)
            throws Exception
    {
        ...
        {
            throw new Exception(
                    p_sourceDir + " and/or " + p_destDir + " are not directories or don't exist");
        }
    ...
    public void copyFile(String p_sourceFileName, String p_destDir) throws Exception
    {
    ...
    private void doCopy(File[] p_fileEntries, File p_destDir, ArrayList p_excludeDirs)
            throws Exception
    {
    ...
    private void copyFile(File p_sourceFile, File p_destDir, String p_destFileName) throws Exception
    {
    ...
    public int countFiles(String p_sourceDir, ArrayList p_excludeDirs) throws Exception
    {
        File sourceDir = new File(p_sourceDir);
