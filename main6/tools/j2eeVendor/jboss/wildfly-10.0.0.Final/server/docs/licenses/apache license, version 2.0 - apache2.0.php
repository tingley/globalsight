...
<!--[if (lt IE 9)]>
<link type="text/css" rel="stylesheet" href="http://opensource.org/sites/all/themes/bootstrap-business/css/ie8.css?o11dsc" media="all" />
<![endif]-->
...
<div class="form-actions form-wrapper" id="edit-actions"><input value="" type="submit" id="edit-submit" name="op" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-LY2JPa_U2Ca5jLQeAwUJJGGE3Dxo-4hCU4Gqah-zpbk" />
...
<div id="page" class="clearfix">
                ...
                <section class="col-md-12">
                    ...
                    <div id="main" class="clearfix">
                        ...
                        <div id="content-wrapper">
                                                                                    ...
                                                                                    <h1 class="page-title">Apache License, Version 2.0</h1>
  ...
  <div class="content">
    <article id="node-41" class="node node-page clearfix">
...
<button onclick="myFunction()">Further resources on <b>Apache License 2.0</b></button>
