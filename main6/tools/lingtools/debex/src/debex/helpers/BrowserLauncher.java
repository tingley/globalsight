 ...
 *  by incorporating the fixes suggested at
 *  http://sourceforge.net/tracker/?atid=114506&group_id=14506&func=browse
 *  and adding support for Mac OS X Java 1.4.1 Update.
 *  G. Herrmann, April 30, 2003
 *
 */
...
public class BrowserLauncher
{
     ...
     * system. Caches results so it only locates the browser once for
     * each use of this class per JVM instance.
     *
        ...
        switch (jvm)
        {
            case MRJ_2_0 :
                try
                {
                    ...
                    Integer gurlType =
                        (Integer) makeOSType.invoke(null, new Object[] { GURL_EVENT });
                    Object appleEvent =
                    ...
                    // next time we call locateBrowser(), we'll get
                    // the same AppleEvent, to which we'll already
                    // have added the relevant parameter. Instead,
                    // regenerate the AppleEvent every time.  There's
                    // probably a way to do this better; if any has
            ...
            case MRJ_2_1 :
                ...
                {
                    systemFolder =
                        (File) findFolder.invoke(null, new Object[] { kSystemFolderType });
                }
                ...
                for (int i = 0; i < systemFolderFiles.length; i++)
                {
                    try
                    {
                        ...
                        // We're looking for a file with a creator
                        // code of 'MACS' and a type of 'FNDR'.  Only
                        // requiring the type results in non-Finder
                        // applications being picked up on certain Mac
                        // OS 9 systems, especially German ones, and
                        // sending a GURL event to those applications
                        // results in a logout under Multiple Users.
